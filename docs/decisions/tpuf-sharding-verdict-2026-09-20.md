...
**Date:** 2026-09-20 (written 2026-09-22 against `origin/main` 27291eb59; line
numbers and `/health` values re-verified 2026-09-23 against `origin/main` 0222ed443)
...
sprint. The state this preserves is the one on 27291eb59 and still on 0222ed443:
...
2026-09-22 returns `turbopuffer_production_default_mount: true`, and so does the
2026-09-23 re-read. Recorded so the
...
(`turbopuffer.py:562`). The SDK's constraint that sharding "can only be
