...
**Composite (equal-weight mean of 13 surfaces) = 1271/13 ≈ 97.77 → report **~98**.**
...
5. ~~HTML writing-asset inline~~ — shipped.
6. **Code residual:** Plans ~95 / Specs ~97 / Code ~96 / TPuf ~95 (no mount flip).
7. Do not invent Synquery/G2/email/mount/CPM.
