...
| (iii) $/minute @ configured cap | **$0.33/min at $0.04/unit** (measured latency × doc unit price); **$0.057/min if bfl/flux-1-dev bills $0.007/gen** per `infrastructure/runbooks/krea.md` | measured 8.2 img/min ceiling (60/7.33 s) × unit price; **unit-price ground truth is the operator's dashboard decrement** | doc-derived was ~$0.60/min @ 4 s/img; slower measured latency cuts the burn rate proportionally |
