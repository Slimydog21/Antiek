...
_Generated by SPR-01 (Grounding + experience-gate harness), Antiek Mountain Shell v2, 2026-05-31.
Every `VERIFIED` row is re-checkable with `git cat-file -e origin/main:<path>`; run
