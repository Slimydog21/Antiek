...
| Story | Violations | Top impact | Worst rule |
|---|---|---|---|
...
| `settings-model-observatory--production` | 0 | — | — |
...
| `multimedia-production-bay--ready-empty` | 0 | — | — |
| `multimedia-production-bay--loading` | 0 | — | — |
