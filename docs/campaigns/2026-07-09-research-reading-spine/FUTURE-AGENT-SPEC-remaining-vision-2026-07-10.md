...
**Campaign tip at write:** residual **agb** (highlight Note+Dialogue path honesty) · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **inventory-agb** + **SESSION-ARC-afw-afx-highlight-dr-path.md** + **SESSION-ARC-afr-aft-research-workstation-spine.md**.  
...
### P1 next offline (residual **agc+**)
Outside thrash: MO live multi-provider · paid L5 · competitive depth. FloatMenu matrix closed. Leave thrash.
