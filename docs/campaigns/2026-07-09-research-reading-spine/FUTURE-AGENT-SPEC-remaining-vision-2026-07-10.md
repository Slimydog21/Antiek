...
**Campaign tip at write:** `b22b29e2` · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **SESSION-ARC-vz-zk-infinite-continuation.md** + inventories **vz–zo** + competitive notes.  
This continuation: **95 residual ships** from vy tip `8e280766`.
...
| Dogfood **v12** | Full list · task-class counts · panel+summary+API honesty · propose≠promote |
