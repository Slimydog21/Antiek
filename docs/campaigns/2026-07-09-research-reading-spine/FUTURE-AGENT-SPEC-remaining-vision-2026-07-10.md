...
**Campaign tip at write:** `c8491240` · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **SESSION-ARC-vz-zk-infinite-continuation.md** + inventories **vz–aaj** + competitive notes.  
This continuation: **117 residual ships** from vy tip `8e280766`.
...
| Write-seed provenance (aah–aaj) | spawn_merge default · library→host aliases · marketplace_catalog feed (18) |
...
Write-seed float provenance wave (aah–aaj) closed three identity bugs.
