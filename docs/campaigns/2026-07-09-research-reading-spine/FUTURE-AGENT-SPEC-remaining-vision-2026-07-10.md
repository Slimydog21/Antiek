...
**Campaign tip at write:** residual **agc** (SESSION-ARC afw–agb FloatMenu highlight path) · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **inventory-agc** + **SESSION-ARC-afw-agb-floatmenu-highlight-path.md** + **SESSION-ARC-afr-aft-research-workstation-spine.md**.  
...
### P1 next offline (residual **agd+**)
Outside thrash: MO live multi-provider · paid L5 · competitive depth. FloatMenu SESSION-ARC agc. Leave thrash.
