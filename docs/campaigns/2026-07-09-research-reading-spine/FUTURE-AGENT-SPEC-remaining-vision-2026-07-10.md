...
**Campaign tip at write:** `84bbfed2` · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **SESSION-ARC-vz-we-budget-stem-honesty.md** + **SESSION-ARC-tt-vt-infinite-wave.md** + inventories **tt–we** + competitive notes. Tip letters **tt–we** (64 residual ships this continuous wave including tip re-anchors).
