...
Prefer **inventory-agw** + **inventory-ags** + **inventory-agr** + **SESSION-ARC-agm-agq-reading-twins-matrix.md**.  
This continuation: **270+ residual ships** from vy tip `8e280766` · wave **afn–agw** closed.
...
| Collective multi-spawn path | **afg–afl** · assembly open/recent/restore **afn–afp** (SESSION-ARC **afq**) · dogfood v16 **afo** · seamless multi-spawn **agv** |
| Model quality per task | Settings **ads** · launch **afb/aff** · badge **afc/afe** |
| Dogfood v22 | **afi**–**agh** · **agp** twins · **ags** Fourier · **agw** spawn+collective merge paths |
