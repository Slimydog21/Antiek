...
**Campaign tip at write:** residual **afu** (SESSION-ARC afr–aft ResearchWorkstation spine) · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **inventory-afu** + **SESSION-ARC-afr-aft-research-workstation-spine.md** + **SESSION-ARC-afn-afp-multi-select-assembly-path.md**.  
...
### P1 next offline (residual **afv+**)
Outside thrash: MO live multi-provider · paid L5 · competitive depth. RW spine SESSION-ARC afu. Leave thrash.
