...
**Campaign tip at write:** residual **aes** (intelligent search + context pack Open Write path) · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **inventory-aes** + **SESSION-ARC-ael-aeq-seamless-write-path.md** + **NEXT-WAVE-after-aes**.  
This continuation: **230 residual ships** from vy tip `8e280766`.
...
| Seamless Write path wave | **ael–aeq** (SESSION-ARC **aer**) + context search **aes** |
...
### P1 next offline (residual **aet+**)
Antiek-bench recursive rewrite · ND advisory · evidence pack path · outside stamp thrash. Leave thrash.
