...
**Campaign tip at write:** residual **aft** (RW ResearchContext + twin auto-promote) · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **inventory-aft** + **inventory-afr** + **SESSION-ARC-afn-afp-multi-select-assembly-path.md**.  
...
### P1 next offline (residual **afu+**)
Outside thrash: MO live multi-provider · paid L5 · competitive depth. RW spine closed (afr–aft). Leave thrash.
