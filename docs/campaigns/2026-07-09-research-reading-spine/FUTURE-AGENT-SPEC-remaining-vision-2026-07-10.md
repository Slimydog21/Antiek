...
**Campaign tip at write:** `41a3e1b8` · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **SESSION-ARC-vz-we-budget-stem-honesty.md** + **SESSION-ARC-tt-vt-infinite-wave.md** + inventories **tt–wg** + competitive notes. Tip letters **tt–wg** (64 residual ships this continuous wave including tip re-anchors).
...
### P1 next offline (residual **wg+** / continue lettering)
