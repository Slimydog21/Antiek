...
**Campaign tip at write:** residual **adp** (suite proposal body honesty matrix + API wire) · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **inventory-adp** + **inventory-ado** + **inventory-adn** + **SESSION-ARC-acp-acy-write-seed-body-loop.md**.  
This continuation: **201 residual ships** from vy tip `8e280766`.
...
| Dogfood **v13** | Fixture **adn** + Settings posture **ado** |
| Write-seed provenance | Full loop **acf–acy** · dogfood **adn–ado** · suite proposal matrix **adp** |
...
### P1 next offline (residual **adq+**)
Prefer real product residual outside stamp thrash; suite proposal body matrix closed **adp**.
