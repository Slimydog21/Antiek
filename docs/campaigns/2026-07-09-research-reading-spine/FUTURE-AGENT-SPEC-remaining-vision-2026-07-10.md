...
**Campaign tip at write:** residual **acq** (TwinNotes has-body) · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **inventory-acq** + **inventory-acp** + **SESSION-ARC-acf-acn-write-seed-body-honesty.md** + inventories **aah–acq**.  
This continuation: **176 residual ships** from vy tip `8e280766`.
...
| Write-seed provenance | has-body matrix marketplace·MO·spawn·collective·HostedHtml (acf–acn) + ResearchProgress (**acp**) + TwinNotes draft/promote (**acq**) |
...
### P1 next offline (residual **acr+**)
Remaining Open Write has-body on ResearchContext · PublicationAttach ·
SessionFlywheel, or twin/MO/collective real product residual outside free thrash.
