...
**Campaign tip at write:** residual **afn** (Select open path honesty) · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **inventory-afn** + **inventory-afm** + **SESSION-ARC-afg-afl-collective-multi-spawn-complete.md**.  
...
### P1 next offline (residual **afo+**)
Outside thrash: MO live multi-provider · paid L5 · competitive depth. Optional thin Select recent path. Leave thrash.
