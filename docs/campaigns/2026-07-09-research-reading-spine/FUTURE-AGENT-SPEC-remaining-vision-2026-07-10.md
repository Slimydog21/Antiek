...
**Campaign tip at write:** residual **afg** (written analysis Open Write source honesty) · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **inventory-afg** + **SESSION-ARC-ael-aex-write-path-complete.md** + **NEXT-WAVE-after-afg**.  
This continuation: **244 residual ships** from vy tip `8e280766`.
...
| Open Write path honesty | **ael–aex** · unit **afa** · analysis source **afg** |
