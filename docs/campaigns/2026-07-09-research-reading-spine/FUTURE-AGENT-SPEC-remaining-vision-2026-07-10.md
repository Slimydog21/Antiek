...
**Campaign tip at write:** residual **ada** (MO ceiling formula constants) · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **inventory-ada** + **SESSION-ARC-acp-acy-write-seed-body-loop.md** + inventories **acp–ada**.  
This continuation: **186 residual ships** from vy tip `8e280766`.
...
| Midnight Oil ceiling | Formula constants machine-readable (**ada**) + tier factor · budget fit |
...
### P1 next offline (residual **adb+**)
Prefer twin/collective/marketplace HTML book path or NotDiamond advisory polish —
write-seed body thrash closed; MO formula constants shipped **ada**.
