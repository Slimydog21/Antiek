...
**Campaign tip at write:** residual **afl** (restore last unit path honesty) · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **inventory-afl** + **SESSION-ARC-afg-afi-collective-multi-spawn-path.md** + **NEXT-WAVE-after-afl**.  
This continuation: **249 residual ships** from vy tip `8e280766`.
...
| Collective multi-spawn path | analysis **afg** · continue **afh/afk** · restore **afl** |
