...
**Campaign tip at write:** residual **agm** (TalkToBook TwinNotes recursive note-taker) · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **inventory-agm** + **inventory-agl** + **SESSION-ARC-agh-agj-free-stem-floatmenu-panels.md**.  
...
| TalkToBook twins | **agm** recursive note-taker on book asset |

### P0 — Operator merge PR #465
**Highest leverage remaining.** Agents never merge main/prod.

### P1 next offline (residual **agn+**)
Outside thrash: MetaReading twins · MO live · paid L5 · competitive depth. Leave thrash.
