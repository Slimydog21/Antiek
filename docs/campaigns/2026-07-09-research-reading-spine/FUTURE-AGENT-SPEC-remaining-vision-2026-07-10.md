...
**Campaign tip at write:** residual **acw** (twins/seed has_body wire) · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **SESSION-ARC-acp-acs-write-seed-body-engagement.md** + inventories **acp–acw**.  
This continuation: **182 residual ships** from vy tip `8e280766`.
...
| Write-seed provenance | UI acf–acs+acv · bench act · Settings acu · API wire **acw** |
...
### P1 next offline (residual **acx+**)
**Pivot hard off write-seed/has_body thrash.** Prefer twin/MO/collective/
marketplace HTML book path real product residual, NotDiamond advisory polish,
or Midnight Oil autonomous swarm offline craft.
