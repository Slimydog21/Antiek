...
**Campaign tip at write:** residual **adk** (continue-as-unit L6 deferred) · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **inventory-adk** + **inventory-adj** + **inventory-adi** + **SESSION-ARC-ada-adf-moil-nd-model-quality.md**.  
This continuation: **196 residual ships** from vy tip `8e280766`.
...
| Dual-gate L1–L7 | Section anchors · deep-links · L2–L7 · host L5 · membership L6 · continue L6 (**adk**) |
...
### P1 next offline (residual **adl+**)
Prefer next real product residual outside dual-gate stamp thrash.
