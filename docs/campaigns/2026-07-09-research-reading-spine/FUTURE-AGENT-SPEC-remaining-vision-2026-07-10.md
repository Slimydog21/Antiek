...
**Campaign tip at write:** residual **acu** (Settings body honesty chrome) · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **inventory-acu** + **inventory-act** + **SESSION-ARC-acp-acs-write-seed-body-engagement.md** + inventories **aah–acu**.  
This continuation: **180 residual ships** from vy tip `8e280766`.
...
| Write-seed provenance | engagement has-body (acf–acs) · bench has_body (**act**) · Settings chrome (**acu**) |
...
### P1 next offline (residual **acv+**)
Wire has_body from Open Write API routes into record_twin_write_seed_usage,
DeepResearchSessionHost has-body stamp, or twin/MO/collective product residual.
