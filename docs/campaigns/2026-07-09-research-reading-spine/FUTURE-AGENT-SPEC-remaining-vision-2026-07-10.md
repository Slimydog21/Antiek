...
**Campaign tip at write:** residual **agi** (highlight Note panel save path honesty) · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465** (OPEN)  
...
Prefer **inventory-agi** + **inventory-agh** + **SESSION-ARC-afn-agc-infinite-continuation.md**.  
