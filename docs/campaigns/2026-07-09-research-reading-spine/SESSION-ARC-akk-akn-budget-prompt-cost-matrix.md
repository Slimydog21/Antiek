...
|---|---|---|
| **ake** | Settings prompt-cost panel | competitive scorecard + FUTURE + decision-tree |
| **akk** | Midnight Oil | → `#prompt-cost-projection` |
...
research spend surface before firing multi-minute / multi-agent / merge work.
