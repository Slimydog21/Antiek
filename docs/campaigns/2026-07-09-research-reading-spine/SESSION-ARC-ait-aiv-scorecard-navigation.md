# SESSION-ARC ait–aiv · competitive DR scorecard navigation matrix · 2026-07-10

**Branch:** `campaign/research-reading-spine-2026-07-09-main` · PR **#465**

| Residual | Surface | Link targets |
|---|---|---|
| **aim** | ResearchProgressPanel | scorecard |
| **aio** | TwinNotesPanel | FUTURE twin matrix + scorecard |
| **aip** | Settings decision-tree dual-gate prep | scorecard |
