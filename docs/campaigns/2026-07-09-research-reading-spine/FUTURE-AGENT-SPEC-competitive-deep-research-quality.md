...
**Campaign tip at write:** residual **amu** · tip `975d6eea` · branch `campaign/research-reading-spine-2026-07-09-main` · PR **#465**  
...
## Competitive patterns (study → Antiek map)
...
- Multi-hop citation chain · hop strip stage deep-links (amc/ame) · evidence Write hop honesty · dogfood v29–v35  
...
- Antiek-bench dogfood recursive rewrite through **v35** (propose≠promote)  
...
## Proof bar for any competitive DR claim

- Cite path + residual id for “shipped”.  
- Cite dual-gate id for “deferred”.  
- Never claim live capability when offline-honest.  
- HTML-first · soft budget · propose≠promote · ND never router.
