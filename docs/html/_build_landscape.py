...
<div class="card"><h3>Ingest reader view</h3><p>Mandatory URL + PDF HTML projections or explicit non-viewable receipts beside substrate chunks, per SPR-AHT-04/07/08.</p></div>
...
<tr><td>Canonical reader HTML</td><td>Always produced by <code>ingest_url</code> and <code>ingest_pdf</code>; no enable flag</td></tr>
