...
|-----------|--------|----------|
| Trajectory replay works against a real multi-step investigation | implementation present / real-investigation proof still needed | `apps/reading/src/components/TrajectoryReplay.tsx`; Storybook story exists; no direct component test found |
