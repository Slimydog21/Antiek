...
<footer class="spec-footer">{esc(row['id'])} · generated {DATE} · source: active Antiek /goal Cycle 11</footer>"""
...
<footer class="spec-footer">Generated by htmlspec · source: active Antiek /goal Cycle 11 · {DATE}</footer>"""
