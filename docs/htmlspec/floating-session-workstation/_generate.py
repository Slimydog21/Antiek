...
<footer class="spec-footer">{esc(row['id'])} · generated {DATE} · source: active Antiek /goal Cycle 13</footer>"""
...
<footer class="spec-footer">Generated by htmlspec · source: active Antiek /goal Cycle 13 · {DATE}</footer>"""
