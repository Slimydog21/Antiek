...
| D2 | Mint a real `success` token for done/met/passed states. Must pass WCAG AA (≥4.5:1) on ice-0 and space-2 in both modes; aurora stays reserved for AI-thinking. | aurora fails contrast (1.9:1 on ice-0) and has a reserved semantic; success is a distinct recurring need across ~14 surfaces. |
