...
class CascadeSession:
    ...
    def __init__(
        ...
        *,
        ...
        self._synthesis_tail_error: Optional[str] = None
    ...
    def record_merge_error(self, message: str) -> None:
        self._merge_error = message
        log_event(
            self.session_id,
            "cascade.merge_failed",
            payload={"error": message},
            role="system",
            events_dir=self._events_dir,
        )

    def record_synthesis_tail_error(self, message: str) -> None:
        self._synthesis_tail_error = message
        log_event(
            self.session_id,
            "cascade.synthesis_tail_failed",
            payload={"error": message},
            role="system",
            events_dir=self._events_dir,
        )
    ...
    def completion_status(self) -> dict:
        ...
        return {
            ...
            "deep_research_complete": (
                self.is_deep_research_complete() if gather_complete else False
            ),
            "synthesis_tail_attempted": self._synthesis_tail_attempted,
            "synthesis_tail_error": self._synthesis_tail_error,
            "merge_error": self._merge_error,
        }
