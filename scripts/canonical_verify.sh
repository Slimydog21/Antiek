...
#   deep-research        — ANT-DRL P-48..P-54 hermetic harness (SPR-DRL-02, SPR-DRL-08, SPR-DRL-09)
#   html-transport       — ANT-AHT P-55 ResearchArtifact transport gates
#
...
cmd_html_transport() {
  echo "== html-transport: P-55 ANT-AHT bundle =="
  "${PY}" -m pytest \
