...
#   deep-research        — ANT-DRL P-39..P-45 hermetic harness (SPR-DRL-02, SPR-DRL-08, SPR-DRL-09)
#   html-transport       — ANT-AHT P-46 ResearchArtifact transport gates
#
...
cmd_html_transport() {
  echo "== html-transport: P-46 ANT-AHT bundle =="
  "${PY}" -m pytest \
