...
#   deep-research        — ANT-DRL P-49..P-55 hermetic harness (SPR-DRL-02, SPR-DRL-08, SPR-DRL-09)
#   html-transport       — ANT-AHT P-56 ResearchArtifact transport gates
#
...
cmd_html_transport() {
  echo "== html-transport: P-56 ANT-AHT bundle =="
  "${PY}" -m pytest \
