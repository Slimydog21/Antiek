...
#   deep-research        — ANT-DRL P-30..P-36 hermetic harness (SPR-DRL-02, SPR-DRL-08, SPR-DRL-09)
#   html-transport       — ANT-AHT P-37 ResearchArtifact transport gates
#
...
cmd_html_transport() {
  echo "== html-transport: P-37 ANT-AHT bundle =="
  "${PY}" -m pytest \
