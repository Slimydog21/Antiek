...
#   deep-research        — ANT-DRL P-38..P-44 hermetic harness (SPR-DRL-02, SPR-DRL-08, SPR-DRL-09)
#   html-transport       — ANT-AHT P-45 ResearchArtifact transport gates
#
...
cmd_html_transport() {
  echo "== html-transport: P-45 ANT-AHT bundle =="
  "${PY}" -m pytest \
