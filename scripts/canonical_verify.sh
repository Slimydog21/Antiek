...
#   deep-research        — ANT-DRL P-31..P-37 hermetic harness (SPR-DRL-02, SPR-DRL-08, SPR-DRL-09)
#   html-transport       — ANT-AHT P-38 ResearchArtifact transport gates
#
...
cmd_html_transport() {
  echo "== html-transport: P-38 ANT-AHT bundle =="
  "${PY}" -m pytest \
