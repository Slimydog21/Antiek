...
#   deep-research        — ANT-DRL P-37..P-43 hermetic harness (SPR-DRL-02, SPR-DRL-08, SPR-DRL-09)
#   html-transport       — ANT-AHT P-44 ResearchArtifact transport gates
#
...
cmd_html_transport() {
  echo "== html-transport: P-44 ANT-AHT bundle =="
  "${PY}" -m pytest \
