...
#   deep-research        — ANT-DRL P-43..P-49 hermetic harness (SPR-DRL-02, SPR-DRL-08, SPR-DRL-09)
#   html-transport       — ANT-AHT P-50 ResearchArtifact transport gates
#
...
cmd_html_transport() {
  echo "== html-transport: P-50 ANT-AHT bundle =="
  "${PY}" -m pytest \
