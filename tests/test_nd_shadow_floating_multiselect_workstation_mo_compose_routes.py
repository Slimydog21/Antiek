"""Route tests for ND shadow + multi-select workstation MO."""
...
from interfaces.research.api.nd_shadow_floating_multiselect_workstation_mo_compose_routes import (
...
def _client() -> TestClient:
    app = FastAPI()
    register_nd_shadow_floating_multiselect_workstation_mo_compose_routes(app)
...
def test_compose_route():
    c = _client()
    r = c.post(
        "/research/nd-shadow-floating-multiselect-workstation-mo/compose",
        json={
            "nd_shadow": {
