...
from tests.test_collective_multiselect_floating_dr_workstation_mo_weekly_src_write_mo_weekly_src_write_pack_compose import (
    FLOATING_PACK,
    MULTISELECT,
)

_PATH = (
    "/research/collective-multiselect-floating-dr-workstation-mo-weekly-src-write-mo-weekly-src-write-pack/compose"
)
