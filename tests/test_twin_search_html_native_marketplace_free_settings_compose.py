"""Pure tests for twin search residual over HTML-native marketplace free settings."""
...
from tests.test_html_native_marketplace_free_settings_nd_shadow_compose import (
    HTML_VIEW,
    MARKET_PACK,
)
...
def test_twin_search_html_native_ready():
    c = compose_twin_search_html_native_marketplace_free_settings(
    ...
    assert "remote_index_queried=false" in (
        format_twin_search_html_native_marketplace_free_settings_summary(c)
    )
