...
from substrate.wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose import AUTHORITY
from tests.test_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose import (
    FULLSCREEN_PACK,
    WRITE,
)

_PATH = "/research/wt-fs-dbm-col-fdr-ws-md-twin-search-html-native-mow12-mpk/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose_routes(app)
