...
from tests.test_nd_shadow_recursive_twin_weekly_src_write_mo_weekly_src_write_pack_compose import (
    ND_SHADOW,
    TWIN_PRESENTATION,
)
...
def test_competition_nd_shadow_twin_presentation_weekly_ready():
    c = compose_competition_dr_nd_shadow_weekly_src_write_mo_weekly_src_write_pack(
    ...
    assert "live_dispatch_authorized=false" in (
        format_competition_dr_nd_shadow_weekly_src_write_mo_weekly_src_write_pack_summary(c)
    )
