"""Route tests for fullscreen + draft-before-merge multi-select pack."""
...
def _client() -> TestClient:
    app = FastAPI()
    register_fullscreen_draft_before_merge_floating_multiselect_compose_routes(app)
...
_PATH = "/research/fullscreen-draft-before-merge-floating-multiselect/compose"
