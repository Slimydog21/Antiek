"""Route tests for draft-before-merge + collective multiselect floating DR MO weekly pack."""
...
_PATH = (
    "/research/draft-before-merge-collective-floating-dr-mo-weekly-pack/compose"
)
