...
from tests.test_write_mode_twin_fullscreen_draft_collective_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose import (
    FULLSCREEN_PACK,
    WRITE,
)
...
_PATH = "/research/write-mode-twin-fullscreen-draft-collective-mo-weekly-src-write-mo-weekly-src-write-mo-weekly-src-write-pack/compose"
