"""Route tests for twin search over HTML-native marketplace MO weekly pack."""
...
from tests.test_twin_search_html_native_marketplace_mo_weekly_pack_compose import (
    HTML_PACK,
    TWIN_RECORDS,
)

_PATH = "/research/twin-search-html-native-marketplace-mo-weekly-pack/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_twin_search_html_native_marketplace_mo_weekly_pack_compose_routes(app)
