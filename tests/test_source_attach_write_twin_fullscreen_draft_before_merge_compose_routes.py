...
_PATH = "/research/source-attach-write-twin-fullscreen-draft-before-merge/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_source_attach_write_twin_fullscreen_draft_before_merge_compose_routes(app)
