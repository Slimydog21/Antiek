"""Route tests for midnight oil source attach quality twin compose."""
...
from interfaces.research.api.midnight_oil_source_attach_quality_twin_compose_routes import (
...
def _client() -> TestClient:
    app = FastAPI()
    register_midnight_oil_source_attach_quality_twin_compose_routes(app)
...
def test_compose_route():
    c = _client()
    r = c.post(
        "/research/midnight-oil-source-attach-quality-twin/compose",
        json={
            "operator_id": "op-1",
            "work_minutes": 120,
            "goals": [
