...
from tests.test_settings_decision_competition_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose import (
    COMPETITION_PACK,
    SETTINGS,
)
...
def test_mo_settings_decision_competition_ready():
    c = compose_midnight_oil_settings_decision_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack(
        mo=MO,
    ...
    assert "live_execution_authorized=false" in (
        format_midnight_oil_settings_decision_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_summary(c)
    )
