...
_PATH = "/research/competition-dr-nd-shadow-recursive-twin-presentation-weekly-source-attach-write-twin-fullscreen-draft/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_competition_dr_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_compose_routes(app)
