...
def test_source_attach_write_twin_ready():
    c = compose_source_attach_write_twin_fs_draft_mo_weekly_src_write_mo_weekly_src_write_pack(
        sources=SOURCES,
    ...
    assert "remote_fetched=false" in (
        format_source_attach_write_twin_fs_draft_mo_weekly_src_write_mo_weekly_src_write_pack_summary(c)
    )
