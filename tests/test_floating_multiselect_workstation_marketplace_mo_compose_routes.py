"""Route tests for multi-select → workstation marketplace MO."""
...
from interfaces.research.api.floating_multiselect_workstation_marketplace_mo_compose_routes import (
...
def test_compose_route():
    c = _client()
    r = c.post(
        "/research/floating-multiselect-workstation-marketplace-mo/compose",
        json={
            "multiselect": {
                "session_id": "sess-1",
