...
from tests.test_floating_dr_workstation_record_model_decision_mo_weekly_src_write_mo_weekly_src_write_pack_compose import (
    HIGHLIGHT_LAUNCH,
    RECORD_PACK,
)
...
def test_collective_multiselect_floating_dr_ready():
    c = compose_collective_multiselect_floating_dr_workstation_mo_weekly_src_write_mo_weekly_src_write_pack(
    ...
    assert "live_dispatched=false" in (
        format_collective_multiselect_floating_dr_workstation_mo_weekly_src_write_mo_weekly_src_write_pack_summary(c)
    )
