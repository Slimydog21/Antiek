...
_PATH = "/research/antiek-bench-weekly-source-attach-write-twin-fullscreen-draft/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_antiek_bench_weekly_source_attach_write_twin_fullscreen_draft_compose_routes(app)
