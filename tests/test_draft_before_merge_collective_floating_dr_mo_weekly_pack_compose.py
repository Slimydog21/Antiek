"""Pure tests for draft-before-merge over collective multiselect floating DR MO weekly pack."""
...
from tests.test_collective_multiselect_floating_dr_workstation_mo_weekly_pack_compose import (
    FLOATING_PACK,
    MULTISELECT,
)
...
def test_draft_before_merge_collective_multiselect_ready():
    c = compose_draft_before_merge_collective_floating_dr_mo_weekly_pack(
