...
from tests.test_midnight_oil_settings_decision_weekly_pack_compose import (
    MO,
    SETTINGS_PACK,
)

_PATH = "/research/midnight-oil-settings-decision-weekly-pack/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_midnight_oil_settings_decision_weekly_pack_compose_routes(app)
