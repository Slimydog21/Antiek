"""Route tests for recursive twin + MO competition compose."""
...
from interfaces.research.api.recursive_twin_mo_competition_compose_routes import (
...
def _client() -> TestClient:
    app = FastAPI()
    register_recursive_twin_mo_competition_compose_routes(app)
...
def test_compose_route():
    c = _client()
    r = c.post(
        "/research/recursive-twin-mo-competition/compose",
        json={
    ...
    assert body["authority"] == "recursive_twin_mo_competition_compose_advisory"
