...
_PATH = "/research/workstation-record-model-decision-twin-search-mo-weekly-src-write-pack/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_workstation_record_model_decision_twin_search_mo_weekly_src_write_pack_compose_routes(app)
