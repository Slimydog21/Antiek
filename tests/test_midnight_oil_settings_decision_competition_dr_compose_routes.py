...
from tests.test_midnight_oil_settings_decision_competition_dr_compose import (
    MO,
    SETTINGS_PACK,
)

_PATH = "/research/midnight-oil-settings-decision-competition-dr/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_midnight_oil_settings_decision_competition_dr_compose_routes(app)
