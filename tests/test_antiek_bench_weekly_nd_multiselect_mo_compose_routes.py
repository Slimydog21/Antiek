"""Route tests for Antiek-bench weekly + ND multi-select pack."""
...
from interfaces.research.api.antiek_bench_weekly_nd_multiselect_mo_compose_routes import (
...
def _client() -> TestClient:
    app = FastAPI()
    register_antiek_bench_weekly_nd_multiselect_mo_compose_routes(app)
...
def test_compose_route():
    c = _client()
    r = c.post(
        "/research/antiek-bench-weekly-nd-multiselect-mo/compose",
        json={
            "weekly_learn": {
                "week_id": "2026-W28",
