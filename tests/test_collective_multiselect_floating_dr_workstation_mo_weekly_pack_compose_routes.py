"""Route tests for collective multiselect over floating DR workstation MO weekly pack."""
...
_PATH = (
    "/research/collective-multiselect-floating-dr-workstation-mo-weekly-pack/compose"
)
