...
_PATH = (
    "/research/collective-multiselect-floating-dr-workstation-mo-weekly-src-write-mo-weekly-src-write-mo-weekly-src-write-mo-weekly-src-write-mo-weekly-src-write-mpk/compose"
)
