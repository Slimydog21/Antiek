...
_PATH = "/research/midnight-oil-settings-decision-weekly-src-write-mo-weekly-pack/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_midnight_oil_settings_decision_weekly_src_write_mo_weekly_pack_compose_routes(app)
