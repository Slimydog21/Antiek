...
from tests.test_nd_shadow_recursive_twin_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose import (
    ND_SHADOW,
    TWIN_PRESENTATION,
)
...
_PATH = (
    "/research/nd-shadow-recursive-twin-weekly-src-write-mo-weekly-src-write-mo-weekly-src-write-mo-weekly-src-write-pack/compose"
)
