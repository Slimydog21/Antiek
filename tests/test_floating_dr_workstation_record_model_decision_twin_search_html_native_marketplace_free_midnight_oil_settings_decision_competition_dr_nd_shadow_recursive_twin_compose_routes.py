"""Route tests for floating DR over workstation record model decision twin search pack."""
...
_PATH = "/research/floating-dr-workstation-record-model-decision-twin-search-html-native-marketplace-free-midnight-oil-settings-decision-competition-dr-nd-shadow-recursive-twin/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_floating_dr_workstation_record_model_decision_twin_search_html_native_marketplace_free_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin_compose_routes(app)
...
def test_compose_route():
    ...
    assert body["authority"] == "floating_dr_workstation_record_model_decision_twin_search_html_native_marketplace_free_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin_compose_advisory"
