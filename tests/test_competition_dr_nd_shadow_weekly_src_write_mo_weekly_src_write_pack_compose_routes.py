...
_PATH = "/research/competition-dr-nd-shadow-weekly-src-write-mo-weekly-src-write-pack/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_competition_dr_nd_shadow_weekly_src_write_mo_weekly_src_write_pack_compose_routes(app)
