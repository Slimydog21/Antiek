"""Pure tests for fullscreen over draft-before-merge collective multiselect pack."""
...
from tests.test_draft_before_merge_collective_multiselect_floating_dr_workstation_record_model_decision_twin_search_html_native_marketplace_free_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin_compose import (
    COLLECTIVE_PACK,
    DRAFT_GATE,
)
...
def test_fullscreen_draft_before_merge_collective_ready():
    c = compose_fullscreen_open_draft_before_merge_collective_multiselect_floating_dr_workstation_record_model_decision_twin_search_html_native_marketplace_free_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin(
    ...
    assert "live_dispatched=false" in (
        format_fullscreen_open_draft_before_merge_collective_multiselect_floating_dr_workstation_record_model_decision_twin_search_html_native_marketplace_free_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin_summary(c)
    )
