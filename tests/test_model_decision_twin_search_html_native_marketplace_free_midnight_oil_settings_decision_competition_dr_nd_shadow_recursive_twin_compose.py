"""Pure tests for model decision over twin search HTML-native marketplace free MO."""
...
from tests.test_twin_search_html_native_marketplace_free_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin_compose import (
    HTML_PACK,
    TWIN_RECORDS,
)
...
def test_model_decision_twin_search_pack_ready():
    c = compose_model_decision_twin_search_html_native_marketplace_free_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin(
        decision=DECISION,
