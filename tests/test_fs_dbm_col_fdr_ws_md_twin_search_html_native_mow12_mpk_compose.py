...
def test_fs_dbm_col_fdr_ws_md_mow12_ready():
    c = compose_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk(
    ...
    assert "live_dispatched=false" in (
        format_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_summary(c)
    )
