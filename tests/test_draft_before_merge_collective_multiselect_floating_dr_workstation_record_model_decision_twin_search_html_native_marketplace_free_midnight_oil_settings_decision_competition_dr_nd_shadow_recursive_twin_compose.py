"""Pure tests for draft-before-merge over collective multiselect floating DR workstation pack."""
...
from tests.test_collective_multiselect_floating_dr_workstation_record_model_decision_twin_search_html_native_marketplace_free_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin_compose import (
    FLOATING_PACK,
    MULTISELECT,
)
...
def test_draft_before_merge_collective_multiselect_ready():
    c = compose_draft_before_merge_collective_multiselect_floating_dr_workstation_record_model_decision_twin_search_html_native_marketplace_free_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin(
