"""Route tests for model decision over twin search HTML-native marketplace MO weekly."""
...
_PATH = (
    "/research/model-decision-twin-search-html-native-mo-weekly-pack/compose"
)
