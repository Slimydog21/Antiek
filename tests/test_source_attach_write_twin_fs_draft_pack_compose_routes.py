...
from tests.test_source_attach_write_twin_fs_draft_pack_compose import (
    SOURCES,
    WRITE_PACK,
)

_PATH = "/research/source-attach-write-twin-fs-draft-pack/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_source_attach_write_twin_fs_draft_pack_compose_routes(app)
