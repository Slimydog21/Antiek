"""Pure tests for collective residual over floating DR MD mow12."""
...
def test_col_fdr_ws_md_mow12_ready():
    c = compose_col_fdr_ws_md_twin_search_html_native_mow12_mpk(
    ...
    assert "live_dispatched=false" in (
        format_col_fdr_ws_md_twin_search_html_native_mow12_mpk_summary(c)
    )
