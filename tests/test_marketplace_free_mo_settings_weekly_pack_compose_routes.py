...
from tests.test_marketplace_free_mo_settings_weekly_pack_compose import (
    MARKET,
    MO_PACK,
)

_PATH = "/research/marketplace-free-mo-settings-weekly-pack/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_marketplace_free_mo_settings_weekly_pack_compose_routes(app)
