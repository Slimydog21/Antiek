"""Route tests for source attach + weekly learn twin presentation."""
...
_PATH = "/research/source-attach-antiek-bench-weekly-learn-twin-presentation/compose"
...
def test_compose_route():
    ...
    assert body["sources"]["pack_ready"] is True
