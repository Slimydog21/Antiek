"""Route tests for write twin collective over fullscreen collective multiselect pack."""
...
_PATH = (
    "/research/write-mode-twin-collective-fullscreen-collective-multiselect/compose"
)
