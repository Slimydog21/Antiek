...
def test_ab_sa_wt_fs_dbm_col_fdr_ws_md_mow12_ready():
    c = compose_ab_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk(
    ...
    assert "backlog_mutated=false" in (
        format_ab_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_summary(c)
    )
