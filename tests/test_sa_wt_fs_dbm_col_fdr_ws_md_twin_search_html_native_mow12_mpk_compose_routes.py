...
from substrate.sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose import AUTHORITY
from tests.test_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose import (
    SOURCES,
    WRITE_PACK,
)

_PATH = "/research/sa-wt-fs-dbm-col-fdr-ws-md-twin-search-html-native-mow12-mpk/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose_routes(app)
