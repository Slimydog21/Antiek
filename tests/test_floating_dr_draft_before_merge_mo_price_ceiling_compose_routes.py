"""Route tests for floating DR over draft-before-merge MO price-ceiling pack."""
...
_PATH = "/research/floating-dr-draft-before-merge-mo-price-ceiling/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_floating_dr_draft_before_merge_mo_price_ceiling_compose_routes(app)
...
def test_compose_route():
    ...
    assert body["highlight_surface"]["pack_ready"] is True
