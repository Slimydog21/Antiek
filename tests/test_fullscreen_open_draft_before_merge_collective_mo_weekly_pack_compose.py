"""Pure tests for fullscreen over draft-before-merge collective MO weekly pack."""
...
from tests.test_draft_before_merge_collective_floating_dr_mo_weekly_pack_compose import (
    COLLECTIVE_PACK,
    DRAFT_GATE,
)
...
def test_fullscreen_draft_before_merge_collective_ready():
    c = compose_fullscreen_open_draft_before_merge_collective_mo_weekly_pack(
    ...
    assert "live_dispatched=false" in (
        format_fullscreen_open_draft_before_merge_collective_mo_weekly_pack_summary(c)
    )
