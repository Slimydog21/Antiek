"""Route tests for collective residual over floating DR MD mow12."""
...
from substrate.col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose import AUTHORITY
from tests.test_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose import (
    FLOATING_PACK,
    MULTISELECT,
)

_PATH = "/research/col-fdr-ws-md-twin-search-html-native-mow12-mpk/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose_routes(app)
