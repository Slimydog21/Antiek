"""Route tests for collective multiselect over floating DR workstation record pack."""
...
_PATH = (
    "/research/collective-multiselect-floating-dr-workstation-record-model-decision-twin-search-html-native-marketplace-free-midnight-oil-settings-decision-competition-dr-nd-shadow-recursive-twin/compose"
)
