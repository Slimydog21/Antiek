...
from tests.test_competition_dr_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_compose import (
    COMPETITION,
    ND_PACK,
)
...
def test_settings_decision_competition_pack_ready():
    c = compose_settings_decision_competition_dr_nd_shadow_recursive_twin_presentation_weekly(
        settings=SETTINGS,
    ...
    assert "secrets_stored=false" in (
        format_settings_decision_competition_dr_nd_shadow_recursive_twin_presentation_weekly_summary(c)
    )
