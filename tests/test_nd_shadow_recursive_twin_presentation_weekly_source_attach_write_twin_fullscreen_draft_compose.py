...
from tests.test_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_compose import (
    PRESENTATION,
    TWIN,
    WEEKLY_PACK,
)
...
def test_nd_shadow_twin_presentation_weekly_ready():
    c = compose_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft(
        nd_shadow=ND_SHADOW,
    ...
    assert "live_router_authorized=false" in (
        format_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_summary(c)
    )
