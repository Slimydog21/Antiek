"""Route tests for competition quality write + twin search compose."""
...
from interfaces.research.api.competition_dr_quality_write_twin_search_compose_routes import (
...
def _client() -> TestClient:
    app = FastAPI()
    register_competition_dr_quality_write_twin_search_compose_routes(app)
...
def test_compose_route():
    c = _client()
    r = c.post(
        "/research/competition-dr-quality-write-twin-search/compose",
        json={
            "session_id": "sess-1",
            "draft_id": "draft-1",
