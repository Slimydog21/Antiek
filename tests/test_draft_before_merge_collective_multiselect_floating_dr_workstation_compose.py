...
from tests.test_collective_multiselect_floating_dr_workstation_record_compose import (
    FLOATING_PACK,
    MULTISELECT,
)
...
def test_draft_before_merge_collective_multiselect_ready():
    c = compose_draft_before_merge_collective_multiselect_floating_dr_workstation(
