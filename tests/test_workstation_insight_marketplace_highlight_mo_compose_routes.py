"""Route tests for workstation insight → marketplace highlight MO."""
...
from interfaces.research.api.workstation_insight_marketplace_highlight_mo_compose_routes import (
...
def _client() -> TestClient:
    app = FastAPI()
    register_workstation_insight_marketplace_highlight_mo_compose_routes(app)
...
def test_compose_route():
    c = _client()
    r = c.post(
        "/research/workstation-insight-marketplace-highlight-mo/compose",
        json={
            "records": {
                "session_id": "sess-1",
