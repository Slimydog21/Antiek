...
from tests.test_twin_search_html_native_marketplace_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose import (
    HTML_PACK,
    TWIN_RECORDS,
)
...
def test_model_decision_twin_search_pack_ready():
    c = compose_model_decision_twin_search_html_native_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack(
        decision=DECISION,
