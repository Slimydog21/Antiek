"""Route tests for draft-before-merge residual over collective FDR MD mow12."""
...
from substrate.dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose import AUTHORITY
from tests.test_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose import (
    COLLECTIVE_PACK,
    DRAFT_GATE,
)

_PATH = "/research/dbm-col-fdr-ws-md-twin-search-html-native-mow12-mpk/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose_routes(app)
