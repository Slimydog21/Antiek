...
from tests.test_draft_before_merge_collective_multiselect_floating_dr_workstation_compose import (
    COLLECTIVE_PACK,
    DRAFT_GATE,
)
...
def test_fullscreen_draft_before_merge_collective_ready():
    c = compose_fullscreen_open_draft_before_merge_collective_multiselect(
    ...
    assert "live_dispatched=false" in (
        format_fullscreen_open_draft_before_merge_collective_multiselect_summary(c)
    )
