...
_PATH = "/research/marketplace-free-mo-settings-weekly-src-write-mo-weekly-src-write-pack/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_marketplace_free_mo_settings_weekly_src_write_mo_weekly_src_write_pack_compose_routes(app)
