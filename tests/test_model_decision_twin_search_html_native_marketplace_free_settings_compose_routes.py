"""Route tests for model decision + twin search HTML-native free settings pack."""
...
_PATH = (
    "/research/model-decision-twin-search-html-native-marketplace-free-settings/compose"
)
...
def test_compose_route():
    ...
    assert body["twin_search_pack"]["hit_count"] >= 1
