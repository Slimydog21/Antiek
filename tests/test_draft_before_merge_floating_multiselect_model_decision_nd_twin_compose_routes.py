"""Route tests for draft-before-merge floating multi-select model decision ND twin."""
...
_PATH = "/research/draft-before-merge-floating-multiselect-model-decision-nd-twin/compose"
