"""Route tests for twin search over HTML-native marketplace free MO pack."""
...
_PATH = "/research/twin-search-html-native-marketplace-free-midnight-oil-settings-decision-competition-dr-nd-shadow-recursive-twin/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_twin_search_html_native_marketplace_free_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin_compose_routes(app)
