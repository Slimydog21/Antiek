...
def test_twin_presentation_weekly_source_attach_ready():
    c = compose_recursive_twin_presentation_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack(
        twin=TWIN,
