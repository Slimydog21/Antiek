"""Pure tests for twin search over HTML-native marketplace MO weekly pack."""
...
from tests.test_html_native_marketplace_mo_weekly_pack_compose import (
    HTML_VIEW,
    MARKET_PACK,
)
...
def test_twin_search_html_native_marketplace_mo_weekly_ready():
    c = compose_twin_search_html_native_marketplace_mo_weekly_pack(
    ...
    assert "remote_index_queried=false" in (
        format_twin_search_html_native_marketplace_mo_weekly_pack_summary(c)
    )
