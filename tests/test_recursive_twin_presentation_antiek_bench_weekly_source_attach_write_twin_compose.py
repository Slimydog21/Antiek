...
from tests.test_antiek_bench_weekly_source_attach_write_twin_compose import (
    SOURCE_PACK,
    WEEKLY_LEARN,
)
...
def test_twin_presentation_weekly_source_attach_ready():
    c = compose_recursive_twin_presentation_antiek_bench_weekly_source_attach_write_twin(
        twin=TWIN,
