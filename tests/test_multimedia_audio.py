...
def test_compatibility_normalization_keeps_source_alignment_and_pronunciation_notes():
    paragraphs = normalize_script_for_audio(_compatibility_plan())
...
def test_compatibility_fake_tts_audio_manifest_has_hashes_transcripts_and_chapters():
    asset = assemble_compatibility_audio_experience(
        _compatibility_plan(),
        asset_id="mm-audio",
...
def test_compatibility_every_spoken_factual_paragraph_has_status_before_render():
...
def test_compatibility_playback_model_exposes_current_chapter_sources_and_steering_target():
    asset = assemble_compatibility_audio_experience(
        _compatibility_plan(),
        asset_id="mm-audio",
        revision_id="rev-audio",
...
def test_compatibility_transcript_delta_is_recorded_when_provider_differs():
    class MutatingTTS:
        name = "mutating"
        model = "test"

        def synthesize(self, request):
            return CompatibilityTTSResult(
                audio_bytes=b"audio",
