"""Route tests for source attach quality interrogation twin compose."""
...
from interfaces.research.api.source_attach_quality_interrogation_twin_compose_routes import (
...
def _client() -> TestClient:
    app = FastAPI()
    register_source_attach_quality_interrogation_twin_compose_routes(app)
...
def test_compose_route():
    c = _client()
    r = c.post(
        "/research/source-attach-quality-interrogation-twin/compose",
        json={
            "session_id": "sess-1",
...
def test_compose_route_budget_block():
    ...
    r = c.post(
        ...
        json={
            ...
            "operator_ack": True,
            "questions": [
                {"question_id": "q1", "body": "Chase?", "priority": 1}
            ],
