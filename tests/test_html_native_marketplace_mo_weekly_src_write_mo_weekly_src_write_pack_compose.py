...
from tests.test_marketplace_free_mo_settings_weekly_src_write_mo_weekly_src_write_pack_compose import (
    MARKET,
    MO_PACK,
)
...
def test_html_native_marketplace_free_mo_ready():
    c = compose_html_native_marketplace_mo_weekly_src_write_mo_weekly_src_write_pack(
        html_view=HTML_VIEW,
    ...
    assert "pdf_primary=false" in (
        format_html_native_marketplace_mo_weekly_src_write_mo_weekly_src_write_pack_summary(c)
    )
