"""Pure tests for write twin collective over fullscreen collective multiselect pack."""
...
from tests.test_fullscreen_open_collective_multiselect_floating_dr_compose import (
    COLLECTIVE_PACK,
    FULLSCREEN,
)
...
def test_write_twin_collective_fullscreen_ready():
    c = compose_write_mode_twin_collective_fullscreen_collective_multiselect(
        write=WRITE,
