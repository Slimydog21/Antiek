"""Route tests for MO + model decision + HTML competition compose."""
...
from interfaces.research.api.mo_model_decision_html_native_competition_compose_routes import (
...
def _client() -> TestClient:
    app = FastAPI()
    register_mo_model_decision_html_native_competition_compose_routes(app)
...
def test_compose_route():
    c = _client()
    r = c.post(
        "/research/mo-model-decision-html-native-competition/compose",
        json={
            "mo": {
                "operator_id": "op-1",
                "work_minutes": 120,
