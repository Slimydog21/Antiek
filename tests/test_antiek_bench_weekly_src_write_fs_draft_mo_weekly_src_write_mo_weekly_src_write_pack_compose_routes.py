...
from tests.test_antiek_bench_weekly_src_write_fs_draft_mo_weekly_src_write_mo_weekly_src_write_pack_compose import (
    SOURCE_PACK,
    WEEKLY_LEARN,
)
from tests.test_source_attach_write_twin_fs_draft_mo_weekly_src_write_mo_weekly_src_write_pack_compose import (
    SOURCES,
    WRITE_PACK,
)

_PATH = "/research/antiek-bench-weekly-src-write-fs-draft-mo-weekly-src-write-mo-weekly-src-write-pack/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_antiek_bench_weekly_src_write_fs_draft_mo_weekly_src_write_mo_weekly_src_write_pack_compose_routes(app)
