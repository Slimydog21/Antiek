...
from substrate.md_twin_search_html_native_mow12_mpk_compose import AUTHORITY
from tests.test_md_twin_search_html_native_mow12_mpk_compose import (
    DECISION,
    TWIN_SEARCH_PACK,
)

_PATH = "/research/md-twin-search-html-native-mow12-mpk/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_md_twin_search_html_native_mow12_mpk_compose_routes(app)
