"""Route tests for twin search over competition DR ND weekly marketplace pack."""
...
def _payload(
    *,
    ...
    search_query: str = "scaling orchestration residual",
) -> dict:
...
def test_compose_route():
    c = _client()
    r = c.post(
        "/research/twin-search-competition-dr-nd-shadow-weekly-marketplace/compose",
