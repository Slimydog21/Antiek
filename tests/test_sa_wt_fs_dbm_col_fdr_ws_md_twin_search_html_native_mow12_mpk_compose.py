...
def test_sa_wt_fs_dbm_col_fdr_ws_md_mow12_ready():
    c = compose_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk(
        sources=SOURCES,
    ...
    assert "remote_fetched=false" in (
        format_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_summary(c)
    )
