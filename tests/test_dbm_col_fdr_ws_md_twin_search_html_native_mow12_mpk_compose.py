"""Pure tests for draft-before-merge residual over collective FDR MD mow12."""
...
def test_dbm_col_fdr_ws_md_mow12_ready():
    c = compose_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk(
    ...
    assert "merge_executed=false" in (
        format_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_summary(c)
    )
