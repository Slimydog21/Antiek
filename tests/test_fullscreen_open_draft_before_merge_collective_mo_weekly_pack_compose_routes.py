"""Route tests for fullscreen + draft-before-merge collective MO weekly pack."""
...
_PATH = "/research/fullscreen-open-draft-before-merge-collective-mo-weekly-pack/compose"
