"""Route tests for floating DR over workstation record model decision pack."""
...
from tests.test_floating_dr_workstation_record_model_decision_compose import (
    HIGHLIGHT_LAUNCH,
    RECORD_PACK,
)

_PATH = "/research/floating-dr-workstation-record-model-decision/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_floating_dr_workstation_record_model_decision_compose_routes(app)
