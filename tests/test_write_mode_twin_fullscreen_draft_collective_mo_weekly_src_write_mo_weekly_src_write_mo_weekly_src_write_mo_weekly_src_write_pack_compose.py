...
from tests.test_fullscreen_open_draft_before_merge_collective_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose import (
    DRAFT_PACK,
    FULLSCREEN,
)
...
def test_write_twin_collective_fullscreen_draft_before_merge_ready():
    c = compose_write_mode_twin_fullscreen_draft_collective_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack(
        write=WRITE,
    ...
    assert "analysis_written=false" in (
        format_write_mode_twin_fullscreen_draft_collective_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_summary(c)
    )
