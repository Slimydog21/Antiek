"""Route tests for floating DR over workstation record model decision MO weekly pack."""
...
_PATH = "/research/floating-dr-workstation-record-model-decision-mo-weekly-pack/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_floating_dr_workstation_record_model_decision_mo_weekly_pack_compose_routes(app)
