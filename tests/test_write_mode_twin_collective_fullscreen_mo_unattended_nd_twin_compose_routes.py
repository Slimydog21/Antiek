"""Route tests for write twin collective + fullscreen MO unattended ND twin."""
...
_PATH = "/research/write-mode-twin-collective-fullscreen-mo-unattended-nd-twin/compose"
