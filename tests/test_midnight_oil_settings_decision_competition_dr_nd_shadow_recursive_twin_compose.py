...
from tests.test_settings_decision_competition_dr_nd_shadow_recursive_twin_presentation_weekly_compose import (
    COMPETITION_PACK,
    SETTINGS,
)
...
def test_mo_settings_decision_competition_ready():
    c = compose_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin(
        mo=MO,
    ...
    assert "live_execution_authorized=false" in (
        format_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin_summary(c)
    )
