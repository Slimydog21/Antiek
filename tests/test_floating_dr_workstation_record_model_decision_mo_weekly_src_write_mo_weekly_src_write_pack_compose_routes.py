...
_PATH = "/research/floating-dr-workstation-record-model-decision-mo-weekly-src-write-mo-weekly-src-write-pack/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_floating_dr_workstation_record_model_decision_mo_weekly_src_write_mo_weekly_src_write_pack_compose_routes(app)
