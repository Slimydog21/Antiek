...
from tests.test_source_attach_write_twin_collective_fullscreen_compose import (
    SOURCES,
    WRITE_PACK,
)

_PATH = "/research/antiek-bench-weekly-source-attach-write-twin/compose"


def _client() -> TestClient:
    app = FastAPI()
    register_antiek_bench_weekly_source_attach_write_twin_compose_routes(app)
