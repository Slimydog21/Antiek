...
from interfaces.research.api.antiek_bench_weekly_source_attach_write_twin_fullscreen_draft_compose_routes import (
    SourcePackBody,
    WeeklyLearnBody,
)
...
recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_compose_router = (
    APIRouter(
        prefix=(
            "/research/recursive-twin-presentation-weekly-source-attach-write-twin-fullscreen-draft"
        ),
        tags=[
            "recursive-twin-presentation-weekly-source-attach-write-twin-fullscreen-draft-compose"
        ],
    )
)
...
@recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_compose_router.post(
    "/compose"
)
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft(
...
def register_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
        recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_compose_router
