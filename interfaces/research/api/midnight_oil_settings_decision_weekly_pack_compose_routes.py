...
midnight_oil_settings_decision_weekly_pack_compose_router = APIRouter(
    prefix="/research/midnight-oil-settings-decision-weekly-pack",
    tags=["midnight-oil-settings-decision-weekly-pack-compose"],
)
...
@midnight_oil_settings_decision_weekly_pack_compose_router.post("/compose")
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_midnight_oil_settings_decision_weekly_pack(
...
def register_midnight_oil_settings_decision_weekly_pack_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
        midnight_oil_settings_decision_weekly_pack_compose_router
    )


__all__ = [
    "midnight_oil_settings_decision_weekly_pack_compose_router",
    "register_midnight_oil_settings_decision_weekly_pack_compose_routes",
]
