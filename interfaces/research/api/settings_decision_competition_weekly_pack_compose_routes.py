...
from interfaces.research.api.competition_dr_nd_shadow_weekly_pack_compose_routes import (
    CompetitionBody,
    NdPackBody,
)
...
settings_decision_competition_weekly_pack_compose_router = APIRouter(
    prefix="/research/settings-decision-competition-weekly-pack",
    tags=["settings-decision-competition-weekly-pack-compose"],
)
...
@settings_decision_competition_weekly_pack_compose_router.post(
    "/compose"
)
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_settings_decision_competition_weekly_pack(
...
def register_settings_decision_competition_weekly_pack_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
        settings_decision_competition_weekly_pack_compose_router
    )
