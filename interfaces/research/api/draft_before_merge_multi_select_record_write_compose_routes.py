"""Registerable HTTP surface for draft-before-merge + multi-select record write pack."""
...
draft_before_merge_multi_select_record_write_compose_router = APIRouter(
    prefix="/research/draft-before-merge-multi-select-record-write",
    tags=["draft-before-merge-multi-select-record-write-compose"],
)
...
@draft_before_merge_multi_select_record_write_compose_router.post("/compose")
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_draft_before_merge_multi_select_record_write(
...
def register_draft_before_merge_multi_select_record_write_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(draft_before_merge_multi_select_record_write_compose_router)


__all__ = [
    "draft_before_merge_multi_select_record_write_compose_router",
