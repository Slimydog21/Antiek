"""Registerable HTTP surface for ND shadow + twin presentation competition pack."""
...
nd_shadow_twin_presentation_competition_compose_router = APIRouter(
    prefix="/research/nd-shadow-twin-presentation-competition",
    tags=["nd-shadow-twin-presentation-competition-compose"],
)
...
@nd_shadow_twin_presentation_competition_compose_router.post("/compose")
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_nd_shadow_twin_presentation_competition(
...
def register_nd_shadow_twin_presentation_competition_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(nd_shadow_twin_presentation_competition_compose_router)


__all__ = [
    "nd_shadow_twin_presentation_competition_compose_router",
