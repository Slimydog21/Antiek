...
from interfaces.research.api.fullscreen_open_draft_before_merge_collective_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_routes import (
    DraftPackBody,
    FullscreenBody,
)
...
write_mode_twin_fullscreen_draft_collective_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_router = (
    APIRouter(
        prefix=(
            "/research/write-mode-twin-fullscreen-draft-collective-mo-weekly-src-write-mo-weekly-src-write-mo-weekly-src-write-pack"
        ),
        tags=[
            "write-mode-twin-fullscreen-draft-collective-mo-weekly-src-write-mo-weekly-src-write-mo-weekly-src-write-pack-compose"
        ],
    )
)
...
@write_mode_twin_fullscreen_draft_collective_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_router.post(
    "/compose"
)
...
def register_write_mode_twin_fullscreen_draft_collective_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
        write_mode_twin_fullscreen_draft_collective_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_router
...
__all__ = [
    ...
    "FullscreenPackBody",
    "write_mode_twin_fullscreen_draft_collective_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_router",
    "register_write_mode_twin_fullscreen_draft_collective_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_routes",
]
