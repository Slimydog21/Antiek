"""Registerable HTTP surface for Antiek-bench recommend + MO unattended fullscreen draft."""
...
from interfaces.research.api.mo_unattended_fullscreen_draft_before_merge_multiselect_compose_routes import (
    FullscreenPackBody,
    MoBody,
)
...
antiek_bench_recommend_mo_unattended_fullscreen_draft_compose_router = APIRouter(
    prefix="/research/antiek-bench-recommend-mo-unattended-fullscreen-draft",
    tags=["antiek-bench-recommend-mo-unattended-fullscreen-draft-compose"],
)
...
@antiek_bench_recommend_mo_unattended_fullscreen_draft_compose_router.post(
    "/compose"
)
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_antiek_bench_recommend_mo_unattended_fullscreen_draft(
...
def register_antiek_bench_recommend_mo_unattended_fullscreen_draft_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
        antiek_bench_recommend_mo_unattended_fullscreen_draft_compose_router
    )
