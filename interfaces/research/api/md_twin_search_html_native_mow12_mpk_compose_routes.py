...
md_twin_search_html_native_mow12_mpk_compose_router = APIRouter(
    prefix="/research/md-twin-search-html-native-mow12-mpk",
    tags=["md-twin-search-html-native-mow12-mpk-compose"],
)
...
@md_twin_search_html_native_mow12_mpk_compose_router.post("/compose")
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_md_twin_search_html_native_mow12_mpk(
...
def register_md_twin_search_html_native_mow12_mpk_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(md_twin_search_html_native_mow12_mpk_compose_router)


__all__ = [
    "md_twin_search_html_native_mow12_mpk_compose_router",
    "register_md_twin_search_html_native_mow12_mpk_compose_routes",
    "AUTHORITY",
]
