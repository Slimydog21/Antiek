"""Registerable HTTP surface for fullscreen + weekly ND multi-select pack."""
...
floating_fullscreen_antiek_bench_weekly_nd_mo_compose_router = APIRouter(
    prefix="/research/floating-fullscreen-antiek-bench-weekly-nd-mo",
    tags=["floating-fullscreen-antiek-bench-weekly-nd-mo-compose"],
)
...
@floating_fullscreen_antiek_bench_weekly_nd_mo_compose_router.post("/compose")
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_floating_fullscreen_antiek_bench_weekly_nd_mo(
            fullscreen=req.fullscreen.model_dump(),
            weekly_nd=req.weekly_nd.model_dump(),
...
def register_floating_fullscreen_antiek_bench_weekly_nd_mo_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
        floating_fullscreen_antiek_bench_weekly_nd_mo_compose_router
    )
