...
from interfaces.research.api.ab_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose_routes import (
    SourcePackBody,
    WeeklyLearnBody,
)
...
rt_ab_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose_router = APIRouter(
    prefix="/research/rt-ab-sa-wt-fs-dbm-col-fdr-ws-md-twin-search-html-native-mow12-mpk",
    tags=["rt-ab-sa-wt-fs-dbm-col-fdr-ws-md-twin-search-html-native-mow12-mpk-compose"],
)
...
@rt_ab_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose_router.post(
    "/compose"
)
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_rt_ab_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk(
...
def register_rt_ab_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
        rt_ab_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose_router
    )


__all__ = [
    "rt_ab_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose_router",
    "register_rt_ab_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpk_compose_routes",
    "AUTHORITY",
]
