...
from substrate.midnight_oil import (
    ...
    MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryEvidenceSealAttestationPlanRequest,
    ...
    MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationPlanRequest,
    ...
    MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationVerificationCommitResultFinalizationPlanReceipt,
    MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationVerificationCommitResultFinalizationPlanRequest,
    MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationVerificationCommitResultFinalizationResultPlanReceipt,
    MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationVerificationCommitResultFinalizationResultPlanRequest,
    ...
    MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorDeliveryAcknowledgementBundlePlanRequest,
    MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorDeliveryAcknowledgementBundleResultReconciliationPlanReceipt,
    MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorDeliveryAcknowledgementBundleResultReconciliationPlanRequest,
    ...
    operator_archive_package_delivery_report_final_delivery_evidence_seal_attestation_plan_midnight_oil,
    ...
    operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_plan_midnight_oil,
    operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_verification_commit_plan_midnight_oil,
    operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_verification_commit_result_finalization_plan_midnight_oil,
    operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_verification_commit_result_finalization_result_plan_midnight_oil,
    operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_verification_commit_result_plan_midnight_oil,
    ...
    operator_archive_package_delivery_report_final_operator_delivery_acknowledgement_bundle_plan_midnight_oil,
    operator_archive_package_delivery_report_final_operator_delivery_acknowledgement_bundle_result_reconciliation_plan_midnight_oil,
...
@midnight_oil_router.post(
    ...
    response_model=MidnightOilFinalCloseoutArchiveReconciliationPlanReceipt,
)
def post_midnight_oil_final_closeout_archive_reconciliation_plan(
...
@midnight_oil_router.post(
    "/operator-archive-handoff-package-result-reconciliation-plan",
    response_model=MidnightOilOperatorArchiveHandoffPackageResultReconciliationPlanReceipt,
)
def post_midnight_oil_operator_archive_handoff_package_result_reconciliation_plan(
...
@midnight_oil_router.post(
    "/operator-archive-handoff-package-delivery-audit-result-reconciliation-plan",
    response_model=MidnightOilOperatorArchiveHandoffPackageDeliveryAuditResultReconciliationPlanReceipt,
)
def post_midnight_oil_operator_archive_handoff_package_delivery_audit_result_reconciliation_plan(
    req: MidnightOilOperatorArchiveHandoffPackageDeliveryAuditResultReconciliationPlanRequest,
) -> MidnightOilOperatorArchiveHandoffPackageDeliveryAuditResultReconciliationPlanReceipt:
    return operator_archive_handoff_package_delivery_audit_result_reconciliation_plan_midnight_oil(
        req
    )
...
@midnight_oil_router.post(
    ...
    response_model=MidnightOilOperatorArchivePackageDeliveryReportPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportPlanReceipt:
    return operator_archive_package_delivery_report_plan_midnight_oil(req)


@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-result-reconciliation-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportResultReconciliationPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_result_reconciliation_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportResultReconciliationPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportResultReconciliationPlanReceipt:
    return operator_archive_package_delivery_report_result_reconciliation_plan_midnight_oil(
        req
    )
...
@midnight_oil_router.post(
    ...
    response_model=MidnightOilOperatorArchivePackageDeliveryReportNotificationResultReconciliationPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_notification_result_reconciliation_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportNotificationResultReconciliationPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportNotificationResultReconciliationPlanReceipt:
    return operator_archive_package_delivery_report_notification_result_reconciliation_plan_midnight_oil(
        req
    )
...
@midnight_oil_router.post(
    ...
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorAcknowledgementPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_operator_acknowledgement_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorAcknowledgementPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorAcknowledgementPlanReceipt:
    return operator_archive_package_delivery_report_final_operator_acknowledgement_plan_midnight_oil(
        req
    )
...
@midnight_oil_router.post(
    ...
    response_model=MidnightOilOperatorArchivePackageDeliveryReportAcknowledgementResultReconciliationPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_acknowledgement_result_reconciliation_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportAcknowledgementResultReconciliationPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportAcknowledgementResultReconciliationPlanReceipt:
    return operator_archive_package_delivery_report_acknowledgement_result_reconciliation_plan_midnight_oil(
        req
    )
...
@midnight_oil_router.post(
    ...
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorDeliveryCloseoutPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_operator_delivery_closeout_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorDeliveryCloseoutPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorDeliveryCloseoutPlanReceipt:
    return operator_archive_package_delivery_report_final_operator_delivery_closeout_plan_midnight_oil(
        req
    )
...
@midnight_oil_router.post(
    ...
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorDeliveryCloseoutResultReconciliationPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_operator_delivery_closeout_result_reconciliation_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorDeliveryCloseoutResultReconciliationPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorDeliveryCloseoutResultReconciliationPlanReceipt:
    return operator_archive_package_delivery_report_final_operator_delivery_closeout_result_reconciliation_plan_midnight_oil(
        req
    )


@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-final-delivery-audit-envelope-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryAuditEnvelopePlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_delivery_audit_envelope_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryAuditEnvelopePlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryAuditEnvelopePlanReceipt:
    return operator_archive_package_delivery_report_final_delivery_audit_envelope_plan_midnight_oil(
        req
    )


@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-final-delivery-audit-envelope-result-reconciliation-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryAuditEnvelopeResultReconciliationPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_delivery_audit_envelope_result_reconciliation_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryAuditEnvelopeResultReconciliationPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryAuditEnvelopeResultReconciliationPlanReceipt:
    return operator_archive_package_delivery_report_final_delivery_audit_envelope_result_reconciliation_plan_midnight_oil(
        req
    )
...
@midnight_oil_router.post(
    ...
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalDispatchAttestationPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_dispatch_attestation_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalDispatchAttestationPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalDispatchAttestationPlanReceipt:
    return operator_archive_package_delivery_report_final_dispatch_attestation_plan_midnight_oil(
        req
    )


@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-final-dispatch-attestation-result-reconciliation-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalDispatchAttestationResultReconciliationPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_dispatch_attestation_result_reconciliation_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalDispatchAttestationResultReconciliationPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalDispatchAttestationResultReconciliationPlanReceipt:
    return operator_archive_package_delivery_report_final_dispatch_attestation_result_reconciliation_plan_midnight_oil(
        req
    )
...
@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-final-operator-archive-seal-acknowledgement-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorArchiveSealAcknowledgementPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_operator_archive_seal_acknowledgement_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorArchiveSealAcknowledgementPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorArchiveSealAcknowledgementPlanReceipt:
    return operator_archive_package_delivery_report_final_operator_archive_seal_acknowledgement_plan_midnight_oil(
        req
    )


@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-final-delivery-evidence-seal-attestation-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryEvidenceSealAttestationPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_delivery_evidence_seal_attestation_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryEvidenceSealAttestationPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryEvidenceSealAttestationPlanReceipt:
    return operator_archive_package_delivery_report_final_delivery_evidence_seal_attestation_plan_midnight_oil(
        req
    )


@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-final-delivery-evidence-seal-attestation-result-reconciliation-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryEvidenceSealAttestationResultReconciliationPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_delivery_evidence_seal_attestation_result_reconciliation_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryEvidenceSealAttestationResultReconciliationPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryEvidenceSealAttestationResultReconciliationPlanReceipt:
    return operator_archive_package_delivery_report_final_delivery_evidence_seal_attestation_result_reconciliation_plan_midnight_oil(
        req
    )


@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-final-operator-delivery-acknowledgement-bundle-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorDeliveryAcknowledgementBundlePlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_operator_delivery_acknowledgement_bundle_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorDeliveryAcknowledgementBundlePlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorDeliveryAcknowledgementBundlePlanReceipt:
    return operator_archive_package_delivery_report_final_operator_delivery_acknowledgement_bundle_plan_midnight_oil(
        req
    )


@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-final-operator-delivery-acknowledgement-bundle-result-reconciliation-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorDeliveryAcknowledgementBundleResultReconciliationPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_operator_delivery_acknowledgement_bundle_result_reconciliation_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorDeliveryAcknowledgementBundleResultReconciliationPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalOperatorDeliveryAcknowledgementBundleResultReconciliationPlanReceipt:
    return operator_archive_package_delivery_report_final_operator_delivery_acknowledgement_bundle_result_reconciliation_plan_midnight_oil(
        req
    )


@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-final-delivery-handoff-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffPlanReceipt:
    return operator_archive_package_delivery_report_final_delivery_handoff_plan_midnight_oil(
        req
    )


@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-final-delivery-handoff-result-reconciliation-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultReconciliationPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_result_reconciliation_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultReconciliationPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultReconciliationPlanReceipt:
    return operator_archive_package_delivery_report_final_delivery_handoff_result_reconciliation_plan_midnight_oil(
        req
    )


@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-final-delivery-handoff-result-persistence-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistencePlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistencePlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistencePlanReceipt:
    return operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_plan_midnight_oil(
        req
    )


@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-final-delivery-handoff-result-persistence-audit-attestation-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationPlanReceipt:
    return operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_plan_midnight_oil(
        req
    )


@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-final-delivery-handoff-result-persistence-audit-attestation-result-reconciliation-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationPlanReceipt:
    return operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_plan_midnight_oil(
        req
    )


@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-final-delivery-handoff-result-persistence-audit-attestation-result-reconciliation-verification-commit-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationVerificationCommitPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_verification_commit_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationVerificationCommitPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationVerificationCommitPlanReceipt:
    return operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_verification_commit_plan_midnight_oil(
        req
    )


@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-final-delivery-handoff-result-persistence-audit-attestation-result-reconciliation-verification-commit-result-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationVerificationCommitResultPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_verification_commit_result_plan(
    ...
    return operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_verification_commit_result_plan_midnight_oil(
        req
    )


@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-final-delivery-handoff-result-persistence-audit-attestation-result-reconciliation-verification-commit-result-finalization-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationVerificationCommitResultFinalizationPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_verification_commit_result_finalization_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationVerificationCommitResultFinalizationPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationVerificationCommitResultFinalizationPlanReceipt:
    return operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_verification_commit_result_finalization_plan_midnight_oil(
        req
    )


@midnight_oil_router.post(
    "/operator-archive-package-delivery-report-final-delivery-handoff-result-persistence-audit-attestation-result-reconciliation-verification-commit-result-finalization-result-plan",
    response_model=MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationVerificationCommitResultFinalizationResultPlanReceipt,
)
def post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_verification_commit_result_finalization_result_plan(
    req: MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationVerificationCommitResultFinalizationResultPlanRequest,
) -> MidnightOilOperatorArchivePackageDeliveryReportFinalDeliveryHandoffResultPersistenceAuditAttestationResultReconciliationVerificationCommitResultFinalizationResultPlanReceipt:
    return operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_verification_commit_result_finalization_result_plan_midnight_oil(
        req
    )
...
__all__ = [
    ...
    "post_midnight_oil_final_closeout_archive_reconciliation_plan",
    ...
    "post_midnight_oil_operator_archive_package_delivery_report_final_operator_delivery_closeout_plan",
    ...
    "post_midnight_oil_operator_archive_package_delivery_report_final_delivery_evidence_seal_attestation_plan",
    "post_midnight_oil_operator_archive_package_delivery_report_final_delivery_evidence_seal_attestation_result_reconciliation_plan",
    "post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_plan",
    "post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_plan",
    "post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_plan",
    "post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_verification_commit_plan",
    "post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_verification_commit_result_finalization_plan",
    "post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_verification_commit_result_finalization_result_plan",
    "post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_audit_attestation_result_reconciliation_verification_commit_result_plan",
    "post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_result_persistence_plan",
    "post_midnight_oil_operator_archive_package_delivery_report_final_delivery_handoff_result_reconciliation_plan",
    ...
    "post_midnight_oil_operator_archive_package_delivery_report_final_operator_archive_seal_acknowledgement_plan",
    "post_midnight_oil_operator_archive_package_delivery_report_final_operator_delivery_acknowledgement_bundle_plan",
    "post_midnight_oil_operator_archive_package_delivery_report_final_operator_delivery_acknowledgement_bundle_result_reconciliation_plan",
