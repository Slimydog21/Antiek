...
from interfaces.research.api.fullscreen_open_draft_before_merge_collective_multiselect_compose_routes import (
    DraftPackBody,
    FullscreenBody,
)
...
write_mode_twin_collective_fullscreen_draft_before_merge_compose_router = (
    APIRouter(
        prefix=(
            "/research/write-mode-twin-collective-fullscreen-draft-before-merge"
        ),
        tags=[
            "write-mode-twin-collective-fullscreen-draft-before-merge-compose"
        ],
    )
)
...
@write_mode_twin_collective_fullscreen_draft_before_merge_compose_router.post(
    "/compose"
)
...
def register_write_mode_twin_collective_fullscreen_draft_before_merge_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
        write_mode_twin_collective_fullscreen_draft_before_merge_compose_router
