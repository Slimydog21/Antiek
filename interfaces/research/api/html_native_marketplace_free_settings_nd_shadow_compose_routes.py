"""Registerable HTTP surface for HTML-native view over marketplace free settings ND."""
...
from interfaces.research.api.marketplace_free_settings_add_model_nd_shadow_compose_routes import (
    MarketBody,
    SettingsPackBody,
)
...
html_native_marketplace_free_settings_nd_shadow_compose_router = APIRouter(
    prefix="/research/html-native-marketplace-free-settings-nd-shadow",
    tags=["html-native-marketplace-free-settings-nd-shadow-compose"],
)
...
@html_native_marketplace_free_settings_nd_shadow_compose_router.post("/compose")
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_html_native_marketplace_free_settings_nd_shadow(
...
def register_html_native_marketplace_free_settings_nd_shadow_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
