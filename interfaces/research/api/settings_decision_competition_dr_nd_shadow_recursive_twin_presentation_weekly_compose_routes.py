...
from interfaces.research.api.competition_dr_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_compose_routes import (
    CompetitionBody,
    NdPackBody,
)
...
settings_decision_competition_dr_nd_shadow_recursive_twin_presentation_weekly_compose_router = APIRouter(
    prefix="/research/settings-decision-competition-dr-nd-shadow-recursive-twin-presentation-weekly",
    tags=["settings-decision-competition-dr-nd-shadow-recursive-twin-presentation-weekly-compose"],
)
...
@settings_decision_competition_dr_nd_shadow_recursive_twin_presentation_weekly_compose_router.post(
    "/compose"
)
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_settings_decision_competition_dr_nd_shadow_recursive_twin_presentation_weekly(
...
def register_settings_decision_competition_dr_nd_shadow_recursive_twin_presentation_weekly_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
