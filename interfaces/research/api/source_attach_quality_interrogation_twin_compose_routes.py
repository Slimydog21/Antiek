"""Registerable HTTP surface for source attach quality interrogation twin compose."""
...
source_attach_quality_interrogation_twin_compose_router = APIRouter(
    prefix="/research/source-attach-quality-interrogation-twin",
    tags=["source-attach-quality-interrogation-twin-compose"],
)
...
@source_attach_quality_interrogation_twin_compose_router.post("/compose")
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_source_attach_quality_interrogation_twin(
    ...
    except SourceAttachQualityInterrogationTwinComposeError as e:
        raise HTTPException(status_code=400, detail=str(e)) from e
    return result.to_dict()


def register_source_attach_quality_interrogation_twin_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(source_attach_quality_interrogation_twin_compose_router)


__all__ = [
    "source_attach_quality_interrogation_twin_compose_router",
    "register_source_attach_quality_interrogation_twin_compose_routes",
]
