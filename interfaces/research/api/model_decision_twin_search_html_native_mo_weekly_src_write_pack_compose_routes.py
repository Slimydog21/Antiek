...
from interfaces.research.api.twin_search_html_native_marketplace_mo_weekly_src_write_pack_compose_routes import (
    HtmlPackBody,
    TwinRecordBody,
)
...
model_decision_twin_search_html_native_mo_weekly_src_write_pack_compose_router = APIRouter(
    prefix="/research/model-decision-twin-search-html-native-mo-weekly-src-write-pack",
    tags=["model-decision-twin-search-html-native-mo-weekly-src-write-pack-compose"],
)
...
@model_decision_twin_search_html_native_mo_weekly_src_write_pack_compose_router.post(
    "/compose"
)
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_model_decision_twin_search_html_native_mo_weekly_src_write_pack(
...
def register_model_decision_twin_search_html_native_mo_weekly_src_write_pack_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
