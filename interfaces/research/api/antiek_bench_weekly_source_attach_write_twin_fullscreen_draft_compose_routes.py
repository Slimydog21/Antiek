...
from interfaces.research.api.source_attach_write_twin_fullscreen_draft_before_merge_compose_routes import (
    SourcesBody,
    WritePackBody,
)
...
antiek_bench_weekly_source_attach_write_twin_fullscreen_draft_compose_router = APIRouter(
    prefix="/research/antiek-bench-weekly-source-attach-write-twin-fullscreen-draft",
    tags=["antiek-bench-weekly-source-attach-write-twin-fullscreen-draft-compose"],
)
...
@antiek_bench_weekly_source_attach_write_twin_fullscreen_draft_compose_router.post("/compose")
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_antiek_bench_weekly_source_attach_write_twin_fullscreen_draft(
...
def register_antiek_bench_weekly_source_attach_write_twin_fullscreen_draft_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
