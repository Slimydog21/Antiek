"""Registerable HTTP surface for MO + model decision + HTML competition."""
...
mo_model_decision_html_native_competition_compose_router = APIRouter(
    prefix="/research/mo-model-decision-html-native-competition",
    tags=["mo-model-decision-html-native-competition-compose"],
)
...
@mo_model_decision_html_native_competition_compose_router.post("/compose")
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_mo_model_decision_html_native_competition(
...
def register_mo_model_decision_html_native_competition_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
        mo_model_decision_html_native_competition_compose_router
    )


__all__ = [
    "mo_model_decision_html_native_competition_compose_router",
    "register_mo_model_decision_html_native_competition_compose_routes",
]
