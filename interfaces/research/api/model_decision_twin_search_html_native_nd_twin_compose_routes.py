"""Registerable HTTP surface for model decision + twin search HTML-native ND twin."""
...
model_decision_twin_search_html_native_nd_twin_compose_router = APIRouter(
    prefix="/research/model-decision-twin-search-html-native-nd-twin",
    tags=["model-decision-twin-search-html-native-nd-twin-compose"],
)
...
@model_decision_twin_search_html_native_nd_twin_compose_router.post("/compose")
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_model_decision_twin_search_html_native_nd_twin(
...
def register_model_decision_twin_search_html_native_nd_twin_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
        model_decision_twin_search_html_native_nd_twin_compose_router
    )
