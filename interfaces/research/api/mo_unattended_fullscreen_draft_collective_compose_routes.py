"""Registerable HTTP surface for MO unattended + fullscreen draft collective."""
...
mo_unattended_fullscreen_draft_collective_compose_router = APIRouter(
    prefix="/research/mo-unattended-fullscreen-draft-collective",
    tags=["mo-unattended-fullscreen-draft-collective-compose"],
)
...
@mo_unattended_fullscreen_draft_collective_compose_router.post("/compose")
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_mo_unattended_fullscreen_draft_collective(
...
def register_mo_unattended_fullscreen_draft_collective_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
        mo_unattended_fullscreen_draft_collective_compose_router
    )
