...
competition_dr_nd_shadow_weekly_src_write_mo_weekly_pack_compose_router = APIRouter(
    prefix="/research/competition-dr-nd-shadow-weekly-src-write-mo-weekly-pack",
    tags=["competition-dr-nd-shadow-weekly-src-write-mo-weekly-pack-compose"],
)
...
@competition_dr_nd_shadow_weekly_src_write_mo_weekly_pack_compose_router.post("/compose")
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_competition_dr_nd_shadow_weekly_src_write_mo_weekly_pack(
...
def register_competition_dr_nd_shadow_weekly_src_write_mo_weekly_pack_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
        competition_dr_nd_shadow_weekly_src_write_mo_weekly_pack_compose_router
    )
...
__all__ = [
    ...
    "NdPackBody",
    "competition_dr_nd_shadow_weekly_src_write_mo_weekly_pack_compose_router",
    "register_competition_dr_nd_shadow_weekly_src_write_mo_weekly_pack_compose_routes",
]
