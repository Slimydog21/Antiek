"""Registerable HTTP surface for highlight source attach quality interrogation."""
...
highlight_source_attach_quality_interrogation_compose_router = APIRouter(
    prefix="/research/highlight-source-attach-quality-interrogation",
    tags=["highlight-source-attach-quality-interrogation-compose"],
)
...
@highlight_source_attach_quality_interrogation_compose_router.post("/compose")
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_highlight_source_attach_quality_interrogation(
...
def register_highlight_source_attach_quality_interrogation_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
        highlight_source_attach_quality_interrogation_compose_router
    )
