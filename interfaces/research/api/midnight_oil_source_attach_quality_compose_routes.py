"""Registerable HTTP surface for MO + source attach quality compose."""
...
midnight_oil_source_attach_quality_compose_router = APIRouter(
    prefix="/research/midnight-oil-source-attach-quality",
    tags=["midnight-oil-source-attach-quality-compose"],
)
...
@midnight_oil_source_attach_quality_compose_router.post("/compose")
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_midnight_oil_source_attach_quality(
...
def register_midnight_oil_source_attach_quality_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(midnight_oil_source_attach_quality_compose_router)


__all__ = [
    "midnight_oil_source_attach_quality_compose_router",
