...
from interfaces.research.api.antiek_bench_weekly_src_write_pack_compose_routes import (
    SourcePackBody,
    WeeklyLearnBody,
)
...
recursive_twin_presentation_weekly_pack_compose_router = (
    APIRouter(
        prefix=(
            "/research/recursive-twin-presentation-weekly-pack"
        ),
        tags=[
            "recursive-twin-presentation-weekly-pack-compose"
        ],
    )
)
...
@recursive_twin_presentation_weekly_pack_compose_router.post(
    "/compose"
)
def post_compose(req: ComposeRequest) -> dict[str, Any]:
    try:
        result = compose_recursive_twin_presentation_weekly_pack(
...
def register_recursive_twin_presentation_weekly_pack_compose_routes(
    app: FastAPI,
) -> None:
    app.include_router(
        recursive_twin_presentation_weekly_pack_compose_router
...
__all__ = [
    "recursive_twin_presentation_weekly_pack_compose_router",
    "register_recursive_twin_presentation_weekly_pack_compose_routes",
]
