...
# Servable items (an actual redistribution grant) land here: the
# "we hold an opt-in-equivalent license" class. CC0 is a public-domain
# dedication but historically routes through this servable lane too (see the
# CC0 row); the CC Public-Domain Mark routes through ``public_domain``.
...
CC_LICENSE_ROWS: tuple[LicenseRow, ...] = (
    ...
    LicenseRow(
        ...
        content_class=SERVABLE_CONTENT_CLASS,
