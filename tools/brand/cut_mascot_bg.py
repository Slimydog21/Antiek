#!/usr/bin/env python3
"""Cut the baked white background out of a Brain pose PNG (SPR-12 M4).

The operator's Krea-generated `_corrected` mascot rasters ship with a
...
the opaque near-white count) and then fixes it.
  ...
  the art is a WHITE-BELLIED mascot on a WHITE background. A global
  ...
  The fix is topological, not photometric: the mascot has a CLOSED black
...
after the operator supplies a new pose.
    ...
    python3 tools/brand/cut_mascot_bg.py \
        apps/reading/src/brand/mascot/poses/anchor/mascot_default_v5_nano_corrected.png \
        apps/reading/src/brand/mascot/poses/anchor/mascot_default_v5_transparent.png
"""
