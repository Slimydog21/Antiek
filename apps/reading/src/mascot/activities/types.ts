...
/**
 * StationActivity — the contract for a thing Brain does at his fixed station.
 *
 ...
 * it no authority to move the mascot. This type deliberately
 * has NO whereabouts field, NO ref, NO setter that could steer Brain: an
 ...
 * caller cannot pass a Brain ref, position, or movement command through the
 ...
 *  Note what is ABSENT: any read of the mascot's own whereabouts. An
 *  instrument reads the CURSOR, never Brain. */
 ...
 *  (useMouseFollow) itself — it is handed no mascot state. */
...
/**
 * A thing Brain does at his station: appearance (ambient CSS classes) + a
...
export interface StationActivity {
  ...
  readonly ambient: {
     ...
     *  Brain in his neutral station pose. Ice fishing uses the own-hole
