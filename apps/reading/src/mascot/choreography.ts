...
/**
 * Brain choreography (SPR-10) — the "waddle to the activated control" layer.
 *
 * The operator's voice note: when a button is activated, Brain waddles over
 ...
 * off-screen element → graceful no-op inside MascotStage.waddleToEl (no throw,
 ...
 * heads to the last target — Brain is never left stuck mid-walk.
 *
 ...
 * of a screen-crossing walk (handled in MascotStage.waddleToEl). This listener
 ...
 * — or whose ancestor carries it — makes Brain waddle to it + emote when
 ...
 * `data-mascot-target` (or a descendant of one) makes Brain waddle to that
 ...
 * untouched; Brain's reaction rides alongside it. waddleToEl is the single
