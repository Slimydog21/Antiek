 ...
 * Brain no longer CHASES the cursor — the reel that consumed this hook's lagged
 ...
 * high factor (0..1) closes most of the gap per leg, keeping the mascot
 * close on the cursor's heels. At 0.75 and a 0.5s lag, Brain reads as a
 * lively, attentive companion — responsive but still with visible character.
 */
export const FOLLOW_EASE = 0.75;

/**
 * After this long with no pointer movement Brain is considered "idle on the
