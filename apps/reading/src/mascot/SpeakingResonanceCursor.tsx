 ...
 * transcript/content read, navigation, networking, spend, or Brain control.
 */
export function SpeakingResonanceCursor({
  ...
  useEffect(() => {
    ...
    if (!disabled) root.classList.add("mascot-speaking-resonance-active");
    else root.classList.remove("mascot-speaking-resonance-active");
    return () => root.classList.remove("mascot-speaking-resonance-active");
  }, [disabled]);
