 ...
 *
 * The TS telemetry contract is generated by tools/codegen/emit_contracts.py
 * into src/generated/contracts.ts and re-exported through frameContract.ts for
 * stable local imports. The Python source of truth remains
 ...
 * contract changes a field name, adds a field, or bumps the version, codegen
 * plus this test must update in lock-step. The field lists below were verified
 * against:
 *
