...
/** S8-full extension — workspace-system actions. Actions have no path; instead
  ...
  const workspaceActions = useMemo<PaletteAction[]>(() => {
    const actions: PaletteAction[] = [
      ...
      },
      {
        kind: "action",
        id: "ws:reset-layout",
        title: "Reset current panel layout",
        subtitle: "Workspace · in-memory only",
        run: () => {
          useWorkspace.getState().reset();
          toast.ok("Current panel layout reset.");
        },
      },
    ];
