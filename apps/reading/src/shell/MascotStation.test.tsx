/**
 * MascotStation.test.tsx — SPR-12 M3 acceptance.
 *
...
/**
 * THE FIXED STATION (2026-07-02) — Brain does NOT chase the cursor and does
 ...
 *  mounted rAF, so they live in MascotStation.station.test.tsx.)
 */
describe("MascotStation — the fixed station", () => {
  ...
  it("never runs an ambient fishing gag (no mascot-fishing class, ever)", () => {
  ...
  it("is fully still under prefers-reduced-motion and stays clickable", () => {
    ...
    expect(container.querySelector(".mascot-waddle")).toBeNull();
    expect(container.querySelector(".mascot-step")).toBeNull();
