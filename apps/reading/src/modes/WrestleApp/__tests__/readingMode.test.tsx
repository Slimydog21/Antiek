...
describe("WrestleApp reading-mode defaults", () => {
...
describe("WrestleApp reading-mode emit", () => {
...
describe("WrestleApp reading-mode layout", () => {
...
describe("WrestleApp AI command palette (Cmd+K)", () => {
...
describe("WrestleApp Cmd+R toggle", () => {
  it("flips the mode", () => {
    renderApp();
    const shell = screen.getByTestId("wrestle-shell");
    expect(shell.getAttribute("data-reading-mode")).toBe("reader");
