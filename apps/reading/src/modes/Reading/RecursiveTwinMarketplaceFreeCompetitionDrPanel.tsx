/**
 * RecursiveTwinMarketplaceFreeCompetitionDrPanel — free-file.
 * Recursive twin note-taker over marketplace free + competition DR pack.
 */
import { useState } from "react";
import { LemonButton, LemonCard } from "../../components/lemon";
import {
  composeRecursiveTwinMarketplaceFreeCompetitionDr,
  formatRecursiveTwinMarketplaceFreeCompetitionDrSummary,
  type RecursiveTwinMarketplaceFreeCompetitionDrCompose,
} from "../../api/recursiveTwinMarketplaceFreeCompetitionDrCompose";

export default function RecursiveTwinMarketplaceFreeCompetitionDrPanel() {
  const [ack, setAck] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [result, setResult] =
    useState<RecursiveTwinMarketplaceFreeCompetitionDrCompose | null>(null);
  ...
  return (
    <LemonCard
      ...
      data-testid="recursive-twin-marketplace-free-competition-dr-panel"
    >
      <h2 className="text-lg font-semibold">
        Recursive twin · marketplace free · competition DR
      </h2>
      <p className="text-sm text-muted">
        Pure advisory — twin_written / purchase_executed / live_dispatch always
        false.
      </p>
      ...
      {result && (
        <div className="space-y-1 text-sm">
          <div data-testid="summary">
            {formatRecursiveTwinMarketplaceFreeCompetitionDrSummary(result)}
          </div>
          <div>
            parent_aligned=
            <strong>{String(result.parent_aligned)}</strong> · pack_ready=
