/**
 * CompetitionDrNdShadowWeeklyMarketplacePanel — free-file.
 */
import { useState } from "react";
import { LemonButton, LemonCard } from "../../components/lemon";
import {
  composeCompetitionDrNdShadowWeeklyMarketplace,
  formatCompetitionDrNdShadowWeeklyMarketplaceSummary,
  type CompetitionDrNdShadowWeeklyMarketplaceCompose,
} from "../../api/competitionDrNdShadowWeeklyMarketplaceCompose";

export default function CompetitionDrNdShadowWeeklyMarketplacePanel() {
  const [ack, setAck] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [result, setResult] =
    useState<CompetitionDrNdShadowWeeklyMarketplaceCompose | null>(null);
  ...
  return (
    <div data-testid="competition-dr-nd-shadow-weekly-marketplace-panel">
      <LemonCard title="Research · competition DR + ND weekly marketplace">
        <p className="text-sm opacity-80">
          Competition quality + arxiv/substack citations over ND shadow REJECT +
          Antiek-bench weekly free marketplace pack. Pure — never live-dispatches.
        </p>
        ...
        {result && (
          <pre className="text-xs mt-2 p-2 bg-bg-light rounded overflow-auto max-h-64">
            {formatCompetitionDrNdShadowWeeklyMarketplaceSummary(result)}
          </pre>
        )}
      </LemonCard>
    </div>
