/**
 * FullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackPanel — free-file.
...
export default function FullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackPanel() {
  const [ack, setAck] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [result, setResult] =
    useState<FullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackCompose | null>(
      null,
    );
  ...
  function onCompose() {
    ...
    try {
      ...
      void ack;
      void composeFullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPack;
      void formatFullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackSummary;
    } catch (e) {
