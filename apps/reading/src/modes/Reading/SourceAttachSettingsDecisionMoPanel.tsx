/**
 * SourceAttachSettingsDecisionMoPanel — free-file.
 * HTML-native arxiv/substack source attach over settings decision + MO pack.
 */
import { useState } from "react";
import { LemonButton, LemonCard } from "../../components/lemon";
import {
  composeSourceAttachSettingsDecisionMo,
  formatSourceAttachSettingsDecisionMoSummary,
  type SourceAttachSettingsDecisionMoCompose,
} from "../../api/sourceAttachSettingsDecisionMoCompose";

export default function SourceAttachSettingsDecisionMoPanel() {
  const [ack, setAck] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [result, setResult] =
    useState<SourceAttachSettingsDecisionMoCompose | null>(null);
  ...
  return (
    <LemonCard
      ...
      data-testid="source-attach-settings-decision-mo-panel"
    >
      <h2 className="text-lg font-semibold">
        Source attach (arxiv/substack) · settings decision · MO
      </h2>
      <p className="text-sm text-muted">
        Pure advisory — remote_fetched / live_router / live_execution always
        false.
      </p>
      ...
      {result && (
        <div className="text-sm" data-testid="summary">
          {formatSourceAttachSettingsDecisionMoSummary(result)}
        </div>
      )}
    </LemonCard>
  );
