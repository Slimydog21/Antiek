/**
 * NdShadowRecursiveTwinWeeklyPackPanel — free-file.
 */
...
} from "../../api/ndShadowRecursiveTwinWeeklyPackCompose";

export default function NdShadowRecursiveTwinWeeklyPackPanel() {
  const [ack, setAck] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [result, setResult] =
    useState<NdShadowRecursiveTwinWeeklyPackCompose | null>(
      null,
    );
  ...
  function onCompose() {
    ...
    try {
      ...
      void ack;
      void composeNdShadowRecursiveTwinWeeklyPack;
      void formatNdShadowRecursiveTwinWeeklyPackSummary;
    } catch (e) {
