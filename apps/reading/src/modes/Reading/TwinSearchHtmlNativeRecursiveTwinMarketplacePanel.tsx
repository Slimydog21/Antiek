/**
 * TwinSearchHtmlNativeRecursiveTwinMarketplacePanel — free-file.
 * Twin intelligent search over HTML-native recursive twin marketplace free pack.
 */
...
} from "../../api/twinSearchHtmlNativeRecursiveTwinMarketplaceCompose";

export default function TwinSearchHtmlNativeRecursiveTwinMarketplacePanel() {
  const [ack, setAck] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [result, setResult] =
    useState<TwinSearchHtmlNativeRecursiveTwinMarketplaceCompose | null>(null);
  ...
  return (
    <LemonCard
      ...
      data-testid="twin-search-html-native-recursive-twin-marketplace-panel"
    >
      <h2 className="text-lg font-semibold">
        Twin search · HTML-native · recursive twin · marketplace
      </h2>
      <p className="text-sm text-muted">
        Pure advisory — remote_index / pdf_view / twin_written always false.
      </p>
      ...
      {result && (
        <div className="space-y-1 text-sm">
          <div data-testid="summary">
            {formatTwinSearchHtmlNativeRecursiveTwinMarketplaceSummary(result)}
          </div>
          <div>
            hits=<strong>{result.hit_count}</strong> · pack_ready=
