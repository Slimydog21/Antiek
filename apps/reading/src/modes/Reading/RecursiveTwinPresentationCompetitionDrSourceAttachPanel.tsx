/**
 * RecursiveTwinPresentationCompetitionDrSourceAttachPanel — free-file.
...
} from "../../api/recursiveTwinPresentationCompetitionDrSourceAttachCompose";
...
export default function RecursiveTwinPresentationCompetitionDrSourceAttachPanel() {
  ...
  const [result, setResult] =
    useState<RecursiveTwinPresentationCompetitionDrSourceAttachCompose | null>(
      null,
    );
  ...
  return (
    <LemonCard
      ...
      data-testid="twin-presentation-competition-dr-source-attach-panel"
    >
      <h2 className="text-lg font-semibold">
        Recursive twin presentation · competition DR source-attach
      </h2>
        ...
        <div className="space-y-2 text-sm">
          ...
          <details>
            <summary>
              ...
              {result.presentation.presentation_sections.length})
            </summary>
