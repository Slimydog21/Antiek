/**
 * ModelDecisionTwinSearchHtmlNativeMarketplacePanel — free-file.
 * Model decision budget over twin search + HTML-native recursive twin marketplace.
 */
import { useState } from "react";
import { LemonButton, LemonCard } from "../../components/lemon";
import {
  composeModelDecisionTwinSearchHtmlNativeMarketplace,
  formatModelDecisionTwinSearchHtmlNativeMarketplaceSummary,
  type ModelDecisionTwinSearchHtmlNativeMarketplaceCompose,
} from "../../api/modelDecisionTwinSearchHtmlNativeMarketplaceCompose";

export default function ModelDecisionTwinSearchHtmlNativeMarketplacePanel() {
  const [ack, setAck] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [result, setResult] =
    useState<ModelDecisionTwinSearchHtmlNativeMarketplaceCompose | null>(null);
  ...
  return (
    <LemonCard
      ...
      data-testid="model-decision-twin-search-html-native-marketplace-panel"
    >
      <h2 className="text-lg font-semibold">
        Model decision · twin search · HTML-native · marketplace
      </h2>
      <p className="text-sm text-muted">
        Pure advisory — live_router / secrets_stored / would_exceed gate held.
      </p>
      ...
      {result && (
        <div className="space-y-1 text-sm">
          <div data-testid="summary">
            {formatModelDecisionTwinSearchHtmlNativeMarketplaceSummary(result)}
          </div>
          <div>
            would_exceed=
