/**
 * FullscreenOpenDraftBeforeMergeCollectiveMultiselectPanel — free-file.
...
export default function FullscreenOpenDraftBeforeMergeCollectiveMultiselectPanel() {
  const [ack, setAck] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [result, setResult] =
    useState<FullscreenOpenDraftBeforeMergeCollectiveMultiselectCompose | null>(
      null,
    );
  ...
  function onCompose() {
    ...
    try {
      ...
      void ack;
      void composeFullscreenOpenDraftBeforeMergeCollectiveMultiselect;
      void formatFullscreenOpenDraftBeforeMergeCollectiveMultiselectSummary;
    } catch (e) {
