/**
 * DraftBeforeMergeCollectivePresentedTwinsPanel — free-file.
...
import {
  ...
  formatDraftBeforeMergeCollectivePresentedTwinsSummary,
  type DraftBeforeMergeCollectivePresentedTwinsCompose,
} from "../../api/draftBeforeMergeCollectivePresentedTwinsCompose";

export default function DraftBeforeMergeCollectivePresentedTwinsPanel() {
  const [ack, setAck] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [result, setResult] =
    useState<DraftBeforeMergeCollectivePresentedTwinsCompose | null>(null);
      ...
      setResult(
        composeDraftBeforeMergeCollectivePresentedTwins({
          draft_gate: {
            ...
            parent_excerpt: "<p>Parent on scaling</p>",
            sources: [
              {
                instance_id: "float-1",
                parent_asset_id: "book-demo",
          ...
          collective_pack: {
            collective: {
              ...
              cohesive_prompt: "Synthesize twins",
            },
            paid_nd: {
              purchase: {
  ...
  return (
    <LemonCard
      ...
      data-testid="draft-before-merge-collective-presented-twins-panel"
    >
      <h2 className="text-lg font-semibold">
        Draft-before-merge · collective presented twins
      </h2>
      <p className="text-sm text-muted">
        Pure advisory — draft_written / merge_executed / purchase_executed
        always false.
      </p>
      ...
      {result && (
        <div className="text-sm" data-testid="summary">
          {formatDraftBeforeMergeCollectivePresentedTwinsSummary(result)}
        </div>
      )}
    </LemonCard>
  );
