/**
 * CompetitionDrSettingsAddModelBenchSourceMoPanel — free-file.
 * Competition DR quality over settings add-model + Antiek-bench source-attach MO.
 */
import { useState } from "react";
import { LemonButton, LemonCard } from "../../components/lemon";
import {
  composeCompetitionDrSettingsAddModelBenchSourceMo,
  formatCompetitionDrSettingsAddModelBenchSourceMoSummary,
  type CompetitionDrSettingsAddModelBenchSourceMoCompose,
} from "../../api/competitionDrSettingsAddModelBenchSourceMoCompose";

export default function CompetitionDrSettingsAddModelBenchSourceMoPanel() {
  const [ack, setAck] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [result, setResult] =
    useState<CompetitionDrSettingsAddModelBenchSourceMoCompose | null>(null);
  ...
  return (
    <LemonCard
      ...
      data-testid="competition-dr-settings-add-model-bench-source-mo-panel"
    >
      <h2 className="text-lg font-semibold">
        Competition DR · settings add-model · Antiek-bench · source · MO
      </h2>
      <p className="text-sm text-muted">
        Pure advisory — live_dispatch / remote_fetched / backlog_mutated /
        inventory_mutated always false.
      </p>
      ...
      {result && (
        <div className="space-y-1 text-sm">
          <div data-testid="summary">
            {formatCompetitionDrSettingsAddModelBenchSourceMoSummary(result)}
          </div>
          <div>
            session_aligned=
