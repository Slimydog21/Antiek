/**
 * FullscreenDraftCollectivePresentedTwinsPanel — free-file.
...
import {
  ...
  formatFullscreenDraftCollectivePresentedTwinsSummary,
  type FullscreenDraftCollectivePresentedTwinsCompose,
} from "../../api/fullscreenDraftCollectivePresentedTwinsCompose";

export default function FullscreenDraftCollectivePresentedTwinsPanel() {
  const [ack, setAck] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [result, setResult] =
    useState<FullscreenDraftCollectivePresentedTwinsCompose | null>(null);
  ...
  return (
    <LemonCard
      ...
      data-testid="fullscreen-draft-collective-presented-twins-panel"
    >
      <h2 className="text-lg font-semibold">
        Fullscreen · draft collective presented twins
      </h2>
      <p className="text-sm text-muted">
        Pure advisory — live_dispatched / merge_executed / draft_written always
        false.
      </p>
      ...
      {result && (
        <div className="text-sm" data-testid="summary">
          {formatFullscreenDraftCollectivePresentedTwinsSummary(result)}
        </div>
      )}
    </LemonCard>
  );
