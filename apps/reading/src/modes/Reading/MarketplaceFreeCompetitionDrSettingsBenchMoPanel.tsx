/**
 * MarketplaceFreeCompetitionDrSettingsBenchMoPanel — free-file.
 * Marketplace free-before-buy over competition DR + settings add-model pack.
 */
import { useState } from "react";
import { LemonButton, LemonCard } from "../../components/lemon";
import {
  composeMarketplaceFreeCompetitionDrSettingsBenchMo,
  formatMarketplaceFreeCompetitionDrSettingsBenchMoSummary,
  type MarketplaceFreeCompetitionDrSettingsBenchMoCompose,
} from "../../api/marketplaceFreeCompetitionDrSettingsBenchMoCompose";

export default function MarketplaceFreeCompetitionDrSettingsBenchMoPanel() {
  const [ack, setAck] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [result, setResult] =
    useState<MarketplaceFreeCompetitionDrSettingsBenchMoCompose | null>(null);
  ...
  return (
    <LemonCard
      ...
      data-testid="marketplace-free-competition-dr-settings-bench-mo-panel"
    >
      <h2 className="text-lg font-semibold">
        Marketplace free · competition DR · settings · bench · MO
      </h2>
      <p className="text-sm text-muted">
        Pure advisory — purchase_executed / hosted / live_dispatch always
        false.
      </p>
      ...
      {result && (
        <div className="space-y-1 text-sm">
          <div data-testid="summary">
            {formatMarketplaceFreeCompetitionDrSettingsBenchMoSummary(result)}
          </div>
          <div>
            path=<strong>{result.market.path}</strong> · pack_ready=
