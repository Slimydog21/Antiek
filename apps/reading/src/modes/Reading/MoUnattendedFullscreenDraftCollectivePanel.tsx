/**
 * MoUnattendedFullscreenDraftCollectivePanel — free-file.
 * Midnight Oil unattended package over fullscreen draft collective pack.
 */
import { useState } from "react";
import { LemonButton, LemonCard } from "../../components/lemon";
import {
  composeMoUnattendedFullscreenDraftCollective,
  formatMoUnattendedFullscreenDraftCollectiveSummary,
  type MoUnattendedFullscreenDraftCollectiveCompose,
} from "../../api/moUnattendedFullscreenDraftCollectiveCompose";

export default function MoUnattendedFullscreenDraftCollectivePanel() {
  const [ack, setAck] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [result, setResult] =
    useState<MoUnattendedFullscreenDraftCollectiveCompose | null>(null);
  ...
  return (
    <LemonCard
      ...
      data-testid="mo-unattended-fullscreen-draft-collective-panel"
    >
      <h2 className="text-lg font-semibold">
        Midnight Oil unattended · fullscreen draft collective
      </h2>
      <p className="text-sm text-muted">
        Pure advisory — live_execution_authorized always false.
      </p>
      ...
      {result && (
        <div className="text-sm" data-testid="summary">
          {formatMoUnattendedFullscreenDraftCollectiveSummary(result)}
        </div>
      )}
    </LemonCard>
  );
