/**
 * PaidPurchaseNdShadowTwinPresentationPanel — free-file.
 * Free-first paid purchase honesty over ND shadow twin presentation pack.
 */
import { useState } from "react";
import { LemonButton, LemonCard } from "../../components/lemon";
import {
  composePaidPurchaseNdShadowTwinPresentation,
  formatPaidPurchaseNdShadowTwinPresentationSummary,
  type PaidPurchaseNdShadowTwinPresentationCompose,
} from "../../api/paidPurchaseNdShadowTwinPresentationCompose";

export default function PaidPurchaseNdShadowTwinPresentationPanel() {
  const [ack, setAck] = useState(true);
  const [error, setError] = useState<string | null>(null);
  const [result, setResult] =
    useState<PaidPurchaseNdShadowTwinPresentationCompose | null>(null);
  ...
  return (
    <LemonCard className="p-4 space-y-3" data-testid="paid-purchase-nd-twin-panel">
      <h2 className="text-lg font-semibold">
        Paid-purchase free-first · ND twin presentation
      </h2>
      <p className="text-sm text-muted">
        Pure advisory — purchase_executed / charge_executed / live_router always
        false.
      </p>
      ...
      {result && (
        <div className="text-sm" data-testid="summary">
          {formatPaidPurchaseNdShadowTwinPresentationSummary(result)}
        </div>
      )}
    </LemonCard>
  );
