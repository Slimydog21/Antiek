 ...
 * each surface), and biographies featured as a real template that opens the
 * dedicated SPR-11 guided landing. The global preview wraps every story in a
 * router, so navigation in the cards is harmless here.
 *
