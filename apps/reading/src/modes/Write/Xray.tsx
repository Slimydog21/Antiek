                ...
                <div data-testid={`xray-paragraph-blocks-${idx}`} className="mt-1.5 space-y-1">
                      ...
                      return (
                        <div key={bid} className="flex items-start gap-2">
                          <button
                            ...
                            className="flex-1 cursor-grab rounded border-l-2 border-sun-deep/50 bg-sun-deep/5 px-2 py-1 text-left text-[12px] text-ink dark:text-bright active:cursor-grabbing"
                  ...
                  {onRegenerateParagraph && ids.length > 0 && (
                    <button
                      ...
                      className="text-[11px] text-sun-deep underline"
                    >
