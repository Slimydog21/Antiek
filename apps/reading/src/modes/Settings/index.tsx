          ...
          >
            ...
            {dogfood && (
              <div
                ...
                data-has-pub-ref-foresight-chrome-posture={String(
                  (dogfood.items || []).some(
                    (it) =>
                      it.item_id === "dogfood-wrestle-pub-ref-foresight-chrome",
                  ),
                )}
                data-has-citation-chain-posture={String(
                  (dogfood.items || []).some(
                ...
                data-has-domain-aware-stem-expanded-posture={String(
                  (dogfood.items || []).some(
                    (it) =>
                      it.item_id ===
                ...
                data-has-evidence-write-multi-hop-posture={String(
                  (dogfood.items || []).some(
                    (it) =>
                      it.item_id === "dogfood-wrestle-evidence-write-multi-hop",
                  ),
                )}
                data-has-competitive-dr-scorecard-posture={String(
                  (dogfood.items || []).some(
                    (it) =>
                      it.item_id === "dogfood-wrestle-competitive-dr-scorecard",
                  ),
                )}
                data-propose-not-promote="true"
              >
                ...
                {(dogfood.items || []).some((it) =>
                  ...
                  <p
                    ...
                    role="status"
                  >
                    Spine postures (v31): write-seed · float evidence · budget
                    ...
                    purchase seamless port · domain-aware twin search · collective unit twin seed · MO deposit twin honesty · pub-ref foresight chrome · citation chain · multi-hop citation chain hops · domain-aware STEM expanded · evidence Write multi-hop · competitive DR scorecard
