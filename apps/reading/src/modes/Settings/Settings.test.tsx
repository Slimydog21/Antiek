...
const {
  ...
  return {
    ...
    fetchAntiekBenchDogfoodFixtures: vi.fn(async () => ({
      // Residual (st/su/…/adn/aeu/afo/ags/agw): competitive dogfood v22 postures.
      suite_version: "suite-competitive-dogfood-v22",
      ...
      // Residual (yb/adn/aeu/afo/ags/agw): full v22 item list (matches substrate; item_count-matches-listed).
      items: [
      ...
      html: "<p>Suite suite-competitive-dogfood-v22 · items=35 · dogfood-wrestle-spawn-merge-path · dogfood-wrestle-collective-multi-spawn-merge</p>",
    })),
...
describe("Settings SPR-01 + decision-tree install", () => {
  ...
  it("loads competitive dogfood fixtures — never auto-promoted", async () => {
    ...
    // Residual (su/…/adn/aeu/afo/ags/agw): v22 spine posture machine attrs.
    ...
    expect(summary.getAttribute("data-item-count")).toBe("35");
    ...
    expect(summary.getAttribute("data-wrestle-count")).toBe("22");
    ...
    // Residual (yb/adn/aeu/afo/ags/agw): full v22 mock lists all 35 items — matches item_count.
    expect(itemsList.getAttribute("data-listed-count")).toBe("35");
    expect(itemsList.getAttribute("data-item-count")).toBe("35");
