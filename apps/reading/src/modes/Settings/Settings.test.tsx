...
const {
  ...
  return {
    ...
    fetchAntiekBenchDogfoodFixtures: vi.fn(async () => ({
      ...
      suite_version: "suite-competitive-dogfood-v31",
      ...
      html: "<p>Suite suite-competitive-dogfood-v31 · items=47 · dogfood-wrestle-evidence-write-multi-hop · dogfood-wrestle-competitive-dr-scorecard</p>",
    })),
...
describe("Settings SPR-01 + decision-tree install", () => {
  ...
  it("loads competitive dogfood fixtures — never auto-promoted", async () => {
    ...
    expect(summary.getAttribute("data-item-count")).toBe("47");
    ...
    expect(summary.getAttribute("data-wrestle-count")).toBe("34");
    ...
    // Residual (yb/…/ais): full v31 mock lists all 47 items — matches item_count.
    expect(itemsList.getAttribute("data-listed-count")).toBe("47");
    expect(itemsList.getAttribute("data-item-count")).toBe("47");
