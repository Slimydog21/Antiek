...
const {
  ...
  return {
    ...
    fetchAntiekBenchDogfoodFixtures: vi.fn(async () => ({
      ...
      suite_version: "suite-competitive-dogfood-v32",
      ...
      html: "<p>Suite suite-competitive-dogfood-v32 · items=48 · dogfood-wrestle-twin-promote-depth-graph · dogfood-wrestle-competitive-dr-scorecard</p>",
    })),
...
describe("Settings SPR-01 + decision-tree install", () => {
  ...
  it("loads competitive dogfood fixtures — never auto-promoted", async () => {
    ...
    expect(summary.getAttribute("data-item-count")).toBe("48");
    ...
    expect(summary.getAttribute("data-wrestle-count")).toBe("35");
    ...
    // Residual (yb/…/ais): full v32 mock lists all 48 items — matches item_count.
    expect(itemsList.getAttribute("data-listed-count")).toBe("48");
    expect(itemsList.getAttribute("data-item-count")).toBe("48");
