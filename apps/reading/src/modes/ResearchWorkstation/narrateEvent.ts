...
const NARRATION: Record<ActionTypeValue, NarrationRule> = {
  ...
  [ActionType.MCP_ATTRIBUTION_RECORDED]: null,
  ...
  [ActionType.RLM_SESSION_STARTED]: null,
  [ActionType.RLM_ITERATION]: null,
  [ActionType.RLM_SUB_CALL_DISPATCHED]: null,
  [ActionType.RLM_SESSION_COMPLETED]: null,
  [ActionType.RLM_SESSION_FAILED]: null,
  ...
  [ActionType.USER_IDENTITY_ATTACHED]: null,
  [ActionType.GRAPH_SCOPE_CHANGED]: null,
