...
body{margin:0;padding:32px;background:#fafaf9;color:#1c1917;font:17px/1.65 Charter,Georgia,serif}
main{max-width:680px;margin:auto}h1{font-size:32px;line-height:1.15}.kicker{font:700 11px/1.2 ui-monospace;letter-spacing:.12em;text-transform:uppercase;color:#0f766e}
.finding{margin:24px 0;padding:18px 20px;border:1px solid #d6d3d1;border-left:4px solid #0f766e;background:white}.source{font:12px/1.4 ui-monospace;color:#78716c}
