...
Inputs:
  ../poses/anchor/mascot_default_v5_nano_corrected.png
...
SRC = HERE.parent / "poses" / "anchor" / "mascot_default_v5_nano_corrected.png"
...
def crop_to_square(img: Image.Image, pad_ratio: float = 0.06) -> Image.Image:
    """Crop to the mascot's bounding box (non-white pixels), then pad to square."""
...
def main() -> None:
    ...
    mascot_card = square.resize((460, 460), Image.LANCZOS)
    card.paste(mascot_card, (120, 85), mascot_card)
