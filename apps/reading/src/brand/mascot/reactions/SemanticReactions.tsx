...
function EvidenceCard() {
  return (
    <svg
      className="mascot-semantic__evidence"
      viewBox="0 0 24 30"
      aria-hidden="true"
    >
      <rect x="2" y="3" width="20" height="25" rx="1" />
      <path d="M7 9h10M7 14h8M7 19h10" />
      <path className="mascot-semantic__spark" d="M18 1v4M16 3h4" />
    </svg>
  );
}
...
function VerificationStamp() {
  return (
    <svg
      className="mascot-semantic__stamp"
      viewBox="0 0 30 30"
      aria-hidden="true"
    >
...
function PaperclipOrbit() {
  return (
    <svg
      className="mascot-semantic__orbit"
      viewBox="0 0 64 28"
      aria-hidden="true"
    >
      <g className="mascot-semantic__paperclips">
...
function BrassTab() {
  return (
    <svg
      className="mascot-semantic__tab"
      viewBox="0 0 22 38"
      aria-hidden="true"
    >
...
function SemanticReaction({
  ...
  const style = {
    width: size,
    height: size,
    "--mascot-semantic-duration": `${DURATION_MS[kind]}ms`,
  } as CSSProperties;
  ...
  return (
    <span
      ...
      className={`mascot-semantic mascot-semantic--${kind}`}
      ...
      style={style}
    >
      <span className="mascot-semantic__mark" aria-hidden="true">
...
export function MascotCurious(props: Props) {
  return <SemanticReaction kind="curious" {...props} />;
}

export function MascotHappy(props: Props) {
  return <SemanticReaction kind="happy" {...props} />;
}

export function MascotDizzy(props: Props) {
  return <SemanticReaction kind="dizzy" {...props} />;
}

export function MascotHit(props: Props) {
  return <SemanticReaction kind="hit" {...props} />;
}

export { DURATION_MS as MASCOT_SEMANTIC_DURATION_MS };
