"""
Lock generated Brain illustrations to the exact Antiek brand yellow #F5DF24.
...
def main() -> None:
    ...
    targets: list[Path] = sorted(p for p in poses_dir.glob("mascot_*_v1.png"))
    if args.include_anchor:
        anchor_dir = poses_dir / "anchor"
        targets += sorted(p for p in anchor_dir.glob("mascot_*_v5_nano.png"))
