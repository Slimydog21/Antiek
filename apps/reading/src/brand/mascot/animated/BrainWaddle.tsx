...
export default function BrainWaddle({
  size = 32,
  label = "Navigating",
}: Props) {
  return (
    ...
    >
      {/* Core mark now single-source from canonical BrainMascot at rail fidelity.
          ...
          container class; the mascot geometry itself is no longer forked. */}
      <BrainMascot mood="idle" size={size} className="mascot-waddle" />
    </span>
  );
}
