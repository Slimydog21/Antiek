 ...
 * src write pack (short residual: TwinSearchHtmlNativeMarketplaceMoWeeklySrcWritePack
 * — FS 255).
 *
...
import {
  ...
  type HtmlNativeMarketplaceMoWeeklySrcWritePackInput,
} from "./htmlNativeMarketplaceMoWeeklySrcWritePackCompose";

export interface TwinSearchHtmlNativeMarketplaceMoWeeklySrcWritePackInput {
  search_query: string;
  twin_records: TwinSearchRecord[];
  search_limit?: number;
  html_pack: Omit<
    HtmlNativeMarketplaceMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface TwinSearchHtmlNativeMarketplaceMoWeeklySrcWritePackCompose {
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "twin_search_html_native_marketplace_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeTwinSearchHtmlNativeMarketplaceMoWeeklySrcWritePack(
  input: TwinSearchHtmlNativeMarketplaceMoWeeklySrcWritePackInput,
  ...
  const html_pack = composeHtmlNativeMarketplaceMoWeeklySrcWritePack({
    ...input.html_pack,
...
export function formatTwinSearchHtmlNativeMarketplaceMoWeeklySrcWritePackSummary(
