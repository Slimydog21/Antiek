...
describe("composeSettingsDecisionMoUnattendedFullscreen", () => {
  const twin_pack = {
    twin: {
      parent_asset_id: "book-1",
      source_excerpt:
  ...
  it("settings decision + MO unattended fullscreen pack ready", () => {
    const c = composeSettingsDecisionMoUnattendedFullscreen({
    ...
    expect(
      formatSettingsDecisionMoUnattendedFullscreenSummary(c),
  ...
  it("would_exceed blocks pack under require_both", () => {
    const c = composeSettingsDecisionMoUnattendedFullscreen({
      decision: {
        ...decision_input,
        spent_usd: 49,
  ...
  it("mo spend_consent false blocks overall", () => {
    const c = composeSettingsDecisionMoUnattendedFullscreen({
      decision: decision_input,
      mo_pack: {
        ...mo_pack,
