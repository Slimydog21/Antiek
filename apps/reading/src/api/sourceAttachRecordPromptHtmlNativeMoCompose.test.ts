...
describe("composeSourceAttachRecordPromptHtmlNativeMo", () => {
  it("arxiv+substack + record html pack ready", () => {
    const c = composeSourceAttachRecordPromptHtmlNativeMo({
      sources: SOURCES,
      record_html: {
    ...
    expect(c.record_html.pack_ready).toBe(true);
    ...
    expect(formatSourceAttachRecordPromptHtmlNativeMoSummary(c)).toMatch(
  ...
  it("budget would_exceed blocks sources path", () => {
    const c = composeSourceAttachRecordPromptHtmlNativeMo({
