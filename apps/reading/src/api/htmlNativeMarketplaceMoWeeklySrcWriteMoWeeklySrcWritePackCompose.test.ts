...
import {
  ...
  formatHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackSummary,
} from "./htmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

describe("composeHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("HTML-native + marketplace free MO weekly pack ready", () => {
    const c = composeHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
    ).toMatch(/pdf_primary=false/);
  });
  ...
  it("missing html sha blocks html_view and pack", () => {
    const c = composeHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePack({
      html_view: {
        ...residual_hn2_outer_html_view,
