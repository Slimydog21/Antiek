 ...
 * (short residual: MarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack — FS 255; never purchase).
...
import {
  composeMidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack,
  type MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
  type MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
} from "./midnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

export interface MarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput {
  market: MarketplaceFreeBeforeBuyHtmlPortInput;
  mo_pack: Omit<
    MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface MarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  title: string;
  account_id: string;
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "marketplace_free_mo_settings_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeMarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack(
  input: MarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
  ...
  const mo_pack = composeMidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...input.mo_pack,
...
export function formatMarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(
