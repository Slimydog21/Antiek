...
import {
  composeFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpack,
  formatFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackSummary,
} from "./fullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackCompose";

describe("composeFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpack", () => {
const WEEKLY_ND = {
  weekly_learn: {
    week_id: "2026-W28",
...
const COMPETITION_CITATIONS = [
  ...
  const residual_ws8_outer_decision_pack = {
    decision: residual_md7_outer_decision,
    twin_search_pack: residual_md7_outer_twin_search_pack,
  };


  const residual_fd8_outer_highlight_launch = {
    parent_asset_id: "book-1",
    highlight: "scaling laws under noise",
    gated: false,
    preferred_view_mode: "floating" as const,
  ...
  const residual_fd8_outer_record_pack = {
    session_id: "sess-1",
    items: residual_ws8_outer_items,
    decision_pack: residual_ws8_outer_decision_pack,
  };


  const residual_cm9_outer_multiselect = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    members: [
      {
  ...
  const residual_cm9_outer_floating_pack = {
    highlight_launch: residual_fd8_outer_highlight_launch,
    record_pack: residual_fd8_outer_record_pack,
  };

const residual_db9_outer_draft_gate = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    parent_excerpt: "<p>Parent body on scaling laws</p>",
    sources: [
  ...
  const residual_db9_outer_collective_pack = {
    multiselect: residual_cm9_outer_multiselect,
    floating_pack: residual_cm9_outer_floating_pack,
  };
...
const residual_cd8_outer_competition = {
  ...
  it("fullscreen + draft-before-merge collective pack ready", () => {
    // residual_fs11: draft_gate@db10 + collective@db11→cm11→fd11→ws11→md11→ts11→hn11→mkt10
    // (MoWeekly×10 moniker needs residual_mkt10 tip; residual_fs10@mkt9 is one lag short)
    const c = composeFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpack({
    ...
    expect(c.authority).toBe("fullscreen_open_draft_before_merge_collective_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mpack_compose_advisory");
    expect(formatFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackSummary(c)).toMatch(/REJECT|pack_ready=true/);
  });
  ...
  it("gated fullscreen fail-closed throws", () => {
    expect(() =>
      composeFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpack({
        fullscreen: {
          ...residual_fs10_outer_fullscreen,
          gated: true,
        },
        draft_pack: residual_fs11_outer_draft_pack,
        operator_ack: true,
      }),
    ).toThrow(/gated|withheld/i);
  });
  ...
  const residual_graft_fs10_outer_fullscreen = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    highlight: "scaling laws under noise",
    gated: false,
  ...
  const residual_graft_db10_tip_draft_gate = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    parent_excerpt: "<p>Parent body on scaling laws</p>",
    sources: [
  ...
  const residual_graft_cm10_tip_multiselect = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    members: [
      {
  ...
  const residual_graft_fd10_tip_highlight_launch = {
    parent_asset_id: "book-1",
    highlight: "scaling laws under noise",
    gated: false,
    preferred_view_mode: "floating" as const,
  ...
  const residual_graft_ws10_tip_items = [
    {
      record_id: "r1",
      kind: "insight" as const,
      text: "scaling holds under noise in compute-optimal regimes",
  ...
  const residual_graft_md10_tip_decision_x = {
    models: [
      {
        model_id: "gpt-5.5",
        tier: "frontier",
  ...
  const residual_graft_md10_tip_twin_search_pack_x = {
    search_query: "scaling laws",
    twin_records: residual_graft_ts10_tip_twin_records,
    html_pack: residual_graft_ts10_tip_html_pack,
  };

  const residual_graft_ws10_tip_decision_pack = {
    decision: residual_graft_md10_tip_decision_x,
    twin_search_pack: residual_graft_md10_tip_twin_search_pack_x,
  };

  const residual_graft_fd10_tip_record_pack = {
    session_id: "sess-1",
    items: residual_graft_ws10_tip_items,
    decision_pack: residual_graft_ws10_tip_decision_pack,
  };

  const residual_graft_cm10_tip_floating_pack = {
    highlight_launch: residual_graft_fd10_tip_highlight_launch,
    record_pack: residual_graft_fd10_tip_record_pack,
  };

  const residual_graft_db10_tip_collective_pack = {
    multiselect: residual_graft_cm10_tip_multiselect,
    floating_pack: residual_graft_cm10_tip_floating_pack,
  };

  const residual_graft_fs10_outer_draft_pack = {
    draft_gate: residual_graft_db10_tip_draft_gate,
    collective_pack: residual_graft_db10_tip_collective_pack,
  };

  const residual_wt10_outer_fullscreen_pack = {
    fullscreen: residual_graft_fs10_outer_fullscreen,
    draft_pack: residual_graft_fs10_outer_draft_pack,
  };
  ...
  // actual market_pack for html-native residual over marketplace MoWeekly=10 moniker
