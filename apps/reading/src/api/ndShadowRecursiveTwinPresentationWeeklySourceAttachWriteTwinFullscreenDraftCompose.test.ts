...
import {
  ...
  formatNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftSummary,
} from "./ndShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose";

describe("composeNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraft", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("ND shadow REJECT + twin presentation weekly source attach pack ready", () => {
    const c = composeNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraft({
    ...
    expect(
      formatNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftSummary(c),
    ).toMatch(/REJECT/);
  });
  ...
  it("parent mismatch blocks pack_ready", () => {
    const c = composeNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraft({
      nd_shadow: residual_outer_nd_shadow,
      twin_presentation: {
        ...residual_outer_twin_presentation,
        twin: {
          ...residual_outer_twin,
  ...
  it("session mismatch blocks pack_ready", () => {
    const c = composeNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraft({
      ...
      twin_presentation: {
        ...residual_outer_twin_presentation,
        weekly_pack: {
          ...residual_outer_weekly_pack,
          source_pack: {
            ...residual_outer_source_pack,
            sources: {
              ...residual_outer_sources,
