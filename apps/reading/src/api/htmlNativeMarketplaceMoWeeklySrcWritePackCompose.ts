 ...
 * (short residual: HtmlNativeMarketplaceMoWeeklySrcWritePack — FS 255; never PDF-primary).
...
import {
  composeMarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklyPack,
  type MarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklyPackCompose,
  type MarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklyPackInput,
} from "./marketplaceFreeMoSettingsWeeklySrcWriteMoWeeklyPackCompose";

export interface HtmlNativeMarketplaceMoWeeklySrcWritePackInput {
  html_view: Omit<HtmlNativeViewSessionAuthorityInput, "operator_ack">;
  market_pack: Omit<
    MarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklyPackInput,
    "operator_ack"
  >;
...
export interface HtmlNativeMarketplaceMoWeeklySrcWritePackCompose {
  session_id: string;
  ...
  market_pack: MarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklyPackCompose;
  ...
  notes: string[];
  authority: "html_native_marketplace_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeHtmlNativeMarketplaceMoWeeklySrcWritePack(
  input: HtmlNativeMarketplaceMoWeeklySrcWritePackInput,
): HtmlNativeMarketplaceMoWeeklySrcWritePackCompose {
  ...
  const market_pack = composeMarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklyPack({
    ...input.market_pack,
    operator_ack: input.operator_ack,
  });
  ...
  return {
    ...
    notes,
    authority:
      "html_native_marketplace_mo_weekly_src_write_pack_compose_advisory",
  };
}

export function formatHtmlNativeMarketplaceMoWeeklySrcWritePackSummary(
  c: HtmlNativeMarketplaceMoWeeklySrcWritePackCompose,
): string {
  return (
