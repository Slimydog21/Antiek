...
describe("composeHtmlNativeMarketplaceMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("HTML-native + marketplace free MO weekly pack ready", () => {
    const c = composeHtmlNativeMarketplaceMoWeeklySrcWritePack({
    ...
    expect(
      formatHtmlNativeMarketplaceMoWeeklySrcWritePackSummary(c),
