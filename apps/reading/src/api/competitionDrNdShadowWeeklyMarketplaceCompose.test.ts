...
describe("composeCompetitionDrNdShadowWeeklyMarketplace", () => {
  it("competition + ND weekly pack ready", () => {
    const c = composeCompetitionDrNdShadowWeeklyMarketplace({
    ...
    expect(c.nd_weekly.pack_ready).toBe(true);
    ...
    expect(formatCompetitionDrNdShadowWeeklyMarketplaceSummary(c)).toMatch(
