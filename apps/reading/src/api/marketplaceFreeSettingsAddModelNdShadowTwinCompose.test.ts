...
describe("composeMarketplaceFreeSettingsAddModelNdShadowTwin", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("marketplace free + settings ND twin pack ready", () => {
    const c = composeMarketplaceFreeSettingsAddModelNdShadowTwin({
    ...
    expect(
      formatMarketplaceFreeSettingsAddModelNdShadowTwinSummary(c),
  ...
  it("no free copy blocks market port_ready", () => {
    const c = composeMarketplaceFreeSettingsAddModelNdShadowTwin({
      market: {
        ...outer_market_input,
  ...
  it("purchase_ack without free still pure never purchases", () => {
    const c = composeMarketplaceFreeSettingsAddModelNdShadowTwin({
      market: {
        ...outer_market_input,
        free_copy_available: false,
