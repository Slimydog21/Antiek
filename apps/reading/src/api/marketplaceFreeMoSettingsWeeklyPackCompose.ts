 ...
 * (short residual: MarketplaceFreeMoSettingsWeeklyPack — FS 255; never purchase).
...
import {
  composeMidnightOilSettingsDecisionWeeklyPack,
  type MidnightOilSettingsDecisionWeeklyPackCompose,
  type MidnightOilSettingsDecisionWeeklyPackInput,
} from "./midnightOilSettingsDecisionWeeklyPackCompose";

export interface MarketplaceFreeMoSettingsWeeklyPackInput {
  market: MarketplaceFreeBeforeBuyHtmlPortInput;
  mo_pack: Omit<
    MidnightOilSettingsDecisionWeeklyPackInput,
    "operator_ack"
  >;
...
export interface MarketplaceFreeMoSettingsWeeklyPackCompose {
  title: string;
  account_id: string;
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "marketplace_free_mo_settings_weekly_pack_compose_advisory";
}
 ...
 */
export function composeMarketplaceFreeMoSettingsWeeklyPack(
  input: MarketplaceFreeMoSettingsWeeklyPackInput,
  ...
  const mo_pack = composeMidnightOilSettingsDecisionWeeklyPack({
    ...input.mo_pack,
...
export function formatMarketplaceFreeMoSettingsWeeklyPackSummary(
