...
describe("composeCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("collective multiselect + floating DR workstation MO weekly src write pack ready", () => {
    const c = composeCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
  ...
  it("session mismatch blocks pack_ready", () => {
    const c = composeCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWritePack({
      multiselect: {
        ...residual_cm2_outer_multiselect,
  ...
  it("parent mismatch blocks pack_ready", () => {
    const c = composeCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWritePack({
      multiselect: {
        ...
        members: residual_cm2_outer_multiselect.members.map((m) => ({
          ...m,
          parent_asset_id: "book-other",
        })),
      },
