...
import {
  ...
  formatAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWritePackSummary,
} from "./antiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWritePackCompose";

describe("composeAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("weekly learn + source attach write twin FS draft MO weekly src write pack ready", () => {
    const c = composeAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWritePack({
    ...
    expect(
      formatAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWritePackSummary(c),
