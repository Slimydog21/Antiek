...
import {
  ...
  formatCompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWritePackSummary,
} from "./competitionDrNdShadowWeeklySrcWriteMoWeeklySrcWritePackCompose";

describe("composeCompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("competition DR + ND shadow weekly src write MO weekly src write pack ready", () => {
    const c = composeCompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatCompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
