...
describe("composeCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("collective multiselect + floating DR workstation pack ready", () => {
    const c = composeCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
  ...
  it("empty selection fail-closed throws", () => {
    expect(() =>
      composeCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
        multiselect: {
          ...residual_cm6_outer_multiselect,
