...
import {
  ...
  formatDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePackSummary,
} from "./draftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePackCompose";

describe("composeDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("draft-before-merge + collective floating DR MO weekly src write pack ready", () => {
    const c = composeDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePack({
    ...
    expect(
      formatDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePackSummary(c),
