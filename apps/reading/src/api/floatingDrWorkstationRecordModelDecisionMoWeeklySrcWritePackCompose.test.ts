...
import {
  ...
  formatFloatingDrWorkstationRecordModelDecisionMoWeeklySrcWritePackSummary,
} from "./floatingDrWorkstationRecordModelDecisionMoWeeklySrcWritePackCompose";

describe("composeFloatingDrWorkstationRecordModelDecisionMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("floating DR + workstation record model decision MO weekly src write pack ready", () => {
    const c = composeFloatingDrWorkstationRecordModelDecisionMoWeeklySrcWritePack({
    ...
    expect(
      formatFloatingDrWorkstationRecordModelDecisionMoWeeklySrcWritePackSummary(c),
