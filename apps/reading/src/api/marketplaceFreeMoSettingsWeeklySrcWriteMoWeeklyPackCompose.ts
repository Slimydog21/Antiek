 ...
 * (short residual: MarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklyPack — FS 255; never purchase).
...
import {
  composeMidnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPack,
  type MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPackCompose,
  type MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPackInput,
} from "./midnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPackCompose";

export interface MarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklyPackInput {
  market: MarketplaceFreeBeforeBuyHtmlPortInput;
  mo_pack: Omit<
    MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPackInput,
    "operator_ack"
  >;
...
export interface MarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklyPackCompose {
  title: string;
  account_id: string;
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "marketplace_free_mo_settings_weekly_src_write_mo_weekly_pack_compose_advisory";
}
 ...
 */
export function composeMarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklyPack(
  input: MarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklyPackInput,
  ...
  const mo_pack = composeMidnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPack({
    ...input.mo_pack,
...
export function formatMarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklyPackSummary(
