...
describe("composeTwinSearchHtmlNativeMarketplaceFreeMo", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("twin search + HTML-native marketplace free MO pack ready", () => {
    const c = composeTwinSearchHtmlNativeMarketplaceFreeMo({
      search_query: "scaling noise",
    ...
    expect(
      formatTwinSearchHtmlNativeMarketplaceFreeMoSummary(c),
