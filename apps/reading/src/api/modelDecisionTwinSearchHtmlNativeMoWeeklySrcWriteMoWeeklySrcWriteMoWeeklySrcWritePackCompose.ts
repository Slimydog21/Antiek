...
import {
  composeTwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack,
  type TwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
  type TwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
} from "./twinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

export interface ModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput {
  decision: Omit<SettingsDecisionTreeUsageBarInput, "operator_ack">;
  twin_search_pack: Omit<
    TwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface ModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "model_decision_twin_search_html_native_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack(
  input: ModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
  ...
  const twin_search_pack = composeTwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
...
export function formatModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(
