...
import {
  composeAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack,
  type AntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
  type AntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
} from "./antiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

export interface RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput {
  twin: Omit<RecursiveTwinNoteTakerInput, "operator_ack">;
  presentation: TwinPresentationSurfaceInput;
  weekly_pack: Omit<
    AntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  week_id: string;
  session_id: string;
  ...
  weekly_pack: AntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose;
  ...
  notes: string[];
  authority: "recursive_twin_presentation_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack(
  input: RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
): RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  ...
  const weekly_pack = composeAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...input.weekly_pack,
    operator_ack: input.operator_ack,
  });
  ...
  return {
    ...
    notes,
    authority:
      "recursive_twin_presentation_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory",
  };
}

export function formatRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(
  c: RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
): string {
  return (
