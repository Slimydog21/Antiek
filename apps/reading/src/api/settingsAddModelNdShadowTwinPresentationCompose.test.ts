...
describe("composeSettingsAddModelNdShadowTwinPresentation", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("settings add-model + ND twin presentation pack ready", () => {
    const c = composeSettingsAddModelNdShadowTwinPresentation({
    ...
    expect(
      formatSettingsAddModelNdShadowTwinPresentationSummary(c),
  ...
  it("ND open_requested false blocks nd_pack readiness", () => {
    const c = composeSettingsAddModelNdShadowTwinPresentation({
      settings: outer_settings_input,
      nd_pack: {
        ...outer_nd_pack,
        twin_presentation: {
          ...outer_nd_pack.twin_presentation,
          presentation: {
  ...
  it("settings action preview still pure", () => {
    const c = composeSettingsAddModelNdShadowTwinPresentation({
      settings: { ...outer_settings_input, action: "preview" as const },
      nd_pack: outer_nd_pack,
      operator_ack: true,
    });
    expect(c.secrets_stored).toBe(false);
