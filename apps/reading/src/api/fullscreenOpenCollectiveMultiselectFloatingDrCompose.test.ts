...
describe("composeFullscreenOpenCollectiveMultiselectFloatingDr", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("fullscreen + collective multiselect floating DR pack ready", () => {
    const c = composeFullscreenOpenCollectiveMultiselectFloatingDr({
    ...
    expect(
      formatFullscreenOpenCollectiveMultiselectFloatingDrSummary(c),
  ...
  it("gated highlight cannot spawn fullscreen", () => {
    expect(() =>
      composeFullscreenOpenCollectiveMultiselectFloatingDr({
        fullscreen: {
          ...residual_fullscreen,
