 ...
 * (short residual: MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPack — FS 255; never live-executes).
...
import {
  ...
  type SettingsDecisionCompetitionWeeklySrcWriteMoWeeklyPackCompose,
  type SettingsDecisionCompetitionWeeklySrcWriteMoWeeklyPackInput,
} from "./settingsDecisionCompetitionWeeklySrcWriteMoWeeklyPackCompose";

export interface MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPackInput {
  mo: Omit<MidnightOilPriceCeilingApprovalInput, "operator_ack">;
  settings_pack: Omit<
    SettingsDecisionCompetitionWeeklySrcWriteMoWeeklyPackInput,
    "operator_ack"
  >;
...
export interface MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPackCompose {
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "midnight_oil_settings_decision_weekly_src_write_mo_weekly_pack_compose_advisory";
}
 ...
 */
export function composeMidnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPack(
  input: MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPackInput,
  ...
  const settings_pack = composeSettingsDecisionCompetitionWeeklySrcWriteMoWeeklyPack({
    ...input.settings_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatMidnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPackSummary(
