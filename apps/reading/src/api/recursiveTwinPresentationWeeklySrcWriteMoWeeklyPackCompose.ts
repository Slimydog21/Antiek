...
import {
  ...
  type AntiekBenchWeeklySrcWriteFsDraftMoWeeklyPackCompose,
  type AntiekBenchWeeklySrcWriteFsDraftMoWeeklyPackInput,
} from "./antiekBenchWeeklySrcWriteFsDraftMoWeeklyPackCompose";

export interface RecursiveTwinPresentationWeeklySrcWriteMoWeeklyPackInput {
  twin: Omit<RecursiveTwinNoteTakerInput, "operator_ack">;
  presentation: TwinPresentationSurfaceInput;
  weekly_pack: Omit<
    AntiekBenchWeeklySrcWriteFsDraftMoWeeklyPackInput,
    "operator_ack"
  >;
...
export interface RecursiveTwinPresentationWeeklySrcWriteMoWeeklyPackCompose {
  week_id: string;
  session_id: string;
  ...
  weekly_pack: AntiekBenchWeeklySrcWriteFsDraftMoWeeklyPackCompose;
  ...
  notes: string[];
  authority: "recursive_twin_presentation_weekly_src_write_mo_weekly_pack_compose_advisory";
}
 ...
 */
export function composeRecursiveTwinPresentationWeeklySrcWriteMoWeeklyPack(
  input: RecursiveTwinPresentationWeeklySrcWriteMoWeeklyPackInput,
): RecursiveTwinPresentationWeeklySrcWriteMoWeeklyPackCompose {
  ...
  const weekly_pack = composeAntiekBenchWeeklySrcWriteFsDraftMoWeeklyPack({
    ...input.weekly_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatRecursiveTwinPresentationWeeklySrcWriteMoWeeklyPackSummary(
  c: RecursiveTwinPresentationWeeklySrcWriteMoWeeklyPackCompose,
): string {
  return (
