...
import {
  composeAntiekBenchSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack,
  type AntiekBenchSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose,
  type AntiekBenchSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput,
} from "./antiekBenchSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose";

export interface RecursiveTwinAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput {
  twin: Omit<RecursiveTwinNoteTakerInput, "operator_ack">;
  presentation: TwinPresentationSurfaceInput;
  weekly_pack: Omit<AntiekBenchSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput, "operator_ack">;
  operator_ack: boolean;
  require_both?: boolean;
}

export interface RecursiveTwinAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose {
  week_id: string;
  session_id: string;
  ...
  weekly_pack: AntiekBenchSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose;
  ...
  notes: string[];
  authority: "recursive_twin_ab_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpack_compose_advisory";
}
 ...
 */
export function composeRecursiveTwinAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack(
  input: RecursiveTwinAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput,
): RecursiveTwinAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose {
  ...
  const weekly_pack = composeAntiekBenchSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack({
    ...input.weekly_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatRecursiveTwinAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackSummary(
  c: RecursiveTwinAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose,
): string {
  return (
