...
import {
  ...
  formatFullscreenOpenDraftBeforeMergeCollectiveMultiselectSummary,
} from "./fullscreenOpenDraftBeforeMergeCollectiveMultiselectCompose";

describe("composeFullscreenOpenDraftBeforeMergeCollectiveMultiselect", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("fullscreen + draft-before-merge collective multiselect pack ready", () => {
    const c = composeFullscreenOpenDraftBeforeMergeCollectiveMultiselect({
    ...
    expect(
      formatFullscreenOpenDraftBeforeMergeCollectiveMultiselectSummary(c),
