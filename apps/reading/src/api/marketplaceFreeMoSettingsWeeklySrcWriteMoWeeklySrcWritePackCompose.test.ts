...
describe("composeMarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("marketplace free + MO settings weekly pack ready", () => {
    const c = composeMarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatMarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
