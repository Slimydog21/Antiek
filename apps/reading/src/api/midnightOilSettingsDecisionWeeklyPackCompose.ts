 ...
 * (short residual: MidnightOilSettingsDecisionWeeklyPack — FS 255; never live-executes).
...
import {
  composeSettingsDecisionCompetitionWeeklyPack,
  type SettingsDecisionCompetitionWeeklyPackCompose,
  type SettingsDecisionCompetitionWeeklyPackInput,
} from "./settingsDecisionCompetitionWeeklyPackCompose";

export interface MidnightOilSettingsDecisionWeeklyPackInput {
  mo: Omit<MidnightOilPriceCeilingApprovalInput, "operator_ack">;
  settings_pack: Omit<
    SettingsDecisionCompetitionWeeklyPackInput,
    "operator_ack"
  >;
...
export interface MidnightOilSettingsDecisionWeeklyPackCompose {
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "midnight_oil_settings_decision_weekly_pack_compose_advisory";
}
 ...
 */
export function composeMidnightOilSettingsDecisionWeeklyPack(
  input: MidnightOilSettingsDecisionWeeklyPackInput,
  ...
  const settings_pack = composeSettingsDecisionCompetitionWeeklyPack({
    ...input.settings_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatMidnightOilSettingsDecisionWeeklyPackSummary(
