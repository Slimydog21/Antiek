...
import {
  ...
  type CollectiveMultiselectFloatingDrWorkstationRecordInput,
} from "./collectiveMultiselectFloatingDrWorkstationRecordCompose";

export interface DraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationInput {
  draft_gate: Omit<FloatingDraftBeforeFullMergeGateInput, "operator_ack">;
  collective_pack: Omit<
    CollectiveMultiselectFloatingDrWorkstationRecordInput,
    "operator_ack"
  >;
...
export interface DraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationCompose {
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "draft_before_merge_collective_multiselect_floating_dr_workstation_compose_advisory";
}
 ...
 */
export function composeDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstation(
  input: DraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationInput,
  ...
  const collective_pack = composeCollectiveMultiselectFloatingDrWorkstationRecord(
    {
...
export function formatDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationSummary(
