...
import {
  ...
  type RecursiveTwinAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput,
} from "./recursiveTwinAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose";

export interface NdShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput {
  nd_shadow: NotDiamondShadowAdvisoryInput;
  twin_presentation: Omit<RecursiveTwinAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput, "operator_ack">;
  operator_ack: boolean;
  require_both?: boolean;
}

export interface NdShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose {
  week_id: string;
  session_id: string;
  ...
  twin_presentation: RecursiveTwinAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose;
  pack_ready: boolean;
  ...
  notes: string[];
  authority: "nd_shadow_rt_ab_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpack_compose_advisory";
}
 ...
 */
export function composeNdShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack(
  input: NdShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput,
): NdShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose {
  ...
  const twin_presentation = composeRecursiveTwinAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack({
...
export function formatNdShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackSummary(
  c: NdShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose,
): string {
  return (
