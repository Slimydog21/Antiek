...
import {
  composeFullscreenOpenDraftBeforeMergeCollectiveMultiselect,
  type FullscreenOpenDraftBeforeMergeCollectiveMultiselectCompose,
  type FullscreenOpenDraftBeforeMergeCollectiveMultiselectInput,
} from "./fullscreenOpenDraftBeforeMergeCollectiveMultiselectCompose";

export interface WriteModeTwinCollectiveFullscreenDraftBeforeMergeInput {
  write: Omit<WriteModeTwinCollectiveAnalysisInput, "operator_ack">;
  fullscreen_pack: Omit<
    FullscreenOpenDraftBeforeMergeCollectiveMultiselectInput,
    "operator_ack"
  >;
...
export interface WriteModeTwinCollectiveFullscreenDraftBeforeMergeCompose {
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "write_mode_twin_collective_fullscreen_draft_before_merge_compose_advisory";
}
 ...
 */
export function composeWriteModeTwinCollectiveFullscreenDraftBeforeMerge(
  input: WriteModeTwinCollectiveFullscreenDraftBeforeMergeInput,
...
export function formatWriteModeTwinCollectiveFullscreenDraftBeforeMergeSummary(
