...
describe("composeFullscreenMoUnattendedDraftMultiselectNdTwin", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("fullscreen + MO unattended draft multiselect ND twin pack ready", () => {
    const c = composeFullscreenMoUnattendedDraftMultiselectNdTwin({
    ...
    expect(
      formatFullscreenMoUnattendedDraftMultiselectNdTwinSummary(c),
  ...
  it("spend_consent false blocks mo readiness overall", () => {
    const c = composeFullscreenMoUnattendedDraftMultiselectNdTwin({
      fullscreen: pack_outer_fullscreen,
      mo_pack: {
        ...pack_outer_mo_pack,
    ...
    expect(c.mo_pack.mo.unattended_package_ready).toBe(false);
