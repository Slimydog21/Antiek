...
describe("composeWorkstationRecordModelDecisionTwinSearchMoWeeklyPack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  const residual_ws_outer_twin_records = [
    {
      twin_id: "twin-book-1",
      parent_asset_id: "book-1",
      insights: ["scaling laws hold under noise in compute-optimal regimes"],
  ...
  const residual_ws_outer_decision_pack = {
    decision: residual_ws_outer_decision,
    twin_search_pack: {
      search_query: "scaling noise",
      twin_records: residual_ws_outer_twin_records,
      html_pack: residual_ws_outer_html_pack,
    },
  };
  ...
  it("workstation records + model decision twin search MO weekly pack ready", () => {
    const c = composeWorkstationRecordModelDecisionTwinSearchMoWeeklyPack({
      session_id: "sess-1",
    ...
    expect(
      formatWorkstationRecordModelDecisionTwinSearchMoWeeklyPackSummary(c),
