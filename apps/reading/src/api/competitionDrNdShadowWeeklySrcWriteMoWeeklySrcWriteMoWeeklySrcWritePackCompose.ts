...
import {
  composeNdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack,
  type NdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
  type NdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
} from "./ndShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

export interface CompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput {
  competition: Omit<CompetitionDrQualitySourcePackInput, "operator_ack">;
  nd_pack: Omit<
    NdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface CompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  session_id: string;
  week_id: string;
  ...
  notes: string[];
  authority: "competition_dr_nd_shadow_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeCompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack(
  input: CompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
  ...
  const nd_pack = composeNdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...input.nd_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatCompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(
