...
import {
  ...
  formatAntiekBenchWeeklySourceAttachWriteTwinSummary,
} from "./antiekBenchWeeklySourceAttachWriteTwinCompose";

describe("composeAntiekBenchWeeklySourceAttachWriteTwin", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("weekly learn + source attach write twin pack ready", () => {
    const c = composeAntiekBenchWeeklySourceAttachWriteTwin({
    ...
    expect(
      formatAntiekBenchWeeklySourceAttachWriteTwinSummary(c),
  ...
  it("insufficient weekly events blocks learn_ready and pack", () => {
    const c = composeAntiekBenchWeeklySourceAttachWriteTwin({
      weekly_learn: {
        ...residual_weekly_learn,
        events: [
          {
            event_id: "e1",
            task: "deep_research",
