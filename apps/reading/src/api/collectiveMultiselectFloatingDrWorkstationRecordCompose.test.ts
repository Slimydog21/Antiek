...
describe("composeCollectiveMultiselectFloatingDrWorkstationRecord", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("collective multiselect + floating DR workstation record pack ready", () => {
    const c = composeCollectiveMultiselectFloatingDrWorkstationRecord({
    ...
    expect(
      formatCollectiveMultiselectFloatingDrWorkstationRecordSummary(c),
  ...
  it("parent mismatch blocks pack_ready", () => {
    const c = composeCollectiveMultiselectFloatingDrWorkstationRecord({
      multiselect: {
        ...
        members: residual_outer_multiselect.members.map((m) => ({
          ...m,
          parent_asset_id: "book-other",
        })),
      },
