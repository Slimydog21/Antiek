...
describe("composeRecursiveTwinNoteTakerTwinSearchModelDecision", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("recursive twin note-taker + twin search model decision pack ready", () => {
    const c = composeRecursiveTwinNoteTakerTwinSearchModelDecision({
    ...
    expect(
      formatRecursiveTwinNoteTakerTwinSearchModelDecisionSummary(c),
  ...
  it("parent misalignment blocks", () => {
    const c = composeRecursiveTwinNoteTakerTwinSearchModelDecision({
      twin: {
        ...pack_outer_twin_note_input,
  ...
  it("zero search hits nested blocks overall", () => {
    const c = composeRecursiveTwinNoteTakerTwinSearchModelDecision({
      twin: pack_outer_twin_note_input,
      twin_search_pack: {
