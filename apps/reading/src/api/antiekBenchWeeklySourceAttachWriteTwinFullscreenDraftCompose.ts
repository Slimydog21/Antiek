 ...
 * write twin fullscreen draft-before-merge pack (pure).
 *
...
import {
  ...
  type SourceAttachWriteTwinFullscreenDraftBeforeMergeInput,
} from "./sourceAttachWriteTwinFullscreenDraftBeforeMergeCompose";

export interface AntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftInput {
  weekly_learn: Omit<AntiekBenchWeeklyUsageLearnInput, "operator_ack">;
  source_pack: Omit<
    SourceAttachWriteTwinFullscreenDraftBeforeMergeInput,
    "operator_ack"
  >;
...
export interface AntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftCompose {
  week_id: string;
  session_id: string;
  ...
  source_pack: SourceAttachWriteTwinFullscreenDraftBeforeMergeCompose;
  ...
  notes: string[];
  authority: "antiek_bench_weekly_source_attach_write_twin_fullscreen_draft_compose_advisory";
}
 ...
 */
export function composeAntiekBenchWeeklySourceAttachWriteTwinFullscreenDraft(
  input: AntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftInput,
): AntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftCompose {
  ...
  const source_pack = composeSourceAttachWriteTwinFullscreenDraftBeforeMerge({
    ...input.source_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatAntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftSummary(
  c: AntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftCompose,
): string {
  return (
