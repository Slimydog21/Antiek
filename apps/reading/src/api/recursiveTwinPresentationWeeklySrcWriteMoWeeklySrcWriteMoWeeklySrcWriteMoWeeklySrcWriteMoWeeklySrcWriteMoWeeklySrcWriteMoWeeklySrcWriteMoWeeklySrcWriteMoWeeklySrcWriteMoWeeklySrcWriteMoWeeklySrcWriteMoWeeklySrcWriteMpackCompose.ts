/**
 * Recursive twin note-taker presentation residual over Antiek-bench weekly
 * usage-learn + HTML-native source attach write twin pack (pure).
 *
 * Operator vision: present twin insights/questions as side-panel / overlay /
 * fullscreen / inline beside weekly bench learn + arxiv/substack source attach
 * + write twin collective honesty — without writing the twin, mutating bench,
 * remote-fetching, or live-dispatching.
 *
...
import {
  ...
  type AntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackCompose,
  type AntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackInput,
...
export interface RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackInput {
  twin: Omit<RecursiveTwinNoteTakerInput, "operator_ack">;
  presentation: TwinPresentationSurfaceInput;
  weekly_pack: Omit<
    AntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackInput,
    "operator_ack"
  >;
...
export interface RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackCompose {
  week_id: string;
  session_id: string;
  ...
  weekly_pack: AntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackCompose;
  ...
  notes: string[];
  authority: "recursive_twin_presentation_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mpack_compose_advisory";
}
...
/**
 * Twin presentation stacked on weekly bench learn + source attach write twin.
 * Never writes twin; never mutates bench; ND REJECT.
 */
export function composeRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpack(
  input: RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackInput,
): RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackCompose {
  ...
  const weekly_pack = composeAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpack({
    ...input.weekly_pack,
    operator_ack: input.operator_ack,
  });
  ...
  const session_id = requireNonEmpty(weekly_pack.session_id, "session_id");
  ...
  const session_aligned = weekly_pack.session_aligned === true;
  const parent_aligned =
    weekly_pack.parent_asset_id === parent_asset_id ||
    weekly_pack.asset_id === parent_asset_id ||
    weekly_pack.parent_aligned === true;
  // Prefer strict parent match on twin parent vs weekly pack parent
  const parent_aligned_strict =
    weekly_pack.parent_asset_id === parent_asset_id ||
    weekly_pack.asset_id === parent_asset_id;
  if (!parent_aligned_strict) {
    notes.push(
  ...
  if (require_both) {
    ...
    pack_ready =
      ...
      weekly_pack.pdf_primary === false &&
      weekly_pack.backlog_mutated === false &&
      (presentation_ready === true || weekly_pack.pack_ready === true);
  }
  ...
  return {
    ...
    notes,
    authority:
      "recursive_twin_presentation_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mpack_compose_advisory",
  };
}

export function formatRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackSummary(
  c: RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackCompose,
): string {
  return (
    `pack_ready=${c.pack_ready} · ` +
    `presentation_ready=${c.presentation.presentation_ready} · ` +
    `weekly_ready=${c.weekly_pack.pack_ready} · ` +
    `learn_ready=${c.weekly_pack.learn_ready} · ` +
