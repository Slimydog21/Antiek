...
import {
  composeHtmlNativeMarketplaceFreeMidnightOilSettings,
  type HtmlNativeMarketplaceFreeMidnightOilSettingsCompose,
  type HtmlNativeMarketplaceFreeMidnightOilSettingsInput,
} from "./htmlNativeMarketplaceFreeMidnightOilSettingsCompose";

export interface TwinSearchHtmlNativeMarketplaceFreeMoInput {
  search_query: string;
  twin_records: TwinSearchRecord[];
  search_limit?: number;
  html_pack: Omit<
    HtmlNativeMarketplaceFreeMidnightOilSettingsInput,
    "operator_ack"
  >;
...
export interface TwinSearchHtmlNativeMarketplaceFreeMoCompose {
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "twin_search_html_native_marketplace_free_mo_compose_advisory";
}
 ...
 */
export function composeTwinSearchHtmlNativeMarketplaceFreeMo(
  input: TwinSearchHtmlNativeMarketplaceFreeMoInput,
  ...
  const html_pack = composeHtmlNativeMarketplaceFreeMidnightOilSettings({
    ...input.html_pack,
...
export function formatTwinSearchHtmlNativeMarketplaceFreeMoSummary(
