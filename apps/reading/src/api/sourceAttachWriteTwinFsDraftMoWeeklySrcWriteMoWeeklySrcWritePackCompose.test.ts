...
describe("composeSourceAttachWriteTwinFsDraftMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("source attach + write twin fullscreen draft MO weekly src write pack ready", () => {
    const c = composeSourceAttachWriteTwinFsDraftMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatSourceAttachWriteTwinFsDraftMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
