...
describe("composeMarketplaceFreeMoSettingsWeeklyPack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("marketplace free + MO settings weekly pack ready", () => {
    const c = composeMarketplaceFreeMoSettingsWeeklyPack({
    ...
    expect(c.authority).toBe("marketplace_free_mo_settings_weekly_pack_compose_advisory");
    expect(formatMarketplaceFreeMoSettingsWeeklyPackSummary(c)).toMatch(/purchase_executed=false/);
  });
