...
describe("composeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("Midnight Oil + settings decision competition DR pack ready", () => {
    const c = composeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
    ...
    expect(
      formatMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinSummary(c),
    ).toMatch(/live_execution_authorized=false|charge_executed=false|REJECT/);
  });
  ...
  it("unattended_ack false blocks MO pack", () => {
    const c = composeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
      mo: {
        ...residual_outer_mo,
  ...
  it("approved_ceiling below recommended blocks MO pack", () => {
    const c = composeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
      mo: {
        ...residual_outer_mo,
        approved_ceiling_usd: 50,
