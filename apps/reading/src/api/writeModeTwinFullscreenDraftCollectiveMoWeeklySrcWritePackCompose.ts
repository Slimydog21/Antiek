...
import {
  ...
  type FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackInput,
} from "./fullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackCompose";

export interface WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePackInput {
  write: Omit<WriteModeTwinCollectiveAnalysisInput, "operator_ack">;
  fullscreen_pack: Omit<
    FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePackCompose {
  week_id: string;
  session_id: string;
  ...
  fullscreen_pack: FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackCompose;
  ...
  notes: string[];
  authority: "write_mode_twin_fullscreen_draft_collective_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeWriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePack(
  input: WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePackInput,
): WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePackCompose {
...
export function formatWriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePackSummary(
  c: WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePackCompose,
): string {
  return (
