...
describe("composeFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
const WEEKLY_ND = {
  weekly_learn: {
    week_id: "2026-W28",
...
const COMPETITION_CITATIONS = [
  ...
  it("fullscreen-open + draft-before-merge collective pack ready", () => {
    const c = composeFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
    ).toMatch(/REJECT|pack_ready=true|merge_executed=false/);
  });
  ...
  it("gated fullscreen fail-closed throws", () => {
    expect(() =>
      composeFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
        fullscreen: {
          ...residual_fs5_outer_fullscreen,
          gated: true,
        },
        draft_pack: residual_fs5_outer_draft_pack,
        operator_ack: true,
      }),
    ).toThrow(/gated|withheld|cannot/i);
  });
