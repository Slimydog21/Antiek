...
describe("composeTwinSearchHtmlNativeMarketplaceMoWeeklyPack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("twin search + HTML-native marketplace MO weekly pack ready", () => {
    const c = composeTwinSearchHtmlNativeMarketplaceMoWeeklyPack({
      search_query: "scaling noise",
    ...
    expect(
      formatTwinSearchHtmlNativeMarketplaceMoWeeklyPackSummary(c),
