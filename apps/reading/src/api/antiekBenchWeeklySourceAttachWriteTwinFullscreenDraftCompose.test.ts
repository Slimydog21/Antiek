...
import {
  ...
  formatAntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftSummary,
} from "./antiekBenchWeeklySourceAttachWriteTwinFullscreenDraftCompose";

describe("composeAntiekBenchWeeklySourceAttachWriteTwinFullscreenDraft", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("weekly learn + source attach write twin fullscreen draft pack ready", () => {
    const c = composeAntiekBenchWeeklySourceAttachWriteTwinFullscreenDraft({
    ...
    expect(
      formatAntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftSummary(c),
