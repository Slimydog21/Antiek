...
import {
  composeNdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWritePack,
  type NdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWritePackCompose,
  type NdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWritePackInput,
} from "./ndShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWritePackCompose";

export interface CompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWritePackInput {
  competition: Omit<CompetitionDrQualitySourcePackInput, "operator_ack">;
  nd_pack: Omit<
    NdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface CompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWritePackCompose {
  session_id: string;
  week_id: string;
  ...
  nd_pack: NdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWritePackCompose;
  ...
  notes: string[];
  authority: "competition_dr_nd_shadow_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeCompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWritePack(
  input: CompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWritePackInput,
): CompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWritePackCompose {
  ...
  const nd_pack = composeNdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWritePack({
    ...input.nd_pack,
    operator_ack: input.operator_ack,
  });
  ...
  return {
    ...
    notes,
    authority:
      "competition_dr_nd_shadow_weekly_src_write_mo_weekly_src_write_pack_compose_advisory",
  };
}

export function formatCompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWritePackSummary(
  c: CompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWritePackCompose,
): string {
  return (
