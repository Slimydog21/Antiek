...
import {
  composeTwinSearchHtmlNativeMarketplaceMoWeeklySrcWritePack,
  type TwinSearchHtmlNativeMarketplaceMoWeeklySrcWritePackCompose,
  type TwinSearchHtmlNativeMarketplaceMoWeeklySrcWritePackInput,
} from "./twinSearchHtmlNativeMarketplaceMoWeeklySrcWritePackCompose";

export interface ModelDecisionTwinSearchHtmlNativeMoWeeklySrcWritePackInput {
  decision: Omit<SettingsDecisionTreeUsageBarInput, "operator_ack">;
  twin_search_pack: Omit<
    TwinSearchHtmlNativeMarketplaceMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface ModelDecisionTwinSearchHtmlNativeMoWeeklySrcWritePackCompose {
  week_id: string;
  session_id: string;
  ...
  twin_search_pack: TwinSearchHtmlNativeMarketplaceMoWeeklySrcWritePackCompose;
  pack_ready: boolean;
  ...
  notes: string[];
  authority: "model_decision_twin_search_html_native_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeModelDecisionTwinSearchHtmlNativeMoWeeklySrcWritePack(
  input: ModelDecisionTwinSearchHtmlNativeMoWeeklySrcWritePackInput,
  ...
  const twin_search_pack = composeTwinSearchHtmlNativeMarketplaceMoWeeklySrcWritePack({
  ...
  return {
    ...
    notes,
    authority:
      "model_decision_twin_search_html_native_mo_weekly_src_write_pack_compose_advisory",
  };
}

export function formatModelDecisionTwinSearchHtmlNativeMoWeeklySrcWritePackSummary(
  c: ModelDecisionTwinSearchHtmlNativeMoWeeklySrcWritePackCompose,
): string {
  const exceed =
