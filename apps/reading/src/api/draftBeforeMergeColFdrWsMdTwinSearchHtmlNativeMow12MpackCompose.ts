...
import {
  composeCollectiveFdrWsMdTwinSearchHtmlNativeMow12Mpack,
  type CollectiveFdrWsMdTwinSearchHtmlNativeMow12MpackCompose,
  type CollectiveFdrWsMdTwinSearchHtmlNativeMow12MpackInput,
} from "./collectiveFdrWsMdTwinSearchHtmlNativeMow12MpackCompose";

export interface DraftBeforeMergeColFdrWsMdTwinSearchHtmlNativeMow12MpackInput {
  draft_gate: Omit<FloatingDraftBeforeFullMergeGateInput, "operator_ack">;
  collective_pack: Omit<CollectiveFdrWsMdTwinSearchHtmlNativeMow12MpackInput, "operator_ack">;
  operator_ack: boolean;
  require_both?: boolean;
}

export interface DraftBeforeMergeColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose {
  week_id: string;
  session_id: string;
  ...
  collective_pack: CollectiveFdrWsMdTwinSearchHtmlNativeMow12MpackCompose;
  ...
  notes: string[];
  authority: "draft_before_merge_col_fdr_ws_md_twin_search_html_native_mow12_mpack_compose_advisory";
}
...
/**
 * Draft-before-full-merge stacked on collective FDR MD mow12.
 * Never writes draft or merges parent; ND REJECT.
 */
export function composeDraftBeforeMergeColFdrWsMdTwinSearchHtmlNativeMow12Mpack(
  input: DraftBeforeMergeColFdrWsMdTwinSearchHtmlNativeMow12MpackInput,
): DraftBeforeMergeColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose {
  ...
  const collective_pack = composeCollectiveFdrWsMdTwinSearchHtmlNativeMow12Mpack({
...
export function formatDraftBeforeMergeColFdrWsMdTwinSearchHtmlNativeMow12MpackSummary(
  c: DraftBeforeMergeColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose,
): string {
  return (
