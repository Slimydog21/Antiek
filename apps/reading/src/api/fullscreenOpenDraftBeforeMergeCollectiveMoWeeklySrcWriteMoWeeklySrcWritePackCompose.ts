...
import {
  composeDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWritePack,
  type DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
  type DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWritePackInput,
} from "./draftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

export interface FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackInput {
  fullscreen: Omit<FloatingFullscreenOpenInput, "operator_ack">;
  draft_pack: Omit<
    DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  week_id: string;
  session_id: string;
  ...
  draft_pack: DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWritePackCompose;
  ...
  notes: string[];
  authority: "fullscreen_open_draft_before_merge_collective_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWritePack(
  input: FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackInput,
): FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  ...
  return {
    ...
    notes,
    authority:
      "fullscreen_open_draft_before_merge_collective_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory",
  };
}

export function formatFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackSummary(
  c: FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
): string {
  return (
