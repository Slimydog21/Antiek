...
describe("composeSettingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("settings decision + competition DR ND shadow weekly pack ready", () => {
    const c = composeSettingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatSettingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
  ...
  it("would_exceed on nested competition blocks pack", () => {
    const c = composeSettingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
      ...
      competition_pack: {
        competition: {
          ...residual_cd3_outer_competition,
          would_exceed: true,
        },
        nd_pack: residual_cd3_outer_nd_pack,
      },
