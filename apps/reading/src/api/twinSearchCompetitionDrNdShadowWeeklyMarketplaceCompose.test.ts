...
describe("composeTwinSearchCompetitionDrNdShadowWeeklyMarketplace", () => {
  ...
  it("twin search + competition ND pack ready", () => {
    const c = composeTwinSearchCompetitionDrNdShadowWeeklyMarketplace({
      competition_pack,
    ...
    expect(c.twin_corpus.length).toBeGreaterThan(0);
    expect(c.authority).toBe(
      "twin_search_competition_dr_nd_shadow_weekly_marketplace_compose_advisory",
    );
    expect(formatTwinSearchCompetitionDrNdShadowWeeklyMarketplaceSummary(c)).toMatch(
  ...
  it("would_exceed blocks competition path", () => {
    const c = composeTwinSearchCompetitionDrNdShadowWeeklyMarketplace({
      competition_pack: {
        ...competition_pack,
  ...
  it("extra twins expand corpus and remain pure", () => {
    const c = composeTwinSearchCompetitionDrNdShadowWeeklyMarketplace({
      competition_pack,
