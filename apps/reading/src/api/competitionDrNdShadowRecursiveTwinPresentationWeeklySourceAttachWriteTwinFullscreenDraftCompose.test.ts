...
describe("composeCompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraft", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("competition DR + ND shadow twin presentation weekly pack ready", () => {
    const c = composeCompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraft({
    ...
    expect(
      formatCompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftSummary(c),
