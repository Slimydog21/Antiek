...
describe("composeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("collective multiselect + floating DR workstation record pack ready", () => {
    const c = composeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
    ...
    expect(c.floating_pack.pack_ready).toBe(true);
    ...
    expect(c.authority).toBe("collective_multiselect_floating_dr_workstation_record_model_decision_twin_search_html_native_marketplace_free_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin_compose_advisory");
    expect(formatCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinSummary(c)).toMatch(/live_dispatched=false/);
  });
  ...
  it("session mismatch blocks pack_ready", () => {
    const c = composeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
      multiselect: {
        ...residual_collective_outer_multiselect,
  ...
  it("parent mismatch blocks pack_ready", () => {
    const c = composeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
      multiselect: {
        ...
        members: residual_collective_outer_multiselect.members.map((m) => ({
          ...m,
          parent_asset_id: "book-other",
        })),
      },
