...
import {
  ...
  type WriteModeTwinFullscreenDraftCollectiveMoWeeklyPackCompose,
  type WriteModeTwinFullscreenDraftCollectiveMoWeeklyPackInput,
} from "./writeModeTwinFullscreenDraftCollectiveMoWeeklyPackCompose";

export interface SourceAttachWriteTwinFsDraftMoWeeklyPackInput {
  sources: Omit<HtmlNativeSourceAttachInput, "operator_ack">;
  write_pack: Omit<
    WriteModeTwinFullscreenDraftCollectiveMoWeeklyPackInput,
    "operator_ack"
  >;
...
export interface SourceAttachWriteTwinFsDraftMoWeeklyPackCompose {
  session_id: string;
  ...
  write_pack: WriteModeTwinFullscreenDraftCollectiveMoWeeklyPackCompose;
  ...
  notes: string[];
  authority: "source_attach_write_twin_fs_draft_mo_weekly_pack_compose_advisory";
}
...
/**
 * HTML-native source attach stacked on write twin fullscreen draft MO weekly pack.
 * Never remote-fetches; never PDF; ND REJECT.
 */
export function composeSourceAttachWriteTwinFsDraftMoWeeklyPack(
  input: SourceAttachWriteTwinFsDraftMoWeeklyPackInput,
  ...
  const write_pack = composeWriteModeTwinFullscreenDraftCollectiveMoWeeklyPack({
    ...input.write_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatSourceAttachWriteTwinFsDraftMoWeeklyPackSummary(
  c: SourceAttachWriteTwinFsDraftMoWeeklyPackCompose,
): string {
  return (
