 ...
 * (short residual: CompetitionDrNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack — FS 255; ND REJECT).
...
import {
  composeNdShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack,
  type NdShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose,
  type NdShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput,
} from "./ndShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose";

export interface CompetitionDrNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput {
  competition: Omit<CompetitionDrQualitySourcePackInput, "operator_ack">;
  nd_pack: Omit<
    NdShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput,
    "operator_ack"
  >;
...
export interface CompetitionDrNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose {
  session_id: string;
  week_id: string;
  ...
  nd_pack: NdShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose;
  ...
  notes: string[];
  authority: "competition_dr_nds_rt_ab_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpack_compose_advisory";
}
 ...
 */
export function composeCompetitionDrNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack(
  input: CompetitionDrNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput,
): CompetitionDrNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose {
  ...
  const nd_pack = composeNdShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack({
    ...input.nd_pack,
    operator_ack: input.operator_ack,
  });
  ...
  return {
    ...
    notes,
    authority:
      "competition_dr_nds_rt_ab_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpack_compose_advisory",
  };
}

export function formatCompetitionDrNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackSummary(
  c: CompetitionDrNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose,
): string {
  return (
