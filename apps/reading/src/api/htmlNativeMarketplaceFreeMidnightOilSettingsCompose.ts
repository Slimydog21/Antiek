...
import {
  ...
  type MarketplaceFreeMidnightOilSettingsDecisionInput,
} from "./marketplaceFreeMidnightOilSettingsDecisionCompose";

export interface HtmlNativeMarketplaceFreeMidnightOilSettingsInput {
  html_view: Omit<HtmlNativeViewSessionAuthorityInput, "operator_ack">;
  market_pack: Omit<
    MarketplaceFreeMidnightOilSettingsDecisionInput,
    "operator_ack"
  >;
...
export interface HtmlNativeMarketplaceFreeMidnightOilSettingsCompose {
  session_id: string;
  ...
  market_pack: MarketplaceFreeMidnightOilSettingsDecisionCompose;
  ...
  notes: string[];
  authority: "html_native_marketplace_free_midnight_oil_settings_compose_advisory";
}
 ...
 */
export function composeHtmlNativeMarketplaceFreeMidnightOilSettings(
  input: HtmlNativeMarketplaceFreeMidnightOilSettingsInput,
  ...
  const market_pack = composeMarketplaceFreeMidnightOilSettingsDecision({
    ...input.market_pack,
    operator_ack: input.operator_ack,
  });
  ...
  return {
    ...
    notes,
    authority:
      "html_native_marketplace_free_midnight_oil_settings_compose_advisory",
  };
}

export function formatHtmlNativeMarketplaceFreeMidnightOilSettingsSummary(
  c: HtmlNativeMarketplaceFreeMidnightOilSettingsCompose,
): string {
  return (
