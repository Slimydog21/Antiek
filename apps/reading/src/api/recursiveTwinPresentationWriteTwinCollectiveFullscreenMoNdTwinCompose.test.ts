...
describe("composeRecursiveTwinPresentationWriteTwinCollectiveFullscreenMoNdTwin", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("recursive twin presentation + write twin collective fullscreen MO ND twin pack ready", () => {
    const c = composeRecursiveTwinPresentationWriteTwinCollectiveFullscreenMoNdTwin({
    ...
    expect(
      formatRecursiveTwinPresentationWriteTwinCollectiveFullscreenMoNdTwinSummary(c),
  ...
  it("open_requested false blocks presentation readiness", () => {
    const c = composeRecursiveTwinPresentationWriteTwinCollectiveFullscreenMoNdTwin({
      twin: pack_outer_twin,
      presentation: {
