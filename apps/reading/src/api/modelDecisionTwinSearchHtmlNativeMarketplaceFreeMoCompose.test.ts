...
describe("composeModelDecisionTwinSearchHtmlNativeMarketplaceFreeMo", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("model decision + twin search HTML-native marketplace free MO pack ready", () => {
    const c = composeModelDecisionTwinSearchHtmlNativeMarketplaceFreeMo({
    ...
    expect(
      formatModelDecisionTwinSearchHtmlNativeMarketplaceFreeMoSummary(c),
  ...
  it("empty twin hits block twin_search_pack and pack under require_both", () => {
    const c = composeModelDecisionTwinSearchHtmlNativeMarketplaceFreeMo({
      decision: residual_decision,
      twin_search_pack: {
        ...residual_outer_twin_search_pack,
        twin_records: [],
      },
      operator_ack: true,
    });
