...
import {
  ...
  formatMidnightOilSettingsDecisionWeeklyPackSummary,
} from "./midnightOilSettingsDecisionWeeklyPackCompose";

describe("composeMidnightOilSettingsDecisionWeeklyPack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("Midnight Oil + settings decision competition weekly pack ready", () => {
    const c = composeMidnightOilSettingsDecisionWeeklyPack({
    ...
    expect(c.authority).toBe("midnight_oil_settings_decision_weekly_pack_compose_advisory");
    expect(formatMidnightOilSettingsDecisionWeeklyPackSummary(c)).toMatch(/live_execution_authorized=false/);
  });
