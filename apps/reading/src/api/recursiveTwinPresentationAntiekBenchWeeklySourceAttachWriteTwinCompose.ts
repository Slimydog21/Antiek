...
import {
  composeAntiekBenchWeeklySourceAttachWriteTwin,
  type AntiekBenchWeeklySourceAttachWriteTwinCompose,
  type AntiekBenchWeeklySourceAttachWriteTwinInput,
} from "./antiekBenchWeeklySourceAttachWriteTwinCompose";

export interface RecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinInput {
  twin: Omit<RecursiveTwinNoteTakerInput, "operator_ack">;
  presentation: TwinPresentationSurfaceInput;
  weekly_pack: Omit<
    AntiekBenchWeeklySourceAttachWriteTwinInput,
    "operator_ack"
  >;
...
export interface RecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinCompose {
  week_id: string;
  session_id: string;
  ...
  weekly_pack: AntiekBenchWeeklySourceAttachWriteTwinCompose;
  ...
  notes: string[];
  authority: "recursive_twin_presentation_antiek_bench_weekly_source_attach_write_twin_compose_advisory";
}
 ...
 */
export function composeRecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwin(
  input: RecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinInput,
): RecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinCompose {
  ...
  const weekly_pack = composeAntiekBenchWeeklySourceAttachWriteTwin({
    ...input.weekly_pack,
    operator_ack: input.operator_ack,
  });
  ...
  return {
    ...
    notes,
    authority:
      "recursive_twin_presentation_antiek_bench_weekly_source_attach_write_twin_compose_advisory",
  };
}

export function formatRecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinSummary(
  c: RecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinCompose,
): string {
  return (
