...
import {
  ...
  formatFullscreenOpenDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinSummary,
...
describe("composeFullscreenOpenDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("fullscreen open + draft-before-merge pack ready", () => {
    const c = composeFullscreenOpenDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
      fullscreen: residual_fullscreen_outer_fullscreen,
      draft_pack: residual_fullscreen_outer_draft_pack,
      operator_ack: true,
    });
    expect(c.fullscreen.fullscreen_ready).toBe(true);
    expect(c.draft_pack.pack_ready).toBe(true);
    ...
    expect(c.authority).toBe("fullscreen_open_draft_before_merge_collective_multiselect_floating_dr_workstation_record_model_decision_twin_search_html_native_marketplace_free_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin_compose_advisory");
    expect(formatFullscreenOpenDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinSummary(c)).toMatch(/merge_executed=false/);
  });
  ...
  it("session mismatch blocks pack_ready", () => {
    const c = composeFullscreenOpenDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
      fullscreen: {
        ...residual_fullscreen_outer_fullscreen,
  ...
  it("gated highlight fail-closed throws (no spawn)", () => {
    expect(() =>
      composeFullscreenOpenDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
        fullscreen: {
          ...residual_fullscreen_outer_fullscreen,
    ...
    ).toThrow(/gated\/withheld highlight cannot spawn/);
  });
});
