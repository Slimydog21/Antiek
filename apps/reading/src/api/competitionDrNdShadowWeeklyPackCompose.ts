 ...
 * (short residual: CompetitionDrNdShadowWeeklyPack — FS 255; ND REJECT).
...
import {
  composeNdShadowRecursiveTwinWeeklyPack,
  type NdShadowRecursiveTwinWeeklyPackCompose,
  type NdShadowRecursiveTwinWeeklyPackInput,
} from "./ndShadowRecursiveTwinWeeklyPackCompose";

export interface CompetitionDrNdShadowWeeklyPackInput {
  competition: Omit<CompetitionDrQualitySourcePackInput, "operator_ack">;
  nd_pack: Omit<
    NdShadowRecursiveTwinWeeklyPackInput,
    "operator_ack"
  >;
...
export interface CompetitionDrNdShadowWeeklyPackCompose {
  session_id: string;
  week_id: string;
  ...
  nd_pack: NdShadowRecursiveTwinWeeklyPackCompose;
  ...
  notes: string[];
  authority: "competition_dr_nd_shadow_weekly_pack_compose_advisory";
}
 ...
 */
export function composeCompetitionDrNdShadowWeeklyPack(
  input: CompetitionDrNdShadowWeeklyPackInput,
): CompetitionDrNdShadowWeeklyPackCompose {
  ...
  const nd_pack = composeNdShadowRecursiveTwinWeeklyPack({
    ...input.nd_pack,
    operator_ack: input.operator_ack,
  });
  ...
  return {
    ...
    notes,
    authority:
      "competition_dr_nd_shadow_weekly_pack_compose_advisory",
  };
}

export function formatCompetitionDrNdShadowWeeklyPackSummary(
  c: CompetitionDrNdShadowWeeklyPackCompose,
): string {
  return (
