...
import {
  ...
  formatDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinSummary,
...
describe("composeDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("draft-before-merge + collective multiselect floating DR pack ready", () => {
    const c = composeDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
      draft_gate: residual_draft_outer_draft_gate,
      collective_pack: residual_draft_outer_collective_pack,
      operator_ack: true,
    });
    expect(c.draft_gate.gate_ready).toBe(true);
    expect(c.collective_pack.pack_ready).toBe(true);
    ...
    expect(c.authority).toBe("draft_before_merge_collective_multiselect_floating_dr_workstation_record_model_decision_twin_search_html_native_marketplace_free_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin_compose_advisory");
    expect(formatDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinSummary(c)).toMatch(/merge_executed=false/);
  });
  ...
  it("session mismatch blocks pack_ready", () => {
    const c = composeDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
      draft_gate: {
        ...residual_draft_outer_draft_gate,
  ...
  it("parent mismatch blocks pack_ready", () => {
    const c = composeDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
      draft_gate: {
        ...
        sources: residual_draft_outer_draft_gate.sources.map((s) => ({
          ...s,
          parent_asset_id: "book-other",
        })),
      },
