 ...
 * (short residual: HtmlNativeMarketplaceMoWeeklyPack — FS 255; never PDF-primary).
...
import {
  ...
  type MarketplaceFreeMoSettingsWeeklyPackInput,
} from "./marketplaceFreeMoSettingsWeeklyPackCompose";

export interface HtmlNativeMarketplaceMoWeeklyPackInput {
  html_view: Omit<HtmlNativeViewSessionAuthorityInput, "operator_ack">;
  market_pack: Omit<
    MarketplaceFreeMoSettingsWeeklyPackInput,
    "operator_ack"
  >;
...
export interface HtmlNativeMarketplaceMoWeeklyPackCompose {
  session_id: string;
  ...
  market_pack: MarketplaceFreeMoSettingsWeeklyPackCompose;
  ...
  notes: string[];
  authority: "html_native_marketplace_mo_weekly_pack_compose_advisory";
}
 ...
 */
export function composeHtmlNativeMarketplaceMoWeeklyPack(
  input: HtmlNativeMarketplaceMoWeeklyPackInput,
): HtmlNativeMarketplaceMoWeeklyPackCompose {
  ...
  const market_pack = composeMarketplaceFreeMoSettingsWeeklyPack({
    ...input.market_pack,
    operator_ack: input.operator_ack,
  });
  ...
  return {
    ...
    notes,
    authority:
      "html_native_marketplace_mo_weekly_pack_compose_advisory",
  };
}

export function formatHtmlNativeMarketplaceMoWeeklyPackSummary(
  c: HtmlNativeMarketplaceMoWeeklyPackCompose,
): string {
  return (
