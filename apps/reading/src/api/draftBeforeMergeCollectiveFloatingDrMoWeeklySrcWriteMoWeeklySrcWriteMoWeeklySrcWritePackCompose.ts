...
import {
  composeCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack,
  type CollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
  type CollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
} from "./collectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

export interface DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput {
  draft_gate: Omit<FloatingDraftBeforeFullMergeGateInput, "operator_ack">;
  collective_pack: Omit<
    CollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  week_id: string;
  session_id: string;
  ...
  collective_pack: CollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose;
  ...
  notes: string[];
  authority: "draft_before_merge_collective_floating_dr_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack(
  input: DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
): DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  ...
  const collective_pack = composeCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack(
    {
...
export function formatDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(
  c: DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
): string {
  return (
