...
describe("composeFloatingDrWorkstationRecordModelDecisionMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("floating DR + workstation record model decision pack ready", () => {
    const c = composeFloatingDrWorkstationRecordModelDecisionMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatFloatingDrWorkstationRecordModelDecisionMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
  ...
  it("gated highlight fail-closed throws", () => {
    expect(() =>
      composeFloatingDrWorkstationRecordModelDecisionMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
        highlight_launch: {
          ...residual_fd3_outer_highlight_launch,
          gated: true,
        },
        record_pack: residual_fd3_outer_record_pack,
        operator_ack: true,
