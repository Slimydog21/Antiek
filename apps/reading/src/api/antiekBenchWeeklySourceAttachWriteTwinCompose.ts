 ...
 * write twin collective fullscreen pack (pure).
 *
...
import {
  composeSourceAttachWriteTwinCollectiveFullscreen,
  type SourceAttachWriteTwinCollectiveFullscreenCompose,
  type SourceAttachWriteTwinCollectiveFullscreenInput,
} from "./sourceAttachWriteTwinCollectiveFullscreenCompose";

export interface AntiekBenchWeeklySourceAttachWriteTwinInput {
  weekly_learn: Omit<AntiekBenchWeeklyUsageLearnInput, "operator_ack">;
  source_pack: Omit<
    SourceAttachWriteTwinCollectiveFullscreenInput,
    "operator_ack"
  >;
...
export interface AntiekBenchWeeklySourceAttachWriteTwinCompose {
  week_id: string;
  session_id: string;
  ...
  source_pack: SourceAttachWriteTwinCollectiveFullscreenCompose;
  ...
  notes: string[];
  authority: "antiek_bench_weekly_source_attach_write_twin_compose_advisory";
}
...
/**
 * Weekly bench learn stacked on source-attach write twin collective fullscreen.
 * Never mutates bench; never remote-fetches; ND REJECT.
 */
export function composeAntiekBenchWeeklySourceAttachWriteTwin(
  input: AntiekBenchWeeklySourceAttachWriteTwinInput,
): AntiekBenchWeeklySourceAttachWriteTwinCompose {
  ...
  const source_pack = composeSourceAttachWriteTwinCollectiveFullscreen({
    ...input.source_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatAntiekBenchWeeklySourceAttachWriteTwinSummary(
  c: AntiekBenchWeeklySourceAttachWriteTwinCompose,
): string {
  return (
