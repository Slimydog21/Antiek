...
import {
  ...
  formatRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary,
} from "./recursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

describe("composeRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("twin presentation + weekly source attach write twin MO weekly src write pack ready", () => {
    const c = composeRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
  ...
  it("session mismatch via nested source blocks pack_ready", () => {
    const c = composeRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
      ...
      presentation: residual_rt2_outer_presentation,
      weekly_pack: {
        ...residual_rt2_outer_weekly_pack,
        source_pack: {
          ...residual_ab2_outer_source_pack,
          sources: {
            ...residual_ab2_outer_source_pack.sources,
