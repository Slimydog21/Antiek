...
import {
  ...
  type FullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackCompose,
  type FullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackInput,
} from "./fullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackCompose";

export interface WriteModeTwinFullscreenDraftCollectiveMoWeeklyPackInput {
  write: Omit<WriteModeTwinCollectiveAnalysisInput, "operator_ack">;
  fullscreen_pack: Omit<
    FullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackInput,
    "operator_ack"
  >;
...
export interface WriteModeTwinFullscreenDraftCollectiveMoWeeklyPackCompose {
  week_id: string;
  session_id: string;
  ...
  fullscreen_pack: FullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackCompose;
  ...
  notes: string[];
  authority: "write_mode_twin_fullscreen_draft_collective_mo_weekly_pack_compose_advisory";
}
 ...
 */
export function composeWriteModeTwinFullscreenDraftCollectiveMoWeeklyPack(
  input: WriteModeTwinFullscreenDraftCollectiveMoWeeklyPackInput,
): WriteModeTwinFullscreenDraftCollectiveMoWeeklyPackCompose {
...
export function formatWriteModeTwinFullscreenDraftCollectiveMoWeeklyPackSummary(
  c: WriteModeTwinFullscreenDraftCollectiveMoWeeklyPackCompose,
): string {
  return (
