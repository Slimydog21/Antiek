 ...
 * (short residual: MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWritePack — FS 255; never live-executes).
...
import {
  composeSettingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWritePack,
  type SettingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWritePackCompose,
  type SettingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWritePackInput,
} from "./settingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWritePackCompose";

export interface MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWritePackInput {
  mo: Omit<MidnightOilPriceCeilingApprovalInput, "operator_ack">;
  settings_pack: Omit<
    SettingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWritePackCompose {
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "midnight_oil_settings_decision_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeMidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWritePack(
  input: MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWritePackInput,
  ...
  const settings_pack = composeSettingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWritePack({
    ...input.settings_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatMidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWritePackSummary(
