...
import {
  ...
  formatCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWritePackSummary,
} from "./collectiveMultiselectFloatingDrWorkstationMoWeeklySrcWritePackCompose";

describe("composeCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("collective multiselect + floating DR workstation MO weekly src write pack ready", () => {
    const c = composeCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWritePack({
    ...
    expect(
      formatCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWritePackSummary(c),
