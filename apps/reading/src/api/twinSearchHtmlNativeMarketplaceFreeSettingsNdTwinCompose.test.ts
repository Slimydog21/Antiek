...
describe("composeTwinSearchHtmlNativeMarketplaceFreeSettingsNdTwin", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("twin search + HTML-native marketplace free settings ND twin ready", () => {
    const c = composeTwinSearchHtmlNativeMarketplaceFreeSettingsNdTwin({
      search_query: "scaling noise",
    ...
    expect(
      formatTwinSearchHtmlNativeMarketplaceFreeSettingsNdTwinSummary(c),
  ...
  it("empty hits block pack_ready under require_both", () => {
    const c = composeTwinSearchHtmlNativeMarketplaceFreeSettingsNdTwin({
      search_query: "scaling noise",
      twin_records: [],
      html_pack: outer_html_pack,
  ...
  it("session mismatch in html pack blocks readiness", () => {
    const c = composeTwinSearchHtmlNativeMarketplaceFreeSettingsNdTwin({
      search_query: "scaling noise",
      twin_records: outer_twin_records,
      html_pack: {
