...
describe("composeSourceAttachWriteTwinFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("source attach + write twin fullscreen draft pack ready", () => {
    const c = composeSourceAttachWriteTwinFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatSourceAttachWriteTwinFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
