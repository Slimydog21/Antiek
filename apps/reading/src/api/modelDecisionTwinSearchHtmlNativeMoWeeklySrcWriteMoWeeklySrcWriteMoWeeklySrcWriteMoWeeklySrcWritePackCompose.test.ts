...
describe("composeModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("model decision + twin search HTML-native pack ready", () => {
    const c = composeModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
    ).toMatch(/REJECT|pack_ready=true|live_meter_read=false/);
  });
  ...
  it("would_exceed projection blocks pack under require_both", () => {
    const c = composeModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
      decision: {
        ...residual_md4_outer_decision,
        projected_cost_usd_high: 9999,
        daily_cap_usd: 10,
        spent_usd: 9,
      },
      twin_search_pack: residual_md4_outer_twin_search_pack,
