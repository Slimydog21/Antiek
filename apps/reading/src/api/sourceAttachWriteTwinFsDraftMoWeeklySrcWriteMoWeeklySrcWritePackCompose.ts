...
import {
  ...
  type WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackInput,
} from "./writeModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

export interface SourceAttachWriteTwinFsDraftMoWeeklySrcWriteMoWeeklySrcWritePackInput {
  sources: Omit<HtmlNativeSourceAttachInput, "operator_ack">;
  write_pack: Omit<
    WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface SourceAttachWriteTwinFsDraftMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  session_id: string;
  ...
  write_pack: WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackCompose;
  ...
  notes: string[];
  authority: "source_attach_write_twin_fs_draft_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeSourceAttachWriteTwinFsDraftMoWeeklySrcWriteMoWeeklySrcWritePack(
  input: SourceAttachWriteTwinFsDraftMoWeeklySrcWriteMoWeeklySrcWritePackInput,
  ...
  const write_pack = composeWriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...input.write_pack,
    operator_ack: input.operator_ack,
  });
  ...
  return {
    ...
    notes,
    authority:
      "source_attach_write_twin_fs_draft_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory",
  };
}

export function formatSourceAttachWriteTwinFsDraftMoWeeklySrcWriteMoWeeklySrcWritePackSummary(
  c: SourceAttachWriteTwinFsDraftMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
): string {
  return (
