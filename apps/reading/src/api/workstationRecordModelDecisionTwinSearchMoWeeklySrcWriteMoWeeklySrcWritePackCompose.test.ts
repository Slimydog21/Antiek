...
describe("composeWorkstationRecordModelDecisionTwinSearchMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("workstation records + model decision twin search MO weekly src write pack ready", () => {
    const c = composeWorkstationRecordModelDecisionTwinSearchMoWeeklySrcWriteMoWeeklySrcWritePack({
      session_id: "sess-1",
    ...
    expect(
      formatWorkstationRecordModelDecisionTwinSearchMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
    ).toMatch(/record_persisted=false/);
  });
  ...
  it("empty items block records and pack under require_both", () => {
    const c = composeWorkstationRecordModelDecisionTwinSearchMoWeeklySrcWriteMoWeeklySrcWritePack({
      session_id: "sess-1",
      items: [],
      decision_pack: residual_ws2_outer_decision_pack,
