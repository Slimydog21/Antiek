...
describe("composeAntiekBenchWeeklyHtmlNativeRecursiveTwin", () => {
  const twin_pack = {
    twin: {
      parent_asset_id: "book-1",
      source_excerpt:
  ...
  it("weekly learn + HTML-native recursive twin pack ready", () => {
    const c = composeAntiekBenchWeeklyHtmlNativeRecursiveTwin({
      weekly_learn,
    ...
    expect(
      formatAntiekBenchWeeklyHtmlNativeRecursiveTwinSummary(c),
  ...
  it("insufficient weekly events blocks learn_ready and pack_ready", () => {
    const c = composeAntiekBenchWeeklyHtmlNativeRecursiveTwin({
      weekly_learn: {
        week_id: "2026-W28",
  ...
  it("session mismatch in html_pack blocks", () => {
    const c = composeAntiekBenchWeeklyHtmlNativeRecursiveTwin({
      weekly_learn,
      html_pack: {
