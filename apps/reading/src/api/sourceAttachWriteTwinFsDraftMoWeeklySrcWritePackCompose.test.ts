...
import {
  ...
  formatSourceAttachWriteTwinFsDraftMoWeeklySrcWritePackSummary,
} from "./sourceAttachWriteTwinFsDraftMoWeeklySrcWritePackCompose";

describe("composeSourceAttachWriteTwinFsDraftMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("source attach + write twin fullscreen draft MO weekly src write pack ready", () => {
    const c = composeSourceAttachWriteTwinFsDraftMoWeeklySrcWritePack({
    ...
    expect(
      formatSourceAttachWriteTwinFsDraftMoWeeklySrcWritePackSummary(c),
