...
import {
  composeDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpack,
  formatDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackSummary,
} from "./draftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackCompose";

describe("composeDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpack", () => {
const WEEKLY_ND = {
  weekly_learn: {
    week_id: "2026-W28",
...
const COMPETITION_CITATIONS = [
  ...
  const residual_mk8_outer_mo_pack = {
  ...
  const residual_hn7_outer_market_pack = {
    market: residual_mk8_outer_market,
    mo_pack: residual_mk8_outer_mo_pack,
  };
  ...
  const residual_ws7_outer_items = [
    {
      record_id: "r1",
      kind: "insight" as const,
      text: "scaling holds under noise in compute-optimal regimes",
  ...
  const residual_fd7_outer_record_pack = {
    session_id: "sess-1",
    items: residual_ws7_outer_items,
    decision_pack: residual_ws7_outer_decision_pack,
  };


  const residual_cm7_outer_multiselect = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    members: [
      {
  ...
  const residual_cm7_outer_floating_pack = {
    highlight_launch: residual_fd7_outer_highlight_launch,
    record_pack: residual_fd7_outer_record_pack,
  };

const residual_db7_outer_draft_gate = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    parent_excerpt: "<p>Parent body on scaling laws</p>",
    sources: [
  ...
  const residual_db7_outer_collective_pack = {
    multiselect: residual_cm7_outer_multiselect,
    floating_pack: residual_cm7_outer_floating_pack,
  };


  const residual_fs7_outer_fullscreen = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    highlight: "scaling laws under noise",
    gated: false,
  ...
  const residual_fs7_outer_draft_pack = {
    draft_gate: residual_db7_outer_draft_gate,
    collective_pack: residual_db7_outer_collective_pack,
  };

const residual_wt7_outer_write = {
    session_id: "sess-1",
    draft_id: "draft-1",
    parent_asset_id: "book-1",
    twin_slices: [
  ...
  const residual_wt7_outer_fullscreen_pack = {
    fullscreen: residual_fs7_outer_fullscreen,
    draft_pack: residual_fs7_outer_draft_pack,
  };

const residual_sa7_outer_sources = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    requested_families: ["arxiv" as const, "substack" as const],
    sources: [
  ...
  const residual_sa7_outer_write_pack = {
    write: residual_wt7_outer_write,
    fullscreen_pack: residual_wt7_outer_fullscreen_pack,
  };

const residual_ab7_outer_weekly_learn = {
    week_id: "2026-W28",
    min_events_per_task: 2,
    events: [
      {
  ...
  const residual_ab7_outer_source_pack = {
    sources: residual_sa7_outer_sources,
    write_pack: residual_sa7_outer_write_pack,
  };

const residual_rt7_outer_twin = {
    parent_asset_id: "book-1",
    source_excerpt:
      "<p>Scaling laws hold under noise in compute-optimal regimes.</p>",
    focus_questions: ["Where does it break?", "What residual gaps?"],
...
const residual_rt7_outer_presentation = {
    view_mode: "side_panel" as const,
    open_requested: true,
    merge_to_parent_preview: false,
    presented_insights: [
  ...
  const residual_rt7_outer_weekly_pack = {
    weekly_learn: residual_ab7_outer_weekly_learn,
    source_pack: residual_ab7_outer_source_pack,
  };

const residual_nds7_outer_nd_shadow = {
    selected_model_id: "gpt-5.5",
    nd_recommended_model_id: "claude-opus",
    kill_switch_on: true,
    confidence: 0.72,
  ...
  const residual_nds7_outer_twin_presentation = {
    twin: residual_rt7_outer_twin,
    presentation: residual_rt7_outer_presentation,
    weekly_pack: residual_rt7_outer_weekly_pack,
  };

const residual_cd7_outer_competition = {
    session_id: "sess-1",
    competitor_decisions: [
      {
        competitor: "Perplexity",
  ...
  const residual_cd7_outer_nd_pack = {
    nd_shadow: residual_nds7_outer_nd_shadow,
    twin_presentation: residual_nds7_outer_twin_presentation,
  };

const residual_sd7_outer_settings = {
    models: [
      { model_id: "gpt-5.5", provider: "openai" },
      { model_id: "grok-4.5", provider: "xai" },
    ],
  ...
  const residual_sd7_outer_competition_pack = {
    competition: residual_cd7_outer_competition,
    nd_pack: residual_cd7_outer_nd_pack,
  };

  const residual_mo7_outer_mo = {
    operator_id: "op-1",
    work_minutes: 120,
    goals: [
      { goal_id: "g1", title: "Map scaling literature" },
  ...
  const residual_mo7_outer_settings_pack = {
    settings: residual_sd7_outer_settings,
    competition_pack: residual_sd7_outer_competition_pack,
  };

  const residual_mkt7_tip_market = {
    title: "Scaling Laws Book",
    account_id: "acct-1",
    free_copy_available: true as boolean | null,
    free_html_projection_sha: "sha-free-1",
  ...
  const residual_mkt7_tip_mo_pack = {
    mo: residual_mo7_outer_mo,
    settings_pack: residual_mo7_outer_settings_pack,
  };
...
// --- residual ×10 tip graft + residual_db10 ---
// --- residual ×10 tip graft + residual_cm10 ---
// --- residual ×10 tip graft + residual_fd10 ---
// --- residual ×10 tip graft + residual_ws10 ---
...
const residual_db10_tip_draft_gate = {
  ...
  it("draft-before-merge + collective floating DR pack ready", () => {
    const c = composeDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpack({
    ...
    expect(c.authority).toBe("draft_before_merge_collective_floating_dr_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mpack_compose_advisory");
    expect(formatDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackSummary(c)).toMatch(/REJECT|pack_ready=true|merge_executed=false/);
  });
  ...
  it("draft_only stage never merge_executed", () => {
    const c = composeDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpack({
      draft_gate: residual_db10_tip_draft_gate,
      collective_pack: residual_db11_tip_collective_pack,
      operator_ack: true,
    });
    expect(c.draft_gate.stage).toBe("draft_only");
    expect(c.merge_executed).toBe(false);
    expect(c.draft_written).toBe(false);
    expect(c.production_router_verdict).toBe("REJECT");
  });
