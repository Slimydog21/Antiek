...
describe("composeTwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("twin search + HTML-native marketplace free MO pack ready", () => {
    const c = composeTwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatTwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
