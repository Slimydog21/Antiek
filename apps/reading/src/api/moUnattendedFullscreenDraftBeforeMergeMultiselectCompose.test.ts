...
describe("composeMoUnattendedFullscreenDraftBeforeMergeMultiselect", () => {
  ...
  it("MO unattended + fullscreen draft multi-select pack ready", () => {
    const c = composeMoUnattendedFullscreenDraftBeforeMergeMultiselect({
      mo: mo_input,
    ...
    expect(
      formatMoUnattendedFullscreenDraftBeforeMergeMultiselectSummary(c),
  ...
  it("unattended_ack false blocks mo readiness", () => {
    const c = composeMoUnattendedFullscreenDraftBeforeMergeMultiselect({
      mo: { ...mo_input, unattended_ack: false },
      fullscreen_pack: outer_fullscreen_pack,
      operator_ack: true,
    });
  ...
  it("spend_consent false blocks mo readiness", () => {
    const c = composeMoUnattendedFullscreenDraftBeforeMergeMultiselect({
      mo: { ...mo_input, spend_consent: false },
      fullscreen_pack: outer_fullscreen_pack,
      operator_ack: true,
    });
    expect(c.mo.unattended_package_ready).toBe(false);
