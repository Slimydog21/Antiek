...
describe("composeAntiekBenchRecommendMoUnattendedFullscreenDraft", () => {
  ...
  it("Antiek-bench recommend + MO unattended fullscreen draft pack ready", () => {
    const c = composeAntiekBenchRecommendMoUnattendedFullscreenDraft({
    ...
    expect(
      formatAntiekBenchRecommendMoUnattendedFullscreenDraftSummary(c),
  ...
  it("unattended_ack false blocks mo and overall", () => {
    const c = composeAntiekBenchRecommendMoUnattendedFullscreenDraft({
      bench: outer_bench_input,
      mo_pack: {
        ...outer_mo_pack,
  ...
  it("insufficient bench events still keeps honesty gates", () => {
    const c = composeAntiekBenchRecommendMoUnattendedFullscreenDraft({
      bench: {
        ...outer_bench_input,
        events: [
