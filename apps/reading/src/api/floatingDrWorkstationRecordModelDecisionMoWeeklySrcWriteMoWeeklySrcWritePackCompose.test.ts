...
describe("composeFloatingDrWorkstationRecordModelDecisionMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("floating DR + workstation record model decision MO weekly src write pack ready", () => {
    const c = composeFloatingDrWorkstationRecordModelDecisionMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatFloatingDrWorkstationRecordModelDecisionMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
  ...
  it("parent mismatch blocks pack_ready", () => {
    const c = composeFloatingDrWorkstationRecordModelDecisionMoWeeklySrcWriteMoWeeklySrcWritePack({
      highlight_launch: {
        ...residual_fd2_outer_highlight_launch,
