...
import {
  ...
  type ModelDecisionTwinSearchHtmlNativeMarketplaceFreeMoInput,
} from "./modelDecisionTwinSearchHtmlNativeMarketplaceFreeMoCompose";

export interface WorkstationRecordModelDecisionTwinSearchInput {
  session_id: string;
  items: WorkstationRecordItem[];
  max_context_lines?: number | null;
  decision_pack: Omit<
    ModelDecisionTwinSearchHtmlNativeMarketplaceFreeMoInput,
    "operator_ack"
  >;
...
export interface WorkstationRecordModelDecisionTwinSearchCompose {
  week_id: string;
  session_id: string;
  ...
  decision_pack: ModelDecisionTwinSearchHtmlNativeMarketplaceFreeMoCompose;
  ...
  notes: string[];
  authority: "workstation_record_model_decision_twin_search_compose_advisory";
}
 ...
 */
export function composeWorkstationRecordModelDecisionTwinSearch(
  input: WorkstationRecordModelDecisionTwinSearchInput,
): WorkstationRecordModelDecisionTwinSearchCompose {
  ...
  const decision_pack = composeModelDecisionTwinSearchHtmlNativeMarketplaceFreeMo({
    ...input.decision_pack,
  ...
  return {
    ...
    notes,
    authority:
      "workstation_record_model_decision_twin_search_compose_advisory",
  };
}

export function formatWorkstationRecordModelDecisionTwinSearchSummary(
  c: WorkstationRecordModelDecisionTwinSearchCompose,
): string {
  return (
