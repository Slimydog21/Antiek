...
import {
  composeSettingsDecisionCompetitionDrNdShadowTwinWeekly,
  type SettingsDecisionCompetitionDrNdShadowTwinWeeklyCompose,
  type SettingsDecisionCompetitionDrNdShadowTwinWeeklyInput,
} from "./settingsDecisionCompetitionDrNdShadowTwinWeeklyCompose";

export interface MidnightOilSettingsDecisionCompetitionDrInput {
  mo: Omit<MidnightOilPriceCeilingApprovalInput, "operator_ack">;
  settings_pack: Omit<
    SettingsDecisionCompetitionDrNdShadowTwinWeeklyInput,
    "operator_ack"
  >;
...
export interface MidnightOilSettingsDecisionCompetitionDrCompose {
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "midnight_oil_settings_decision_competition_dr_compose_advisory";
}
 ...
 */
export function composeMidnightOilSettingsDecisionCompetitionDr(
  input: MidnightOilSettingsDecisionCompetitionDrInput,
  ...
  const settings_pack = composeSettingsDecisionCompetitionDrNdShadowTwinWeekly({
    ...input.settings_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatMidnightOilSettingsDecisionCompetitionDrSummary(
