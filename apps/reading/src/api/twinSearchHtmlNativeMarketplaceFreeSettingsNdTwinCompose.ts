 ...
 * marketplace + BYOK settings + NotDiamond REJECT + twin presentation honesty —
...
import {
  ...
  type HtmlNativeMarketplaceFreeSettingsNdTwinInput,
} from "./htmlNativeMarketplaceFreeSettingsNdTwinCompose";

export interface TwinSearchHtmlNativeMarketplaceFreeSettingsNdTwinInput {
  search_query: string;
  twin_records: TwinSearchRecord[];
  search_limit?: number;
  html_pack: Omit<
    HtmlNativeMarketplaceFreeSettingsNdTwinInput,
    "operator_ack"
  >;
...
export interface TwinSearchHtmlNativeMarketplaceFreeSettingsNdTwinCompose {
  session_id: string;
  ...
  html_pack: HtmlNativeMarketplaceFreeSettingsNdTwinCompose;
  hit_count: number;
  pack_ready: boolean;
  ...
  notes: string[];
  authority: "twin_search_html_native_marketplace_free_settings_nd_twin_compose_advisory";
}
...
/**
 * Twin substrate search stacked on HTML-native marketplace free settings ND twin pack.
 * Never remote-indexes; never PDF-primary; never writes twins; ND REJECT.
 */
export function composeTwinSearchHtmlNativeMarketplaceFreeSettingsNdTwin(
  input: TwinSearchHtmlNativeMarketplaceFreeSettingsNdTwinInput,
  ...
  const html_pack = composeHtmlNativeMarketplaceFreeSettingsNdTwin({
    ...input.html_pack,
...
export function formatTwinSearchHtmlNativeMarketplaceFreeSettingsNdTwinSummary(
  c: TwinSearchHtmlNativeMarketplaceFreeSettingsNdTwinCompose,
): string {
  return (
