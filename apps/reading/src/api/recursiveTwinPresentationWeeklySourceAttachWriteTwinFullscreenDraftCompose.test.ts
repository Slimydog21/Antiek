...
describe("composeRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraft", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("twin presentation + weekly source attach write twin fullscreen draft pack ready", () => {
    const c = composeRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraft({
    ...
    expect(
      formatRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftSummary(c),
