...
import {
  composeAntiekBenchWeeklySourceAttachWriteTwinFullscreenDraft,
  type AntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftCompose,
  type AntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftInput,
} from "./antiekBenchWeeklySourceAttachWriteTwinFullscreenDraftCompose";

export interface RecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftInput {
  twin: Omit<RecursiveTwinNoteTakerInput, "operator_ack">;
  presentation: TwinPresentationSurfaceInput;
  weekly_pack: Omit<
    AntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftInput,
    "operator_ack"
  >;
...
export interface RecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose {
  week_id: string;
  session_id: string;
  ...
  weekly_pack: AntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftCompose;
  ...
  notes: string[];
  authority: "recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_compose_advisory";
}
 ...
 */
export function composeRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraft(
  input: RecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftInput,
): RecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose {
  ...
  const weekly_pack = composeAntiekBenchWeeklySourceAttachWriteTwinFullscreenDraft({
    ...input.weekly_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftSummary(
  c: RecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose,
): string {
  return (
