...
import {
  ...
  formatWorkstationRecordModelDecisionTwinSearchSummary,
} from "./workstationRecordModelDecisionTwinSearchCompose";

describe("composeWorkstationRecordModelDecisionTwinSearch", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("workstation records + model decision twin search pack ready", () => {
    const c = composeWorkstationRecordModelDecisionTwinSearch({
      session_id: "sess-1",
    ...
    expect(
      formatWorkstationRecordModelDecisionTwinSearchSummary(c),
  ...
  it("empty records block pack under require_both", () => {
    const c = composeWorkstationRecordModelDecisionTwinSearch({
      session_id: "sess-1",
      items: [],
      decision_pack: residual_outer_decision_pack,
