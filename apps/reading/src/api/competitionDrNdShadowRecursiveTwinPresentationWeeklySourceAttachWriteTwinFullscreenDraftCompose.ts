...
import {
  composeNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraft,
  type NdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose,
  type NdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftInput,
} from "./ndShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose";

export interface CompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftInput {
  competition: Omit<CompetitionDrQualitySourcePackInput, "operator_ack">;
  nd_pack: Omit<
    NdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftInput,
    "operator_ack"
  >;
...
export interface CompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose {
  session_id: string;
  week_id: string;
  ...
  notes: string[];
  authority: "competition_dr_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_compose_advisory";
}
 ...
 */
export function composeCompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraft(
  input: CompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftInput,
  ...
  const nd_pack = composeNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraft({
    ...input.nd_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatCompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftSummary(
