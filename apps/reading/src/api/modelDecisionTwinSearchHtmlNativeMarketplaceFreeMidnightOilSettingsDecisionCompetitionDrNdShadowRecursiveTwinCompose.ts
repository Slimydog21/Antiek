 ...
 * intelligent search + HTML-native + marketplace free + Midnight Oil pack (pure).
 *
 ...
 * while twin search + HTML-native + free-before-buy + MO honesty remain pure —
...
import {
  ...
  type TwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinInput,
} from "./twinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinCompose";

export interface ModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinInput {
  decision: Omit<SettingsDecisionTreeUsageBarInput, "operator_ack">;
  twin_search_pack: Omit<
    TwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinInput,
    "operator_ack"
  >;
...
export interface ModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinCompose {
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "model_decision_twin_search_html_native_marketplace_free_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin_compose_advisory";
}
...
/**
 * Model decision/usage/projection stacked on twin search HTML-native marketplace free MO.
 * Never live-routes; never purchases; never PDF-primary; ND REJECT.
 */
export function composeModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin(
  input: ModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinInput,
  ...
  const twin_search_pack = composeTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
  ...
  if (pack_ready) {
    notes.push(
      "pack_ready=true — model decision + twin search HTML-native marketplace free MO ready; still pure",
    );
  } else {
    notes.push(
...
export function formatModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinSummary(
