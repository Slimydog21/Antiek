...
describe("composeCompetitionDrSettingsAddModelBenchSourceMo", () => {
  const twin_pack = {
    twin: {
      parent_asset_id: "book-1",
      source_excerpt:
  ...
  it("competition DR + settings add-model bench source MO pack ready", () => {
    const c = composeCompetitionDrSettingsAddModelBenchSourceMo({
    ...
    expect(
      formatCompetitionDrSettingsAddModelBenchSourceMoSummary(c),
  ...
  it("session mismatch blocks overall", () => {
    const c = composeCompetitionDrSettingsAddModelBenchSourceMo({
      competition: { ...competition_input, session_id: "sess-other" },
      settings_pack: {
        settings: settings_input,
        bench_pack: {
          bench: bench_input,
  ...
  it("would_exceed quality gate blocks competition and overall", () => {
    const c = composeCompetitionDrSettingsAddModelBenchSourceMo({
      competition: {
        ...competition_input,
        would_exceed: true,
