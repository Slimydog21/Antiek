...
describe("composeWriteModeTwinCollectiveFullscreenDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("write twin collective + fullscreen draft-before-merge pack ready", () => {
    const c = composeWriteModeTwinCollectiveFullscreenDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
    ...
    expect(c.authority).toBe("write_mode_twin_collective_fullscreen_draft_before_merge_collective_multiselect_floating_dr_workstation_record_model_decision_twin_search_html_native_marketplace_free_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin_compose_advisory");
    expect(formatWriteModeTwinCollectiveFullscreenDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinSummary(c)).toMatch(/analysis_written=false/);
  });
  ...
  it("parent mismatch blocks pack_ready", () => {
    const c = composeWriteModeTwinCollectiveFullscreenDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
      write: {
        ...
        twin_slices: [
          {
            ...residual_write_outer_write.twin_slices[0],
            parent_asset_id: "book-other",
          },
          {
            ...residual_write_outer_write.twin_slices[1],
            parent_asset_id: "book-other-slice-2",
          },
        ],
        chase_slots: residual_write_outer_write.chase_slots.map((s) => ({
          ...s,
          parent_asset_id: "book-other",
        })),
      },
