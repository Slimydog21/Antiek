...
import {
  ...
  formatWriteModeTwinCollectiveFullscreenDraftBeforeMergeSummary,
} from "./writeModeTwinCollectiveFullscreenDraftBeforeMergeCompose";

describe("composeWriteModeTwinCollectiveFullscreenDraftBeforeMerge", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("write twin collective + fullscreen draft-before-merge pack ready", () => {
    const c = composeWriteModeTwinCollectiveFullscreenDraftBeforeMerge({
    ...
    expect(
      formatWriteModeTwinCollectiveFullscreenDraftBeforeMergeSummary(c),
  ...
  it("parent mismatch blocks pack_ready", () => {
    const c = composeWriteModeTwinCollectiveFullscreenDraftBeforeMerge({
      write: {
        ...
        twin_slices: [
          {
            ...residual_outer_write.twin_slices[0],
            parent_asset_id: "book-other",
          },
          {
            ...residual_outer_write.twin_slices[1],
            parent_asset_id: "book-other-slice-2",
          },
        ],
        chase_slots: residual_outer_write.chase_slots.map((s) => ({
          ...s,
          parent_asset_id: "book-other",
        })),
      },
