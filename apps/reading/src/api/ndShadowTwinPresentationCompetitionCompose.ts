 ...
 * + competition DR free-market pack (pure).
 *
...
import {
  ...
  type RecursiveTwinPresentationCompetitionDrCompose,
  type RecursiveTwinPresentationCompetitionDrInput,
} from "./recursiveTwinPresentationCompetitionDrCompose";

export interface NdShadowTwinPresentationCompetitionInput {
  nd_shadow: NotDiamondShadowAdvisoryInput;
  twin_presentation: Omit<
    RecursiveTwinPresentationCompetitionDrInput,
    "operator_ack"
  >;
...
export interface NdShadowTwinPresentationCompetitionCompose {
  ...
  twin_presentation: RecursiveTwinPresentationCompetitionDrCompose;
  pack_ready: boolean;
  ...
  notes: string[];
  authority: "nd_shadow_twin_presentation_competition_compose_advisory";
}
...
/**
 * ND shadow REJECT re-affirmation on twin presentation + competition pack.
 * Never live-routes; never writes twin; never purchases.
 */
export function composeNdShadowTwinPresentationCompetition(
  input: NdShadowTwinPresentationCompetitionInput,
  ...
  const twin_presentation = composeRecursiveTwinPresentationCompetitionDr({
  ...
  if (pack_ready) {
    notes.push(
      "pack_ready=true — ND shadow REJECT re-affirmed on twin presentation pack; still pure",
    );
  } else {
    notes.push(
...
export function formatNdShadowTwinPresentationCompetitionSummary(
  c: NdShadowTwinPresentationCompetitionCompose,
): string {
  return (
