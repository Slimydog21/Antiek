...
import {
  ...
  formatRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePackSummary,
} from "./recursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePackCompose";

describe("composeRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("twin presentation + weekly source attach write twin MO weekly src write pack ready", () => {
    const c = composeRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
    ...
    const c = composeRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePack({
      ...
      weekly_pack: {
        ...
        source_pack: {
          ...
          sources: {
            ...residual_ab_outer_source_pack.sources,
