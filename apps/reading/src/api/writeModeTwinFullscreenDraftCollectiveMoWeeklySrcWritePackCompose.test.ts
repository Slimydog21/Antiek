...
import {
  ...
  formatWriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePackSummary,
} from "./writeModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePackCompose";

describe("composeWriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("write-mode twin + fullscreen draft collective MO weekly src write pack ready", () => {
    const c = composeWriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePack({
    ...
    expect(
      formatWriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePackSummary(c),
  ...
  it("parent mismatch on write blocks pack under require_both", () => {
    ...
    // write pack itself may fail parent alignment or outer pack_ready
    expect(c.pack_ready).toBe(false);
    expect(c.draft_written).toBe(false);
    expect(c.analysis_written).toBe(false);
    expect(c.merge_executed).toBe(false);
