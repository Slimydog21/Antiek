...
import {
  ...
  type MidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinInput,
} from "./midnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinCompose";

export interface MarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinInput {
  market: MarketplaceFreeBeforeBuyHtmlPortInput;
  mo_pack: Omit<
    MidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinInput,
    "operator_ack"
  >;
...
export interface MarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinCompose {
  title: string;
  account_id: string;
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "marketplace_free_midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin_compose_advisory";
}
 ...
 */
export function composeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin(
  input: MarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinInput,
  ...
  const mo_pack = composeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
    ...input.mo_pack,
...
export function formatMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinSummary(
