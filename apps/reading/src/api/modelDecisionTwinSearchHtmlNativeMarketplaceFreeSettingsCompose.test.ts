...
describe("composeModelDecisionTwinSearchHtmlNativeMarketplaceFreeSettings", () => {
  ...
  it("model decision + twin search HTML-native marketplace free settings pack ready", () => {
    const c = composeModelDecisionTwinSearchHtmlNativeMarketplaceFreeSettings({
    ...
    expect(c.twin_search_pack.hit_count).toBeGreaterThanOrEqual(1);
    ...
    expect(
      formatModelDecisionTwinSearchHtmlNativeMarketplaceFreeSettingsSummary(c),
  ...
  it("would_exceed blocks pack_ready under require_both", () => {
    const c = composeModelDecisionTwinSearchHtmlNativeMarketplaceFreeSettings({
      decision: {
  ...
  it("zero search hits blocks overall", () => {
    const c = composeModelDecisionTwinSearchHtmlNativeMarketplaceFreeSettings({
      decision: decision_outer_input,
      twin_search_pack: {
        ...twin_search_pack,
