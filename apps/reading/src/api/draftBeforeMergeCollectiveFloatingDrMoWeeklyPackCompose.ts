 ...
 * floating DR workstation MO weekly pack (pure).
 *
...
import {
  composeCollectiveMultiselectFloatingDrWorkstationMoWeeklyPack,
  type CollectiveMultiselectFloatingDrWorkstationMoWeeklyPackCompose,
  type CollectiveMultiselectFloatingDrWorkstationMoWeeklyPackInput,
} from "./collectiveMultiselectFloatingDrWorkstationMoWeeklyPackCompose";

export interface DraftBeforeMergeCollectiveFloatingDrMoWeeklyPackInput {
  draft_gate: Omit<FloatingDraftBeforeFullMergeGateInput, "operator_ack">;
  collective_pack: Omit<
    CollectiveMultiselectFloatingDrWorkstationMoWeeklyPackInput,
    "operator_ack"
  >;
...
export interface DraftBeforeMergeCollectiveFloatingDrMoWeeklyPackCompose {
  week_id: string;
  session_id: string;
  ...
  collective_pack: CollectiveMultiselectFloatingDrWorkstationMoWeeklyPackCompose;
  ...
  notes: string[];
  authority: "draft_before_merge_collective_floating_dr_mo_weekly_pack_compose_advisory";
}
 ...
 */
export function composeDraftBeforeMergeCollectiveFloatingDrMoWeeklyPack(
  input: DraftBeforeMergeCollectiveFloatingDrMoWeeklyPackInput,
): DraftBeforeMergeCollectiveFloatingDrMoWeeklyPackCompose {
  ...
  const collective_pack = composeCollectiveMultiselectFloatingDrWorkstationMoWeeklyPack(
    {
  ...
  return {
    ...
    notes,
    authority:
      "draft_before_merge_collective_floating_dr_mo_weekly_pack_compose_advisory",
  };
}

export function formatDraftBeforeMergeCollectiveFloatingDrMoWeeklyPackSummary(
  c: DraftBeforeMergeCollectiveFloatingDrMoWeeklyPackCompose,
): string {
  return (
