...
describe("composeTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("twin search + HTML-native marketplace free MO pack ready", () => {
    const c = composeTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
      search_query: "scaling noise",
    ...
    expect(c.html_pack.pack_ready).toBe(true);
    ...
    expect(
      formatTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinSummary(c),
    ).toMatch(/remote_index_queried=false|REJECT|twin_written=false/);
  });
  ...
  it("empty twin_records blocks pack_ready under require_both", () => {
    const c = composeTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
      search_query: "scaling noise",
      twin_records: [],
      html_pack: residual_twin_search_html_pack,
  ...
  it("nonsense query with empty hits blocks pack_ready under require_both", () => {
    const c = composeTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
