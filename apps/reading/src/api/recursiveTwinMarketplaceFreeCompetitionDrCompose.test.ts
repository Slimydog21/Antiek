...
describe("composeRecursiveTwinMarketplaceFreeCompetitionDr", () => {
  const twin_pack = {
    twin: {
      parent_asset_id: "book-1",
      source_excerpt:
  ...
  it("recursive twin + marketplace free competition DR pack ready", () => {
    const c = composeRecursiveTwinMarketplaceFreeCompetitionDr({
    ...
    expect(c.twin.twin_written).toBe(false);
    ...
    expect(
      formatRecursiveTwinMarketplaceFreeCompetitionDrSummary(c),
  ...
  it("parent mismatch blocks overall", () => {
    const c = composeRecursiveTwinMarketplaceFreeCompetitionDr({
      twin: { ...twin_note_input, parent_asset_id: "book-other" },
      market_pack: {
        market: market_input,
        competition_pack: {
          competition: competition_input,
