/**
 * Marketplace free-before-buy residual over settings add-model + ND shadow
 * competition DR + MO unattended rewrite pack (pure).
 *
 * Operator vision: free-first digital book HTML port readiness stacked on BYOK
 * settings add-model, NotDiamond REJECT, competition DR quality, and Midnight
 * Oil unattended honesty. Prefer free HTML; never auto-purchase; never host.
 *
...
import {
  ...
  type SettingsAddModelNdShadowCompetitionDrMoInput,
} from "./settingsAddModelNdShadowCompetitionDrMoCompose";

export interface MarketplaceFreeSettingsAddModelNdShadowInput {
  market: MarketplaceFreeBeforeBuyHtmlPortInput;
  settings_pack: Omit<
    SettingsAddModelNdShadowCompetitionDrMoInput,
    "operator_ack"
  >;
...
export interface MarketplaceFreeSettingsAddModelNdShadowCompose {
  title: string;
  account_id: string;
  session_id: string;
  week_id: string;
  ...
  settings_pack: SettingsAddModelNdShadowCompetitionDrMoCompose;
  pack_ready: boolean;
  ...
  notes: string[];
  authority: "marketplace_free_settings_add_model_nd_shadow_compose_advisory";
}
 ...
 */
export function composeMarketplaceFreeSettingsAddModelNdShadow(
  input: MarketplaceFreeSettingsAddModelNdShadowInput,
  ...
  const settings_pack = composeSettingsAddModelNdShadowCompetitionDrMo({
    ...input.settings_pack,
...
export function formatMarketplaceFreeSettingsAddModelNdShadowSummary(
  c: MarketplaceFreeSettingsAddModelNdShadowCompose,
): string {
  return (
