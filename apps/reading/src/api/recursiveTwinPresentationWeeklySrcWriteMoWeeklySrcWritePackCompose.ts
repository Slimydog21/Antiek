...
import {
  composeAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWritePack,
  type AntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWritePackCompose,
  type AntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWritePackInput,
} from "./antiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWritePackCompose";

export interface RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePackInput {
  twin: Omit<RecursiveTwinNoteTakerInput, "operator_ack">;
  presentation: TwinPresentationSurfaceInput;
  weekly_pack: Omit<
    AntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePackCompose {
  week_id: string;
  session_id: string;
  ...
  weekly_pack: AntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWritePackCompose;
  ...
  notes: string[];
  authority: "recursive_twin_presentation_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePack(
  input: RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePackInput,
): RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePackCompose {
  ...
  const weekly_pack = composeAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWritePack({
    ...input.weekly_pack,
    operator_ack: input.operator_ack,
  });
  ...
  return {
    ...
    notes,
    authority:
      "recursive_twin_presentation_weekly_src_write_mo_weekly_src_write_pack_compose_advisory",
  };
}

export function formatRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePackSummary(
  c: RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePackCompose,
): string {
  return (
