...
import {
  composeTwinSearchHtmlNativeMarketplaceFreeMo,
  type TwinSearchHtmlNativeMarketplaceFreeMoCompose,
  type TwinSearchHtmlNativeMarketplaceFreeMoInput,
} from "./twinSearchHtmlNativeMarketplaceFreeMoCompose";

export interface ModelDecisionTwinSearchHtmlNativeMarketplaceFreeMoInput {
  decision: Omit<SettingsDecisionTreeUsageBarInput, "operator_ack">;
  twin_search_pack: Omit<
    TwinSearchHtmlNativeMarketplaceFreeMoInput,
    "operator_ack"
  >;
...
export interface ModelDecisionTwinSearchHtmlNativeMarketplaceFreeMoCompose {
  week_id: string;
  session_id: string;
  ...
  twin_search_pack: TwinSearchHtmlNativeMarketplaceFreeMoCompose;
  pack_ready: boolean;
  ...
  notes: string[];
  authority: "model_decision_twin_search_html_native_marketplace_free_mo_compose_advisory";
}
 ...
 */
export function composeModelDecisionTwinSearchHtmlNativeMarketplaceFreeMo(
  input: ModelDecisionTwinSearchHtmlNativeMarketplaceFreeMoInput,
  ...
  const twin_search_pack = composeTwinSearchHtmlNativeMarketplaceFreeMo({
  ...
  return {
    ...
    notes,
    authority:
      "model_decision_twin_search_html_native_marketplace_free_mo_compose_advisory",
  };
}

export function formatModelDecisionTwinSearchHtmlNativeMarketplaceFreeMoSummary(
  c: ModelDecisionTwinSearchHtmlNativeMarketplaceFreeMoCompose,
): string {
  const exceed =
