...
describe("composeCompetitionDrSourceAttachAntiekBenchRecommend", () => {
  ...
  it("competition DR + source-attach Antiek-bench recommend pack ready", () => {
    const c = composeCompetitionDrSourceAttachAntiekBenchRecommend({
    ...
    expect(
      formatCompetitionDrSourceAttachAntiekBenchRecommendSummary(c),
  ...
  it("quality below floor blocks competition readiness", () => {
    const c = composeCompetitionDrSourceAttachAntiekBenchRecommend({
      competition: {
        ...outer_competition_input,
        quality_overall: 0.2,
