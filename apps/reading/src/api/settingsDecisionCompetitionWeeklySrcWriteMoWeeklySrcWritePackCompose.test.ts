...
import {
  ...
  formatSettingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWritePackSummary,
} from "./settingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWritePackCompose";

describe("composeSettingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("settings decision + competition DR ND shadow weekly pack ready", () => {
    const c = composeSettingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatSettingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
