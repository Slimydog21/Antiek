...
describe("composeAntiekBenchSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack", () => {
const WEEKLY_ND = {
  weekly_learn: {
    week_id: "2026-W28",
...
const residual_ts10_tip_twin_records = [
  ...
  it("antiek-bench weekly learn + source-attach pack ready", () => {
    const c = composeAntiekBenchSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack({
    ...
    expect(formatAntiekBenchSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackSummary(c)).toMatch(/REJECT|pack_ready=true/);
  });
