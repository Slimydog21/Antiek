...
describe("composeWriteModeTwinCollectiveFullscreenCollectiveMultiselect", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("write twin collective + fullscreen collective multiselect pack ready", () => {
    const c = composeWriteModeTwinCollectiveFullscreenCollectiveMultiselect({
    ...
    expect(
      formatWriteModeTwinCollectiveFullscreenCollectiveMultiselectSummary(c),
    ...
    const c = composeWriteModeTwinCollectiveFullscreenCollectiveMultiselect({
      write: {
        ...
        twin_slices: [
          ...
          {
            parent_asset_id: "other-book-2",
            insights: ["z"],
            questions: [] as string[],
          },
        ],
        chase_slots: residual_write.chase_slots.map((s) => ({
          ...s,
          parent_asset_id: "other-book",
        })),
      },
