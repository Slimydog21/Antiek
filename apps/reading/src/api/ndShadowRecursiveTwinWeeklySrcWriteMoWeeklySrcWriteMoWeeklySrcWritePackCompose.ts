...
import {
  composeRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack,
  type RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
  type RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
} from "./recursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

export interface NdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput {
  nd_shadow: NotDiamondShadowAdvisoryInput;
  twin_presentation: Omit<
    RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface NdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  week_id: string;
  session_id: string;
  ...
  twin_presentation: RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose;
  pack_ready: boolean;
  ...
  notes: string[];
  authority: "nd_shadow_recursive_twin_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeNdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack(
  input: NdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
): NdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  ...
  return {
    ...
    notes,
    authority:
      "nd_shadow_recursive_twin_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory",
  };
}

export function formatNdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(
  c: NdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
): string {
  return (
