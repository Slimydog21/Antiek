...
describe("composeTwinSearchHtmlNativeMarketplaceMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("twin search + HTML-native marketplace MO weekly src write pack ready", () => {
    const c = composeTwinSearchHtmlNativeMarketplaceMoWeeklySrcWritePack({
      search_query: "scaling noise",
    ...
    expect(
      formatTwinSearchHtmlNativeMarketplaceMoWeeklySrcWritePackSummary(c),
  ...
  it("empty twin_records blocks hits and pack under require_both", () => {
    const c = composeTwinSearchHtmlNativeMarketplaceMoWeeklySrcWritePack({
      search_query: "scaling noise",
      twin_records: [],
      html_pack: residual_ts_outer_html_pack,
  ...
  it("nonsense query with empty hits blocks pack under require_both", () => {
    const c = composeTwinSearchHtmlNativeMarketplaceMoWeeklySrcWritePack({
