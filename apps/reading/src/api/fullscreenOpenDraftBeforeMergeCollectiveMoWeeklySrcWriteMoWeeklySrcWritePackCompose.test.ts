...
describe("composeFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("fullscreen + draft-before-merge collective MO weekly src write pack ready", () => {
    const c = composeFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
