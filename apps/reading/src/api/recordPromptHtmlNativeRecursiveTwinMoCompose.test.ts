...
describe("composeRecordPromptHtmlNativeRecursiveTwinMo", () => {
  it("record prompt + html pack ready", () => {
    const c = composeRecordPromptHtmlNativeRecursiveTwinMo({
    ...
    expect(formatRecordPromptHtmlNativeRecursiveTwinMoSummary(c)).toMatch(
