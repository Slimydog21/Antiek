...
import {
  ...
  type RecursiveTwinPresentationWeeklySrcWriteMoWeeklyPackCompose,
  type RecursiveTwinPresentationWeeklySrcWriteMoWeeklyPackInput,
} from "./recursiveTwinPresentationWeeklySrcWriteMoWeeklyPackCompose";

export interface NdShadowRecursiveTwinWeeklySrcWriteMoWeeklyPackInput {
  nd_shadow: NotDiamondShadowAdvisoryInput;
  twin_presentation: Omit<
    RecursiveTwinPresentationWeeklySrcWriteMoWeeklyPackInput,
    "operator_ack"
  >;
...
export interface NdShadowRecursiveTwinWeeklySrcWriteMoWeeklyPackCompose {
  week_id: string;
  session_id: string;
  ...
  twin_presentation: RecursiveTwinPresentationWeeklySrcWriteMoWeeklyPackCompose;
  pack_ready: boolean;
  ...
  notes: string[];
  authority: "nd_shadow_recursive_twin_weekly_src_write_mo_weekly_pack_compose_advisory";
}
 ...
 */
export function composeNdShadowRecursiveTwinWeeklySrcWriteMoWeeklyPack(
  input: NdShadowRecursiveTwinWeeklySrcWriteMoWeeklyPackInput,
): NdShadowRecursiveTwinWeeklySrcWriteMoWeeklyPackCompose {
...
export function formatNdShadowRecursiveTwinWeeklySrcWriteMoWeeklyPackSummary(
  c: NdShadowRecursiveTwinWeeklySrcWriteMoWeeklyPackCompose,
): string {
  return (
