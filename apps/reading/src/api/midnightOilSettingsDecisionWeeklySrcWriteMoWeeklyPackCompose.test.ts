...
import {
  ...
  formatMidnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPackSummary,
} from "./midnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPackCompose";

describe("composeMidnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("Midnight Oil + settings decision competition weekly pack ready", () => {
    const c = composeMidnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPack({
    ...
    expect(
      formatMidnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPackSummary(c),
  ...
  it("recommend_only stage ready without unattended still pure", () => {
    const c = composeMidnightOilSettingsDecisionWeeklySrcWriteMoWeeklyPack({
      mo: {
        operator_id: "op-1",
        work_minutes: 120,
