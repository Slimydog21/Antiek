...
import {
  composeCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWritePack,
  type CollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWritePackCompose,
  type CollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWritePackInput,
} from "./collectiveMultiselectFloatingDrWorkstationMoWeeklySrcWritePackCompose";

export interface DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePackInput {
  draft_gate: Omit<FloatingDraftBeforeFullMergeGateInput, "operator_ack">;
  collective_pack: Omit<
    CollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePackCompose {
  week_id: string;
  session_id: string;
  ...
  collective_pack: CollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWritePackCompose;
  ...
  notes: string[];
  authority: "draft_before_merge_collective_floating_dr_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePack(
  input: DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePackInput,
): DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePackCompose {
  ...
  const collective_pack = composeCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWritePack(
    {
  ...
  return {
    ...
    notes,
    authority:
      "draft_before_merge_collective_floating_dr_mo_weekly_src_write_pack_compose_advisory",
  };
}

export function formatDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePackSummary(
  c: DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePackCompose,
): string {
  return (
