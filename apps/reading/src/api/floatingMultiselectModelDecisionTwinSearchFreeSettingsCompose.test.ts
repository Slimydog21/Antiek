...
describe("composeFloatingMultiselectModelDecisionTwinSearchFreeSettings", () => {
  ...
  it("floating multi-select + model decision twin search free settings pack ready", () => {
    const c = composeFloatingMultiselectModelDecisionTwinSearchFreeSettings({
    ...
    expect(
      formatFloatingMultiselectModelDecisionTwinSearchFreeSettingsSummary(c),
