...
describe("composeSourceAttachModelDecisionTwinSearch", () => {
  const twin_pack = {
    twin: {
      parent_asset_id: "book-1",
      source_excerpt:
  ...
  it("source attach + model decision twin search pack ready", () => {
    const c = composeSourceAttachModelDecisionTwinSearch({
      sources,
      decision_pack: {
        decision,
        twin_search_pack: {
    ...
    expect(
      formatSourceAttachModelDecisionTwinSearchSummary(c),
  ...
  it("empty sources blocks attach_ready and pack_ready", () => {
    const c = composeSourceAttachModelDecisionTwinSearch({
      sources: {
        ...sources,
        sources: [],
