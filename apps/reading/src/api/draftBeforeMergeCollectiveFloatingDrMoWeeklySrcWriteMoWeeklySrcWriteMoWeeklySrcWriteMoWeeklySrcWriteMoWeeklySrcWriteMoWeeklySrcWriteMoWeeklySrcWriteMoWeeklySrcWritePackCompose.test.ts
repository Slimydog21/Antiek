...
import {
  composeDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack,
  formatDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary,
} from "./draftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

describe("composeDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
const WEEKLY_ND = {
  weekly_learn: {
    week_id: "2026-W28",
...
const residual_sd7_outer_settings = {
  ...
  const residual_hn8_tip_html_view = {
    session_id: "sess-1",
    asset_id: "book-1",
    html_projection_sha: "sha-free-1",
    view_requested: true,
  ...
  const residual_hn8_tip_market_pack = {
    market: residual_mkt7_tip_market,
    mo_pack: residual_mkt7_tip_mo_pack,
  };

  const residual_ts8_tip_twin_records = [
    {
      twin_id: "twin-book-1",
      parent_asset_id: "book-1",
      insights: ["scaling laws hold under noise in compute-optimal regimes"],
  ...
  const residual_ts8_tip_html_pack = {
    html_view: residual_hn8_tip_html_view,
    market_pack: residual_hn8_tip_market_pack,
  };

  const residual_md8_tip_decision = {
    models: [
      {
        model_id: "gpt-5.5",
        tier: "frontier",
  ...
  const residual_md8_tip_twin_search_pack = {
    search_query: "scaling laws",
    twin_records: residual_ts8_tip_twin_records,
    html_pack: residual_ts8_tip_html_pack,
  };

  const residual_ws8_tip_items = [
    {
      record_id: "r1",
      kind: "insight" as const,
      text: "scaling holds under noise in compute-optimal regimes",
  ...
  const residual_ws8_tip_decision_pack = {
    decision: residual_md8_tip_decision,
    twin_search_pack: residual_md8_tip_twin_search_pack,
  };

  const residual_fd8_tip_highlight_launch = {
    parent_asset_id: "book-1",
    highlight: "scaling laws under noise",
    gated: false,
    preferred_view_mode: "floating" as const,
  ...
  const residual_fd8_tip_record_pack = {
    session_id: "sess-1",
    items: residual_ws8_tip_items,
    decision_pack: residual_ws8_tip_decision_pack,
  };

  const residual_cm8_tip_multiselect = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    members: [
      {
  ...
  const residual_cm8_tip_floating_pack = {
    highlight_launch: residual_fd8_tip_highlight_launch,
    record_pack: residual_fd8_tip_record_pack,
  };

  const residual_db8_tip_draft_gate = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    parent_excerpt: "<p>Parent body on scaling laws</p>",
    sources: [
  ...
  const residual_db8_tip_collective_pack = {
    multiselect: residual_cm8_tip_multiselect,
    floating_pack: residual_cm8_tip_floating_pack,
  };

  it("draft-before-merge + collective floating DR pack ready", () => {
    const c = composeDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
      draft_gate: residual_db8_tip_draft_gate,
      collective_pack: residual_db8_tip_collective_pack,
      operator_ack: true,
    });
    ...
    expect(c.authority).toBe("draft_before_merge_collective_floating_dr_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory");
    expect(formatDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c)).toMatch(/REJECT|pack_ready=true|merge_executed=false/);
  });
