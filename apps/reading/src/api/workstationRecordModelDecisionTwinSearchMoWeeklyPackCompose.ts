 ...
 * HTML-native + HTML-native marketplace MO weekly pack (pure).
 *
...
import {
  ...
  type ModelDecisionTwinSearchHtmlNativeMoWeeklyPackInput,
} from "./modelDecisionTwinSearchHtmlNativeMoWeeklyPackCompose";

export interface WorkstationRecordModelDecisionTwinSearchMoWeeklyPackInput {
  session_id: string;
  items: WorkstationRecordItem[];
  max_context_lines?: number | null;
  decision_pack: Omit<
    ModelDecisionTwinSearchHtmlNativeMoWeeklyPackInput,
    "operator_ack"
  >;
...
export interface WorkstationRecordModelDecisionTwinSearchMoWeeklyPackCompose {
  week_id: string;
  session_id: string;
  ...
  decision_pack: ModelDecisionTwinSearchHtmlNativeMoWeeklyPackCompose;
  ...
  notes: string[];
  authority: "workstation_record_model_decision_twin_search_mo_weekly_pack_compose_advisory";
}
 ...
 */
export function composeWorkstationRecordModelDecisionTwinSearchMoWeeklyPack(
  input: WorkstationRecordModelDecisionTwinSearchMoWeeklyPackInput,
): WorkstationRecordModelDecisionTwinSearchMoWeeklyPackCompose {
  ...
  const decision_pack = composeModelDecisionTwinSearchHtmlNativeMoWeeklyPack({
    ...input.decision_pack,
  ...
  if (pack_ready) {
    notes.push(
      "pack_ready=true — workstation records + model decision twin search MO weekly ready; still pure",
    );
  } else {
    notes.push(
  ...
  return {
    ...
    notes,
    authority:
      "workstation_record_model_decision_twin_search_mo_weekly_pack_compose_advisory",
  };
}

export function formatWorkstationRecordModelDecisionTwinSearchMoWeeklyPackSummary(
  c: WorkstationRecordModelDecisionTwinSearchMoWeeklyPackCompose,
): string {
  return (
