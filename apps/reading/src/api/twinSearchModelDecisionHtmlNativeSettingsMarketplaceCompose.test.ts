...
describe("composeTwinSearchModelDecisionHtmlNativeSettingsMarketplace", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("twin search + model decision HTML-native settings marketplace pack ready", () => {
    const c = composeTwinSearchModelDecisionHtmlNativeSettingsMarketplace({
      search_query: "scaling noise",
      twin_records: twin_search_records,
    ...
    expect(
      formatTwinSearchModelDecisionHtmlNativeSettingsMarketplaceSummary(c),
  ...
  it("zero hits blocks pack_ready under require_both", () => {
    const c = composeTwinSearchModelDecisionHtmlNativeSettingsMarketplace({
  ...
  it("budget would_exceed nested blocks overall", () => {
    const c = composeTwinSearchModelDecisionHtmlNativeSettingsMarketplace({
      search_query: "scaling noise",
      twin_records: twin_search_records,
      model_decision_pack: {
        ...outer_model_decision_pack,
        decision: {
