...
describe("composeFloatingDrWorkstationRecordModelDecision", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("floating DR + workstation record model decision pack ready", () => {
    const c = composeFloatingDrWorkstationRecordModelDecision({
    ...
    expect(
      formatFloatingDrWorkstationRecordModelDecisionSummary(c),
