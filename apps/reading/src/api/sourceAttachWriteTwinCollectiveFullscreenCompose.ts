 ...
 * collective + fullscreen collective multiselect pack (pure).
 *
...
import {
  ...
  type WriteModeTwinCollectiveFullscreenCollectiveMultiselectInput,
} from "./writeModeTwinCollectiveFullscreenCollectiveMultiselectCompose";

export interface SourceAttachWriteTwinCollectiveFullscreenInput {
  sources: Omit<HtmlNativeSourceAttachInput, "operator_ack">;
  write_pack: Omit<
    WriteModeTwinCollectiveFullscreenCollectiveMultiselectInput,
    "operator_ack"
  >;
...
export interface SourceAttachWriteTwinCollectiveFullscreenCompose {
  session_id: string;
  ...
  write_pack: WriteModeTwinCollectiveFullscreenCollectiveMultiselectCompose;
  ...
  notes: string[];
  authority: "source_attach_write_twin_collective_fullscreen_compose_advisory";
}
...
/**
 * HTML-native source attach stacked on write twin collective fullscreen pack.
 * Never remote-fetches; never PDF; ND REJECT.
 */
export function composeSourceAttachWriteTwinCollectiveFullscreen(
  input: SourceAttachWriteTwinCollectiveFullscreenInput,
): SourceAttachWriteTwinCollectiveFullscreenCompose {
  ...
  const write_pack = composeWriteModeTwinCollectiveFullscreenCollectiveMultiselect({
    ...input.write_pack,
    operator_ack: input.operator_ack,
  });
  ...
  return {
    ...
    notes,
    authority:
      "source_attach_write_twin_collective_fullscreen_compose_advisory",
  };
}

export function formatSourceAttachWriteTwinCollectiveFullscreenSummary(
  c: SourceAttachWriteTwinCollectiveFullscreenCompose,
): string {
  return (
