...
describe("composeFloatingDrDraftBeforeMergeMoPriceCeiling", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("floating DR highlight + draft-before-merge MO price-ceiling pack ready", () => {
    const c = composeFloatingDrDraftBeforeMergeMoPriceCeiling({
    ...
    expect(
      formatFloatingDrDraftBeforeMergeMoPriceCeilingSummary(c),
