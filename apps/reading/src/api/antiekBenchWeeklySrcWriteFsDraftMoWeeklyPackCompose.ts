 ...
 * write twin fullscreen draft MO weekly pack (pure).
 *
...
import {
  composeSourceAttachWriteTwinFsDraftMoWeeklyPack,
  type SourceAttachWriteTwinFsDraftMoWeeklyPackCompose,
  type SourceAttachWriteTwinFsDraftMoWeeklyPackInput,
} from "./sourceAttachWriteTwinFsDraftMoWeeklyPackCompose";

export interface AntiekBenchWeeklySrcWriteFsDraftMoWeeklyPackInput {
  weekly_learn: Omit<AntiekBenchWeeklyUsageLearnInput, "operator_ack">;
  source_pack: Omit<
    SourceAttachWriteTwinFsDraftMoWeeklyPackInput,
    "operator_ack"
  >;
...
export interface AntiekBenchWeeklySrcWriteFsDraftMoWeeklyPackCompose {
  week_id: string;
  session_id: string;
  ...
  source_pack: SourceAttachWriteTwinFsDraftMoWeeklyPackCompose;
  ...
  notes: string[];
  authority: "antiek_bench_weekly_src_write_fs_draft_mo_weekly_pack_compose_advisory";
}
 ...
 */
export function composeAntiekBenchWeeklySrcWriteFsDraftMoWeeklyPack(
  input: AntiekBenchWeeklySrcWriteFsDraftMoWeeklyPackInput,
): AntiekBenchWeeklySrcWriteFsDraftMoWeeklyPackCompose {
  ...
  const source_pack = composeSourceAttachWriteTwinFsDraftMoWeeklyPack({
    ...input.source_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatAntiekBenchWeeklySrcWriteFsDraftMoWeeklyPackSummary(
  c: AntiekBenchWeeklySrcWriteFsDraftMoWeeklyPackCompose,
): string {
  return (
