...
import {
  ...
  formatHtmlNativeMarketplaceMoWeeklyPackSummary,
} from "./htmlNativeMarketplaceMoWeeklyPackCompose";

describe("composeHtmlNativeMarketplaceMoWeeklyPack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("HTML-native + marketplace free MO weekly pack ready", () => {
    const c = composeHtmlNativeMarketplaceMoWeeklyPack({
    ...
    expect(c.authority).toBe("html_native_marketplace_mo_weekly_pack_compose_advisory");
    expect(formatHtmlNativeMarketplaceMoWeeklyPackSummary(c)).toMatch(/pdf_primary=false/);
  });
