...
import {
  ...
  type MidnightOilSettingsDecisionCompetitionDrCompose,
  type MidnightOilSettingsDecisionCompetitionDrInput,
} from "./midnightOilSettingsDecisionCompetitionDrCompose";

export interface MarketplaceFreeMidnightOilSettingsDecisionInput {
  market: MarketplaceFreeBeforeBuyHtmlPortInput;
  mo_pack: Omit<
    MidnightOilSettingsDecisionCompetitionDrInput,
    "operator_ack"
  >;
...
export interface MarketplaceFreeMidnightOilSettingsDecisionCompose {
  title: string;
  account_id: string;
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "marketplace_free_midnight_oil_settings_decision_compose_advisory";
}
 ...
 */
export function composeMarketplaceFreeMidnightOilSettingsDecision(
  input: MarketplaceFreeMidnightOilSettingsDecisionInput,
  ...
  const mo_pack = composeMidnightOilSettingsDecisionCompetitionDr({
    ...input.mo_pack,
...
export function formatMarketplaceFreeMidnightOilSettingsDecisionSummary(
