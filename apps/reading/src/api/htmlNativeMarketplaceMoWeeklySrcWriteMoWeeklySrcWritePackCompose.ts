 ...
 * (short residual: HtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePack — FS 255; never PDF-primary).
...
import {
  ...
  type MarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWritePackInput,
} from "./marketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWritePackCompose";

export interface HtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackInput {
  html_view: Omit<HtmlNativeViewSessionAuthorityInput, "operator_ack">;
  market_pack: Omit<
    MarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface HtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  session_id: string;
  ...
  market_pack: MarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWritePackCompose;
  ...
  notes: string[];
  authority: "html_native_marketplace_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePack(
  input: HtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackInput,
): HtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  ...
  const market_pack = composeMarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWritePack({
    ...input.market_pack,
    operator_ack: input.operator_ack,
  });
  ...
  return {
    ...
    notes,
    authority:
      "html_native_marketplace_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory",
  };
}

export function formatHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackSummary(
  c: HtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
): string {
  return (
