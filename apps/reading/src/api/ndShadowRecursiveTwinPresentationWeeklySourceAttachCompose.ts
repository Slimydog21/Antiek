 ...
 * + Antiek-bench weekly source-attach write twin pack (pure).
 *
...
import {
  composeRecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwin,
  type RecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinCompose,
  type RecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinInput,
} from "./recursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinCompose";

export interface NdShadowRecursiveTwinPresentationWeeklySourceAttachInput {
  nd_shadow: NotDiamondShadowAdvisoryInput;
  twin_presentation: Omit<
    RecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinInput,
    "operator_ack"
  >;
...
export interface NdShadowRecursiveTwinPresentationWeeklySourceAttachCompose {
  week_id: string;
  session_id: string;
  ...
  twin_presentation: RecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinCompose;
  pack_ready: boolean;
  ...
  notes: string[];
  authority: "nd_shadow_recursive_twin_presentation_weekly_source_attach_compose_advisory";
}
...
/**
 * ND shadow REJECT re-affirmation on twin presentation + weekly source-attach pack.
 * Never live-routes; never writes twin; never mutates bench.
 */
export function composeNdShadowRecursiveTwinPresentationWeeklySourceAttach(
  input: NdShadowRecursiveTwinPresentationWeeklySourceAttachInput,
): NdShadowRecursiveTwinPresentationWeeklySourceAttachCompose {
...
export function formatNdShadowRecursiveTwinPresentationWeeklySourceAttachSummary(
  c: NdShadowRecursiveTwinPresentationWeeklySourceAttachCompose,
): string {
  return (
