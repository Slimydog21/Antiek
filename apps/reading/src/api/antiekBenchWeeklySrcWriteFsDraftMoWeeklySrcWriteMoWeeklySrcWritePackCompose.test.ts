...
describe("composeAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("weekly learn + source attach write twin FS draft MO weekly src write pack ready", () => {
    const c = composeAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
