...
describe("composeHtmlNativeMarketplaceFreeSettingsNdTwin", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("HTML-native + marketplace free settings ND twin pack ready", () => {
    const c = composeHtmlNativeMarketplaceFreeSettingsNdTwin({
    ...
    expect(
      formatHtmlNativeMarketplaceFreeSettingsNdTwinSummary(c),
  ...
  it("session mismatch blocks pack_ready", () => {
    const c = composeHtmlNativeMarketplaceFreeSettingsNdTwin({
      html_view: { ...outer_html_view_input, session_id: "sess-other" },
      market_pack: outer_market_pack,
      operator_ack: true,
    });
  ...
  it("asset_id mismatch blocks parent_aligned", () => {
    const c = composeHtmlNativeMarketplaceFreeSettingsNdTwin({
      html_view: { ...outer_html_view_input, asset_id: "book-other" },
      market_pack: outer_market_pack,
      operator_ack: true,
    });
