...
import {
  ...
  type NdShadowRecursiveTwinPresentationWeeklySourceAttachInput,
} from "./ndShadowRecursiveTwinPresentationWeeklySourceAttachCompose";

export interface CompetitionDrNdShadowTwinPresentationWeeklyInput {
  competition: Omit<CompetitionDrQualitySourcePackInput, "operator_ack">;
  nd_pack: Omit<
    NdShadowRecursiveTwinPresentationWeeklySourceAttachInput,
    "operator_ack"
  >;
...
export interface CompetitionDrNdShadowTwinPresentationWeeklyCompose {
  session_id: string;
  week_id: string;
  ...
  nd_pack: NdShadowRecursiveTwinPresentationWeeklySourceAttachCompose;
  ...
  notes: string[];
  authority: "competition_dr_nd_shadow_twin_presentation_weekly_compose_advisory";
}
 ...
 */
export function composeCompetitionDrNdShadowTwinPresentationWeekly(
  input: CompetitionDrNdShadowTwinPresentationWeeklyInput,
): CompetitionDrNdShadowTwinPresentationWeeklyCompose {
  ...
  const nd_pack = composeNdShadowRecursiveTwinPresentationWeeklySourceAttach({
    ...input.nd_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatCompetitionDrNdShadowTwinPresentationWeeklySummary(
  c: CompetitionDrNdShadowTwinPresentationWeeklyCompose,
): string {
  return (
