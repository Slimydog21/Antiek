...
import {
  composeRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePack,
  type RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePackCompose,
  type RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePackInput,
} from "./recursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePackCompose";

export interface NdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWritePackInput {
  nd_shadow: NotDiamondShadowAdvisoryInput;
  twin_presentation: Omit<
    RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface NdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWritePackCompose {
  week_id: string;
  session_id: string;
  ...
  twin_presentation: RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWritePackCompose;
  pack_ready: boolean;
  ...
  notes: string[];
  authority: "nd_shadow_recursive_twin_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeNdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWritePack(
  input: NdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWritePackInput,
): NdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWritePackCompose {
  ...
  return {
    ...
    notes,
    authority:
      "nd_shadow_recursive_twin_weekly_src_write_mo_weekly_src_write_pack_compose_advisory",
  };
}

export function formatNdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWritePackSummary(
  c: NdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWritePackCompose,
): string {
  return (
