...
import {
  ...
  type DraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationInput,
} from "./draftBeforeMergeCollectiveMultiselectFloatingDrWorkstationCompose";

export interface FullscreenOpenDraftBeforeMergeCollectiveMultiselectInput {
  fullscreen: Omit<FloatingFullscreenOpenInput, "operator_ack">;
  draft_pack: Omit<
    DraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationInput,
    "operator_ack"
  >;
...
export interface FullscreenOpenDraftBeforeMergeCollectiveMultiselectCompose {
  week_id: string;
  session_id: string;
  ...
  draft_pack: DraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationCompose;
  ...
  notes: string[];
  authority: "fullscreen_open_draft_before_merge_collective_multiselect_compose_advisory";
}
 ...
 */
export function composeFullscreenOpenDraftBeforeMergeCollectiveMultiselect(
  input: FullscreenOpenDraftBeforeMergeCollectiveMultiselectInput,
): FullscreenOpenDraftBeforeMergeCollectiveMultiselectCompose {
  ...
  return {
    ...
    notes,
    authority:
      "fullscreen_open_draft_before_merge_collective_multiselect_compose_advisory",
  };
}

export function formatFullscreenOpenDraftBeforeMergeCollectiveMultiselectSummary(
  c: FullscreenOpenDraftBeforeMergeCollectiveMultiselectCompose,
): string {
  return (
