...
import {
  ...
  type RecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftInput,
} from "./recursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose";

export interface NdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftInput {
  nd_shadow: NotDiamondShadowAdvisoryInput;
  twin_presentation: Omit<
    RecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftInput,
    "operator_ack"
  >;
...
export interface NdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose {
  week_id: string;
  session_id: string;
  ...
  twin_presentation: RecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose;
  pack_ready: boolean;
  ...
  notes: string[];
  authority: "nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_compose_advisory";
}
 ...
 */
export function composeNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraft(
  input: NdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftInput,
  ...
  return {
    ...
    notes,
    authority:
      "nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_compose_advisory",
  };
}

export function formatNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftSummary(
  c: NdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose,
): string {
  return (
