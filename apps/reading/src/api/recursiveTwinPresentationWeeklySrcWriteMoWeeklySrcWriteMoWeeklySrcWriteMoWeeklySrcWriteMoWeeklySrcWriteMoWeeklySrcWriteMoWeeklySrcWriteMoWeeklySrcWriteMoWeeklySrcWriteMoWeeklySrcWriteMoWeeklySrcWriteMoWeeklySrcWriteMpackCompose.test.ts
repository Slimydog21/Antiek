...
import {
  ...
  formatRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackSummary,
} from "./recursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackCompose";

describe("composeRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpack", () => {
const WEEKLY_ND = {
  weekly_learn: {
    week_id: "2026-W28",
...
const COMPETITION_CITATIONS = [
  ...
  (outer_settings_pack as { competition_pack?: unknown }).competition_pack =
    pack_outer_competition_pack;
  (outer_market_pack as { competition_pack?: unknown }).competition_pack =
    pack_outer_competition_pack;
  ...
  (outer_market_pack as { mo_pack?: unknown }).mo_pack =
    pack_outer_mo_for_market;
  ...
  const residual_mk7_outer_market_pre0 = {
    title: "Scaling Laws Book",
    account_id: "acct-1",
    free_copy_available: true as boolean | null,
    free_html_projection_sha: "sha-free-1",
  ...
  const residual_mk7_outer_mo_pack_pre0 = {
  ...
  const residual_hn6_outer_market_pack = {
    market: residual_mk7_outer_market_pre0,
    mo_pack: residual_mk7_outer_mo_pack_pre0,
  };
  ...
  const residual_mk7_outer_market = {
    title: "Scaling Laws Book",
    account_id: "acct-1",
    free_copy_available: true as boolean | null,
    free_html_projection_sha: "sha-free-1",
  ...
  const residual_mk7_outer_mo_pack = {
    mo: residual_mo6_outer_mo,
    settings_pack: residual_mo6_outer_settings_pack,
  };


  const residual_hn7_outer_html_view = {
    session_id: "sess-1",
    asset_id: "book-1",
    html_projection_sha: "sha-free-1",
    view_requested: true,
  ...
  const residual_hn7_outer_market_pack = {
    market: residual_mk7_outer_market,
    mo_pack: residual_mk7_outer_mo_pack,
  };


  const residual_ts7_outer_twin_records = [
    {
      twin_id: "twin-book-1",
      parent_asset_id: "book-1",
      insights: ["scaling laws hold under noise in compute-optimal regimes"],
  ...
  const residual_ts7_outer_html_pack = {
    html_view: residual_hn7_outer_html_view,
    market_pack: residual_hn7_outer_market_pack,
  };


  const residual_md7_outer_decision = {
    models: [
      {
        model_id: "gpt-5.5",
        tier: "frontier",
  ...
  const residual_md7_outer_twin_search_pack = {
    search_query: "scaling noise",
    twin_records: residual_ts7_outer_twin_records,
    html_pack: residual_ts7_outer_html_pack,
  };


  const residual_ws8_outer_items = [
    {
      record_id: "r1",
      kind: "insight" as const,
      text: "scaling holds under noise in compute-optimal regimes",
...
const residual_rtx_graft_mkt7_tip_market = {
    title: "Scaling Laws Book",
    account_id: "acct-1",
    free_copy_available: true as boolean | null,
    free_html_projection_sha: "sha-free-1",
  ...
  const residual_rtx_graft_mkt7_tip_mo_pack = {
    mo: residual_graft_mo7_outer_mo,
    settings_pack: residual_graft_mo7_outer_settings_pack,
  };

  const residual_rtx_graft_hn8_tip_html_view = {
    session_id: "sess-1",
    asset_id: "book-1",
    html_projection_sha: "sha-free-1",
    view_requested: true,
  ...
  const residual_rtx_graft_hn8_tip_market_pack = {
    market: residual_rtx_graft_mkt7_tip_market,
    mo_pack: residual_rtx_graft_mkt7_tip_mo_pack,
  };

  const residual_rtx_graft_ts8_tip_twin_records = [
    {
      twin_id: "twin-book-1",
      parent_asset_id: "book-1",
      insights: ["scaling laws hold under noise in compute-optimal regimes"],
  ...
  const residual_rtx_graft_ts8_tip_html_pack = {
    html_view: residual_rtx_graft_hn8_tip_html_view,
    market_pack: residual_rtx_graft_hn8_tip_market_pack,
  };

  const residual_rtx_graft_md8_tip_decision = {
    models: [
      {
        model_id: "gpt-5.5",
        tier: "frontier",
  ...
  const residual_rtx_graft_md8_tip_twin_search_pack = {
    search_query: "scaling laws",
    twin_records: residual_rtx_graft_ts8_tip_twin_records,
    html_pack: residual_rtx_graft_ts8_tip_html_pack,
  };

  const residual_rtx_graft_ws8_tip_items = [
    {
      record_id: "r1",
      kind: "insight" as const,
      text: "scaling holds under noise in compute-optimal regimes",
  ...
  const residual_rtx_graft_ws8_tip_decision_pack = {
    decision: residual_rtx_graft_md8_tip_decision,
    twin_search_pack: residual_rtx_graft_md8_tip_twin_search_pack,
  };

  const residual_rtx_graft_fd8_tip_highlight_launch = {
    parent_asset_id: "book-1",
    highlight: "scaling laws under noise",
    gated: false,
    preferred_view_mode: "floating" as const,
  ...
  const residual_rtx_graft_fd8_tip_record_pack = {
    session_id: "sess-1",
    items: residual_rtx_graft_ws8_tip_items,
    decision_pack: residual_rtx_graft_ws8_tip_decision_pack,
  };

  const residual_rtx_graft_cm8_tip_multiselect = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    members: [
      {
  ...
  const residual_rtx_graft_cm8_tip_floating_pack = {
    highlight_launch: residual_rtx_graft_fd8_tip_highlight_launch,
    record_pack: residual_rtx_graft_fd8_tip_record_pack,
  };

  const residual_rtx_graft_db8_tip_draft_gate = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    parent_excerpt: "<p>Parent body on scaling laws</p>",
    sources: [
  ...
  const residual_rtx_graft_db8_tip_collective_pack = {
    multiselect: residual_rtx_graft_cm8_tip_multiselect,
    floating_pack: residual_rtx_graft_cm8_tip_floating_pack,
  floating_dr_pack: residual_cf_floating_dr_pack,
  };
...
const residual_abx_graft_mkt7_tip_market = {
    title: "Scaling Laws Book",
    account_id: "acct-1",
    free_copy_available: true as boolean | null,
    free_html_projection_sha: "sha-free-1",
  ...
  const residual_abx_graft_mkt7_tip_mo_pack = {
    mo: residual_graft_mo7_outer_mo,
    settings_pack: residual_graft_mo7_outer_settings_pack,
  };

  const residual_abx_graft_hn8_tip_html_view = {
    session_id: "sess-1",
    asset_id: "book-1",
    html_projection_sha: "sha-free-1",
    view_requested: true,
  ...
  const residual_abx_graft_hn8_tip_market_pack = {
    market: residual_abx_graft_mkt7_tip_market,
    mo_pack: residual_abx_graft_mkt7_tip_mo_pack,
  };

  const residual_abx_graft_ts8_tip_twin_records = [
    {
      twin_id: "twin-book-1",
      parent_asset_id: "book-1",
      insights: ["scaling laws hold under noise in compute-optimal regimes"],
  ...
  const residual_abx_graft_ts8_tip_html_pack = {
    html_view: residual_abx_graft_hn8_tip_html_view,
    market_pack: residual_abx_graft_hn8_tip_market_pack,
  };

  const residual_abx_graft_md8_tip_decision = {
    models: [
      {
        model_id: "gpt-5.5",
        tier: "frontier",
  ...
  const residual_abx_graft_md8_tip_twin_search_pack = {
    search_query: "scaling laws",
    twin_records: residual_abx_graft_ts8_tip_twin_records,
    html_pack: residual_abx_graft_ts8_tip_html_pack,
  };

  const residual_abx_graft_ws8_tip_items = [
    {
      record_id: "r1",
      kind: "insight" as const,
      text: "scaling holds under noise in compute-optimal regimes",
  ...
  const residual_abx_graft_ws8_tip_decision_pack = {
    decision: residual_abx_graft_md8_tip_decision,
    twin_search_pack: residual_abx_graft_md8_tip_twin_search_pack,
  };

  const residual_abx_graft_fd8_tip_highlight_launch = {
    parent_asset_id: "book-1",
    highlight: "scaling laws under noise",
    gated: false,
    preferred_view_mode: "floating" as const,
  ...
  const residual_abx_graft_fd8_tip_record_pack = {
    session_id: "sess-1",
    items: residual_abx_graft_ws8_tip_items,
    decision_pack: residual_abx_graft_ws8_tip_decision_pack,
  };

  const residual_abx_graft_cm8_tip_multiselect = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    members: [
      {
  ...
  const residual_abx_graft_cm8_tip_floating_pack = {
    highlight_launch: residual_abx_graft_fd8_tip_highlight_launch,
    record_pack: residual_abx_graft_fd8_tip_record_pack,
  };

  const residual_abx_graft_db8_tip_draft_gate = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    parent_excerpt: "<p>Parent body on scaling laws</p>",
    sources: [
  ...
  const residual_abx_graft_db8_tip_collective_pack = {
    multiselect: residual_abx_graft_cm8_tip_multiselect,
    floating_pack: residual_abx_graft_cm8_tip_floating_pack,
  floating_dr_pack: residual_cf_floating_dr_pack,
  };


const residual_sax_graft_mo6_outer_mo = {
    operator_id: "op-1",
    work_minutes: 120,
    goals: [
      { goal_id: "g1", title: "Map scaling literature" },
  ...
  const residual_sax_graft_mo6_outer_settings_pack = {
    settings: residual_sd6_outer_settings,
    competition_pack: residual_sd6_outer_competition_pack,
  };


  const residual_sax_graft_mk8_outer_market = {
    title: "Scaling Laws Book",
    account_id: "acct-1",
    free_copy_available: true as boolean | null,
    free_html_projection_sha: "sha-free-1",
  ...
  const residual_sax_graft_mk8_outer_mo_pack = {
    mo: residual_sax_graft_mo6_outer_mo,
    settings_pack: residual_sax_graft_mo6_outer_settings_pack,
  };


  const residual_sax_graft_hn7_outer_html_view = {
    session_id: "sess-1",
    asset_id: "book-1",
    html_projection_sha: "sha-free-1",
    view_requested: true,
  ...
  const residual_sax_graft_hn7_outer_market_pack = {
    market: residual_sax_graft_mk8_outer_market,
    mo_pack: residual_sax_graft_mk8_outer_mo_pack,
  };


  const residual_sax_graft_ts7_outer_twin_records = [
    {
      twin_id: "twin-book-1",
      parent_asset_id: "book-1",
      insights: ["scaling laws hold under noise in compute-optimal regimes"],
  ...
  const residual_sax_graft_ts7_outer_html_pack = {
    html_view: residual_sax_graft_hn7_outer_html_view,
    market_pack: residual_sax_graft_hn7_outer_market_pack,
  };


  const residual_sax_graft_md7_outer_decision = {
    models: [
      {
        model_id: "gpt-5.5",
        tier: "frontier",
  ...
  const residual_sax_graft_md7_outer_twin_search_pack = {
    search_query: "scaling noise",
    twin_records: residual_sax_graft_ts7_outer_twin_records,
    html_pack: residual_sax_graft_ts7_outer_html_pack,
  };


  const residual_sax_graft_ws7_outer_items = [
    {
      record_id: "r1",
      kind: "insight" as const,
      text: "scaling holds under noise in compute-optimal regimes",
  ...
  const residual_sax_graft_ws7_outer_decision_pack = {
    decision: residual_sax_graft_md7_outer_decision,
    twin_search_pack: residual_sax_graft_md7_outer_twin_search_pack,
  };


  const residual_sax_graft_fd7_outer_highlight_launch = {
    parent_asset_id: "book-1",
    highlight: "scaling laws under noise",
    gated: false,
    preferred_view_mode: "floating" as const,
  ...
  const residual_sax_graft_fd7_outer_record_pack = {
    session_id: "sess-1",
    items: residual_sax_graft_ws7_outer_items,
    decision_pack: residual_sax_graft_ws7_outer_decision_pack,
  };


  const residual_sax_graft_cm7_outer_multiselect = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    members: [
      {
  ...
  const residual_sax_graft_cm7_outer_floating_pack = {
    highlight_launch: residual_sax_graft_fd7_outer_highlight_launch,
    record_pack: residual_sax_graft_fd7_outer_record_pack,
  };

const residual_sax_graft_db7_outer_draft_gate = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    parent_excerpt: "<p>Parent body on scaling laws</p>",
    sources: [
  ...
  const residual_sax_graft_fs7_outer_fullscreen = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    highlight: "scaling laws under noise",
    gated: false,
  ...
  const residual_sax_graft_fs7_outer_draft_pack = {
    draft_gate: residual_sax_graft_db7_outer_draft_gate,
    collective_pack: residual_sax_graft_db7_outer_collective_pack,
  };

const residual_sax_graft_wt7_outer_write = {
    session_id: "sess-1",
    draft_id: "draft-1",
    parent_asset_id: "book-1",
    twin_slices: [
...
const residual_sax_graft_sa7_outer_sources = {
  ...
  const residual_sax_graft_sa7_outer_write_pack = {
    write: residual_sax_graft_wt7_outer_write,
    fullscreen_pack: residual_sax_graft_wt7_outer_fullscreen_pack,
  };

const residual_sax_graft_ab7_outer_weekly_learn = {
    week_id: "2026-W28",
    min_events_per_task: 2,
    events: [
      {
  ...
  const residual_sax_graft_ab7_outer_source_pack = {
    sources: residual_sax_graft_sa7_outer_sources,
    write_pack: residual_sax_graft_sa7_outer_write_pack,
  };

const residual_sax_graft_rt7_outer_twin = {
    parent_asset_id: "book-1",
    source_excerpt:
      "<p>Scaling laws hold under noise in compute-optimal regimes.</p>",
    focus_questions: ["Where does it break?", "What residual gaps?"],
...
const residual_sax_graft_rt7_outer_presentation = {
    view_mode: "side_panel" as const,
    open_requested: true,
    merge_to_parent_preview: false,
    presented_insights: [
  ...
  const residual_sax_graft_rt7_outer_weekly_pack = {
    weekly_learn: residual_sax_graft_ab7_outer_weekly_learn,
    source_pack: residual_sax_graft_ab7_outer_source_pack,
  };

const residual_sax_graft_nds7_outer_nd_shadow = {
    selected_model_id: "gpt-5.5",
    nd_recommended_model_id: "claude-opus",
    kill_switch_on: true,
    confidence: 0.72,
  ...
  const residual_sax_graft_nds7_outer_twin_presentation = {
    twin: residual_sax_graft_rt7_outer_twin,
    presentation: residual_sax_graft_rt7_outer_presentation,
    weekly_pack: residual_sax_graft_rt7_outer_weekly_pack,
  };

const residual_sax_graft_cd7_outer_competition = {
    session_id: "sess-1",
    competitor_decisions: [
      {
        competitor: "Perplexity",
  ...
  const residual_sax_graft_cd7_outer_nd_pack = {
    nd_shadow: residual_sax_graft_nds7_outer_nd_shadow,
    twin_presentation: residual_sax_graft_nds7_outer_twin_presentation,
  };

const residual_sax_graft_sd7_outer_settings = {
    models: [
      { model_id: "gpt-5.5", provider: "openai" },
      { model_id: "grok-4.5", provider: "xai" },
    ],
  ...
  const residual_sax_graft_sd7_outer_competition_pack = {
    competition: residual_sax_graft_cd7_outer_competition,
    nd_pack: residual_sax_graft_cd7_outer_nd_pack,
  };

  const residual_sax_graft_mo7_outer_mo = {
    operator_id: "op-1",
    work_minutes: 120,
    goals: [
      { goal_id: "g1", title: "Map scaling literature" },
  ...
  const residual_sax_graft_mo7_outer_settings_pack = {
    settings: residual_sax_graft_sd7_outer_settings,
    competition_pack: residual_sax_graft_sd7_outer_competition_pack,
  };

  const residual_sax_graft_mkt7_tip_market = {
    title: "Scaling Laws Book",
    account_id: "acct-1",
    free_copy_available: true as boolean | null,
    free_html_projection_sha: "sha-free-1",
  ...
  const residual_sax_graft_mkt7_tip_mo_pack = {
    mo: residual_sax_graft_mo7_outer_mo,
    settings_pack: residual_sax_graft_mo7_outer_settings_pack,
  };

  const residual_sax_graft_hn8_tip_html_view = {
    session_id: "sess-1",
    asset_id: "book-1",
    html_projection_sha: "sha-free-1",
    view_requested: true,
  ...
  const residual_sax_graft_hn8_tip_market_pack = {
    market: residual_sax_graft_mkt7_tip_market,
    mo_pack: residual_sax_graft_mkt7_tip_mo_pack,
  };

  const residual_sax_graft_ts8_tip_twin_records = [
    {
      twin_id: "twin-book-1",
      parent_asset_id: "book-1",
      insights: ["scaling laws hold under noise in compute-optimal regimes"],
  ...
  const residual_sax_graft_ts8_tip_html_pack = {
    html_view: residual_sax_graft_hn8_tip_html_view,
    market_pack: residual_sax_graft_hn8_tip_market_pack,
  };

  const residual_sax_graft_md8_tip_decision = {
    models: [
      {
        model_id: "gpt-5.5",
        tier: "frontier",
  ...
  const residual_sax_graft_md8_tip_twin_search_pack = {
    search_query: "scaling laws",
    twin_records: residual_sax_graft_ts8_tip_twin_records,
    html_pack: residual_sax_graft_ts8_tip_html_pack,
  };

  const residual_sax_graft_ws8_tip_items = [
    {
      record_id: "r1",
      kind: "insight" as const,
      text: "scaling holds under noise in compute-optimal regimes",
  ...
  const residual_sax_graft_ws8_tip_decision_pack = {
    decision: residual_sax_graft_md8_tip_decision,
    twin_search_pack: residual_sax_graft_md8_tip_twin_search_pack,
  };

  const residual_sax_graft_fd8_tip_highlight_launch = {
    parent_asset_id: "book-1",
    highlight: "scaling laws under noise",
    gated: false,
    preferred_view_mode: "floating" as const,
  ...
  const residual_sax_graft_fd8_tip_record_pack = {
    session_id: "sess-1",
    items: residual_sax_graft_ws8_tip_items,
    decision_pack: residual_sax_graft_ws8_tip_decision_pack,
  };

  const residual_sax_graft_cm8_tip_multiselect = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    members: [
      {
  ...
  const residual_sax_graft_cm8_tip_floating_pack = {
    highlight_launch: residual_sax_graft_fd8_tip_highlight_launch,
    record_pack: residual_sax_graft_fd8_tip_record_pack,
  };

  const residual_sax_graft_db8_tip_draft_gate = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    parent_excerpt: "<p>Parent body on scaling laws</p>",
    sources: [
...
const residual_wtx_graft_mo6_outer_mo = {
    operator_id: "op-1",
    work_minutes: 120,
    goals: [
      { goal_id: "g1", title: "Map scaling literature" },
  ...
  const residual_wtx_graft_mo6_outer_settings_pack = {
    settings: residual_sd6_outer_settings,
    competition_pack: residual_sd6_outer_competition_pack,
  };


  const residual_wtx_graft_mk8_outer_market = {
    title: "Scaling Laws Book",
    account_id: "acct-1",
    free_copy_available: true as boolean | null,
    free_html_projection_sha: "sha-free-1",
  ...
  const residual_wtx_graft_mk8_outer_mo_pack = {
    mo: residual_wtx_graft_mo6_outer_mo,
    settings_pack: residual_wtx_graft_mo6_outer_settings_pack,
  };


  const residual_wtx_graft_hn7_outer_html_view = {
    session_id: "sess-1",
    asset_id: "book-1",
    html_projection_sha: "sha-free-1",
    view_requested: true,
  ...
  const residual_wtx_graft_hn7_outer_market_pack = {
    market: residual_wtx_graft_mk8_outer_market,
    mo_pack: residual_wtx_graft_mk8_outer_mo_pack,
  };


  const residual_wtx_graft_ts7_outer_twin_records = [
    {
      twin_id: "twin-book-1",
      parent_asset_id: "book-1",
      insights: ["scaling laws hold under noise in compute-optimal regimes"],
  ...
  const residual_wtx_graft_ts7_outer_html_pack = {
    html_view: residual_wtx_graft_hn7_outer_html_view,
    market_pack: residual_wtx_graft_hn7_outer_market_pack,
  };


  const residual_wtx_graft_md7_outer_decision = {
    models: [
      {
        model_id: "gpt-5.5",
        tier: "frontier",
  ...
  const residual_wtx_graft_md7_outer_twin_search_pack = {
    search_query: "scaling noise",
    twin_records: residual_wtx_graft_ts7_outer_twin_records,
    html_pack: residual_wtx_graft_ts7_outer_html_pack,
  };


  const residual_wtx_graft_ws7_outer_items = [
    {
      record_id: "r1",
      kind: "insight" as const,
      text: "scaling holds under noise in compute-optimal regimes",
  ...
  const residual_wtx_graft_ws7_outer_decision_pack = {
    decision: residual_wtx_graft_md7_outer_decision,
    twin_search_pack: residual_wtx_graft_md7_outer_twin_search_pack,
  };


  const residual_wtx_graft_fd7_outer_highlight_launch = {
    parent_asset_id: "book-1",
    highlight: "scaling laws under noise",
    gated: false,
    preferred_view_mode: "floating" as const,
  ...
  const residual_wtx_graft_fd7_outer_record_pack = {
    session_id: "sess-1",
    items: residual_wtx_graft_ws7_outer_items,
    decision_pack: residual_wtx_graft_ws7_outer_decision_pack,
  };


  const residual_wtx_graft_cm7_outer_multiselect = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    members: [
      {
  ...
  const residual_wtx_graft_cm7_outer_floating_pack = {
    highlight_launch: residual_wtx_graft_fd7_outer_highlight_launch,
    record_pack: residual_wtx_graft_fd7_outer_record_pack,
  };

const residual_wtx_graft_db7_outer_draft_gate = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    parent_excerpt: "<p>Parent body on scaling laws</p>",
    sources: [
  ...
  const residual_wtx_graft_fs7_outer_fullscreen = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    highlight: "scaling laws under noise",
    gated: false,
  ...
  const residual_wtx_graft_fs7_outer_draft_pack = {
    draft_gate: residual_wtx_graft_db7_outer_draft_gate,
    collective_pack: residual_wtx_graft_db7_outer_collective_pack,
  };

const residual_wtx_graft_wt7_outer_write = {
    session_id: "sess-1",
    draft_id: "draft-1",
    parent_asset_id: "book-1",
    twin_slices: [
...
const residual_wtx_graft_sa7_outer_sources = {
  ...
  const residual_wtx_graft_sa7_outer_write_pack = {
    write: residual_wtx_graft_wt7_outer_write,
    fullscreen_pack: residual_wtx_graft_wt7_outer_fullscreen_pack,
  };

const residual_wtx_graft_ab7_outer_weekly_learn = {
    week_id: "2026-W28",
    min_events_per_task: 2,
    events: [
      {
  ...
  const residual_wtx_graft_ab7_outer_source_pack = {
    sources: residual_wtx_graft_sa7_outer_sources,
    write_pack: residual_wtx_graft_sa7_outer_write_pack,
  };

const residual_wtx_graft_rt7_outer_twin = {
    parent_asset_id: "book-1",
    source_excerpt:
      "<p>Scaling laws hold under noise in compute-optimal regimes.</p>",
    focus_questions: ["Where does it break?", "What residual gaps?"],
...
const residual_wtx_graft_rt7_outer_presentation = {
    view_mode: "side_panel" as const,
    open_requested: true,
    merge_to_parent_preview: false,
    presented_insights: [
  ...
  const residual_wtx_graft_rt7_outer_weekly_pack = {
    weekly_learn: residual_wtx_graft_ab7_outer_weekly_learn,
    source_pack: residual_wtx_graft_ab7_outer_source_pack,
  };

const residual_wtx_graft_nds7_outer_nd_shadow = {
    selected_model_id: "gpt-5.5",
    nd_recommended_model_id: "claude-opus",
    kill_switch_on: true,
    confidence: 0.72,
  ...
  const residual_wtx_graft_nds7_outer_twin_presentation = {
    twin: residual_wtx_graft_rt7_outer_twin,
    presentation: residual_wtx_graft_rt7_outer_presentation,
    weekly_pack: residual_wtx_graft_rt7_outer_weekly_pack,
  };

const residual_wtx_graft_cd7_outer_competition = {
    session_id: "sess-1",
    competitor_decisions: [
      {
        competitor: "Perplexity",
  ...
  const residual_wtx_graft_cd7_outer_nd_pack = {
    nd_shadow: residual_wtx_graft_nds7_outer_nd_shadow,
    twin_presentation: residual_wtx_graft_nds7_outer_twin_presentation,
  };

const residual_wtx_graft_sd7_outer_settings = {
    models: [
      { model_id: "gpt-5.5", provider: "openai" },
      { model_id: "grok-4.5", provider: "xai" },
    ],
  ...
  const residual_wtx_graft_sd7_outer_competition_pack = {
    competition: residual_wtx_graft_cd7_outer_competition,
    nd_pack: residual_wtx_graft_cd7_outer_nd_pack,
  };

  const residual_wtx_graft_mo7_outer_mo = {
    operator_id: "op-1",
    work_minutes: 120,
    goals: [
      { goal_id: "g1", title: "Map scaling literature" },
  ...
  const residual_wtx_graft_mo7_outer_settings_pack = {
    settings: residual_wtx_graft_sd7_outer_settings,
    competition_pack: residual_wtx_graft_sd7_outer_competition_pack,
  };

  const residual_wtx_graft_mkt7_tip_market = {
    title: "Scaling Laws Book",
    account_id: "acct-1",
    free_copy_available: true as boolean | null,
    free_html_projection_sha: "sha-free-1",
  ...
  const residual_wtx_graft_mkt7_tip_mo_pack = {
    mo: residual_wtx_graft_mo7_outer_mo,
    settings_pack: residual_wtx_graft_mo7_outer_settings_pack,
  };

  const residual_wtx_graft_hn8_tip_html_view = {
    session_id: "sess-1",
    asset_id: "book-1",
    html_projection_sha: "sha-free-1",
    view_requested: true,
  ...
  const residual_wtx_graft_hn8_tip_market_pack = {
    market: residual_wtx_graft_mkt7_tip_market,
    mo_pack: residual_wtx_graft_mkt7_tip_mo_pack,
  };

  const residual_wtx_graft_ts8_tip_twin_records = [
    {
      twin_id: "twin-book-1",
      parent_asset_id: "book-1",
      insights: ["scaling laws hold under noise in compute-optimal regimes"],
  ...
  const residual_wtx_graft_ts8_tip_html_pack = {
    html_view: residual_wtx_graft_hn8_tip_html_view,
    market_pack: residual_wtx_graft_hn8_tip_market_pack,
  };

  const residual_wtx_graft_md8_tip_decision = {
    models: [
      {
        model_id: "gpt-5.5",
        tier: "frontier",
  ...
  const residual_wtx_graft_md8_tip_twin_search_pack = {
    search_query: "scaling laws",
    twin_records: residual_wtx_graft_ts8_tip_twin_records,
    html_pack: residual_wtx_graft_ts8_tip_html_pack,
  };

  const residual_wtx_graft_ws8_tip_items = [
    {
      record_id: "r1",
      kind: "insight" as const,
      text: "scaling holds under noise in compute-optimal regimes",
  ...
  const residual_wtx_graft_ws8_tip_decision_pack = {
    decision: residual_wtx_graft_md8_tip_decision,
    twin_search_pack: residual_wtx_graft_md8_tip_twin_search_pack,
  };

  const residual_wtx_graft_fd8_tip_highlight_launch = {
    parent_asset_id: "book-1",
    highlight: "scaling laws under noise",
    gated: false,
    preferred_view_mode: "floating" as const,
  ...
  const residual_wtx_graft_fd8_tip_record_pack = {
    session_id: "sess-1",
    items: residual_wtx_graft_ws8_tip_items,
    decision_pack: residual_wtx_graft_ws8_tip_decision_pack,
  };

  const residual_wtx_graft_cm8_tip_multiselect = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    members: [
      {
  ...
  const residual_wtx_graft_cm8_tip_floating_pack = {
    highlight_launch: residual_wtx_graft_fd8_tip_highlight_launch,
    record_pack: residual_wtx_graft_fd8_tip_record_pack,
  };

  const residual_wtx_graft_db8_tip_draft_gate = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    parent_excerpt: "<p>Parent body on scaling laws</p>",
    sources: [
...
const residual_graftx_mo6_outer_mo = {
    operator_id: "op-1",
    work_minutes: 120,
    goals: [
      { goal_id: "g1", title: "Map scaling literature" },
  ...
  const residual_graftx_mo6_outer_settings_pack = {
    settings: residual_sd6_outer_settings,
    competition_pack: residual_sd6_outer_competition_pack,
  };


  const residual_graftx_mk8_outer_market = {
    title: "Scaling Laws Book",
    account_id: "acct-1",
    free_copy_available: true as boolean | null,
    free_html_projection_sha: "sha-free-1",
  ...
  const residual_graftx_mk8_outer_mo_pack = {
    mo: residual_graftx_mo6_outer_mo,
    settings_pack: residual_graftx_mo6_outer_settings_pack,
  };


  const residual_graftx_hn7_outer_html_view = {
    session_id: "sess-1",
    asset_id: "book-1",
    html_projection_sha: "sha-free-1",
    view_requested: true,
  ...
  const residual_graftx_hn7_outer_market_pack = {
    market: residual_graftx_mk8_outer_market,
    mo_pack: residual_graftx_mk8_outer_mo_pack,
  };


  const residual_graftx_ts7_outer_twin_records = [
    {
      twin_id: "twin-book-1",
      parent_asset_id: "book-1",
      insights: ["scaling laws hold under noise in compute-optimal regimes"],
  ...
  const residual_graftx_ts7_outer_html_pack = {
    html_view: residual_graftx_hn7_outer_html_view,
    market_pack: residual_graftx_hn7_outer_market_pack,
  };


  const residual_graftx_md7_outer_decision = {
    models: [
      {
        model_id: "gpt-5.5",
        tier: "frontier",
  ...
  const residual_graftx_md7_outer_twin_search_pack = {
    search_query: "scaling noise",
    twin_records: residual_graftx_ts7_outer_twin_records,
    html_pack: residual_graftx_ts7_outer_html_pack,
  };


  const residual_graftx_ws7_outer_items = [
    {
      record_id: "r1",
      kind: "insight" as const,
      text: "scaling holds under noise in compute-optimal regimes",
  ...
  const residual_graftx_ws7_outer_decision_pack = {
    decision: residual_graftx_md7_outer_decision,
    twin_search_pack: residual_graftx_md7_outer_twin_search_pack,
  };


  const residual_graftx_fd7_outer_highlight_launch = {
    parent_asset_id: "book-1",
    highlight: "scaling laws under noise",
    gated: false,
    preferred_view_mode: "floating" as const,
  ...
  const residual_graftx_fd7_outer_record_pack = {
    session_id: "sess-1",
    items: residual_graftx_ws7_outer_items,
    decision_pack: residual_graftx_ws7_outer_decision_pack,
  };


  const residual_graftx_cm7_outer_multiselect = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    members: [
      {
  ...
  const residual_graftx_cm7_outer_floating_pack = {
    highlight_launch: residual_graftx_fd7_outer_highlight_launch,
    record_pack: residual_graftx_fd7_outer_record_pack,
  };

const residual_graftx_db7_outer_draft_gate = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    parent_excerpt: "<p>Parent body on scaling laws</p>",
    sources: [
  ...
  const residual_graftx_fs7_outer_fullscreen = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    highlight: "scaling laws under noise",
    gated: false,
  ...
  const residual_graftx_fs7_outer_draft_pack = {
    draft_gate: residual_graftx_db7_outer_draft_gate,
    collective_pack: residual_graftx_db7_outer_collective_pack,
  };

const residual_graftx_wt7_outer_write = {
    session_id: "sess-1",
    draft_id: "draft-1",
    parent_asset_id: "book-1",
    twin_slices: [
...
const residual_graftx_sa7_outer_sources = {
  ...
  const residual_graftx_sa7_outer_write_pack = {
    write: residual_graftx_wt7_outer_write,
    fullscreen_pack: residual_graftx_wt7_outer_fullscreen_pack,
  };

const residual_graftx_ab7_outer_weekly_learn = {
    week_id: "2026-W28",
    min_events_per_task: 2,
    events: [
      {
  ...
  const residual_graftx_ab7_outer_source_pack = {
    sources: residual_graftx_sa7_outer_sources,
    write_pack: residual_graftx_sa7_outer_write_pack,
  };

const residual_graftx_rt7_outer_twin = {
    parent_asset_id: "book-1",
    source_excerpt:
      "<p>Scaling laws hold under noise in compute-optimal regimes.</p>",
    focus_questions: ["Where does it break?", "What residual gaps?"],
...
const residual_graftx_rt7_outer_presentation = {
    view_mode: "side_panel" as const,
    open_requested: true,
    merge_to_parent_preview: false,
    presented_insights: [
  ...
  const residual_graftx_rt7_outer_weekly_pack = {
    weekly_learn: residual_graftx_ab7_outer_weekly_learn,
    source_pack: residual_graftx_ab7_outer_source_pack,
  };

const residual_graftx_nds7_outer_nd_shadow = {
    selected_model_id: "gpt-5.5",
    nd_recommended_model_id: "claude-opus",
    kill_switch_on: true,
    confidence: 0.72,
  ...
  const residual_graftx_nds7_outer_twin_presentation = {
    twin: residual_graftx_rt7_outer_twin,
    presentation: residual_graftx_rt7_outer_presentation,
    weekly_pack: residual_graftx_rt7_outer_weekly_pack,
  };

const residual_graftx_cd7_outer_competition = {
    session_id: "sess-1",
    competitor_decisions: [
      {
        competitor: "Perplexity",
  ...
  const residual_graftx_cd7_outer_nd_pack = {
    nd_shadow: residual_graftx_nds7_outer_nd_shadow,
    twin_presentation: residual_graftx_nds7_outer_twin_presentation,
  };

const residual_graftx_sd7_outer_settings = {
    models: [
      { model_id: "gpt-5.5", provider: "openai" },
      { model_id: "grok-4.5", provider: "xai" },
    ],
  ...
  const residual_graftx_sd7_outer_competition_pack = {
    competition: residual_graftx_cd7_outer_competition,
    nd_pack: residual_graftx_cd7_outer_nd_pack,
  };

  const residual_graftx_mo7_outer_mo = {
    operator_id: "op-1",
    work_minutes: 120,
    goals: [
      { goal_id: "g1", title: "Map scaling literature" },
  ...
  const residual_graftx_mo7_outer_settings_pack = {
    settings: residual_graftx_sd7_outer_settings,
    competition_pack: residual_graftx_sd7_outer_competition_pack,
  };

  const residual_graftx_mkt7_tip_market = {
    title: "Scaling Laws Book",
    account_id: "acct-1",
    free_copy_available: true as boolean | null,
    free_html_projection_sha: "sha-free-1",
  ...
  const residual_graftx_mkt7_tip_mo_pack = {
    mo: residual_graftx_mo7_outer_mo,
    settings_pack: residual_graftx_mo7_outer_settings_pack,
  };

  const residual_graftx_hn8_tip_html_view = {
    session_id: "sess-1",
    asset_id: "book-1",
    html_projection_sha: "sha-free-1",
    view_requested: true,
  ...
  const residual_graftx_hn8_tip_market_pack = {
    market: residual_graftx_mkt7_tip_market,
    mo_pack: residual_graftx_mkt7_tip_mo_pack,
  };

  const residual_graftx_ts8_tip_twin_records = [
    {
      twin_id: "twin-book-1",
      parent_asset_id: "book-1",
      insights: ["scaling laws hold under noise in compute-optimal regimes"],
  ...
  const residual_graftx_ts8_tip_html_pack = {
    html_view: residual_graftx_hn8_tip_html_view,
    market_pack: residual_graftx_hn8_tip_market_pack,
  };

  const residual_graftx_md8_tip_decision = {
    models: [
      {
        model_id: "gpt-5.5",
        tier: "frontier",
  ...
  const residual_graftx_md8_tip_twin_search_pack = {
    search_query: "scaling laws",
    twin_records: residual_graftx_ts8_tip_twin_records,
    html_pack: residual_graftx_ts8_tip_html_pack,
  };

  const residual_graftx_ws8_tip_items = [
    {
      record_id: "r1",
      kind: "insight" as const,
      text: "scaling holds under noise in compute-optimal regimes",
  ...
  const residual_graftx_ws8_tip_decision_pack = {
    decision: residual_graftx_md8_tip_decision,
    twin_search_pack: residual_graftx_md8_tip_twin_search_pack,
  };

  const residual_graftx_fd8_tip_highlight_launch = {
    parent_asset_id: "book-1",
    highlight: "scaling laws under noise",
    gated: false,
    preferred_view_mode: "floating" as const,
  ...
  const residual_graftx_fd8_tip_record_pack = {
    session_id: "sess-1",
    items: residual_graftx_ws8_tip_items,
    decision_pack: residual_graftx_ws8_tip_decision_pack,
  };

  const residual_graftx_cm8_tip_multiselect = {
    session_id: "sess-1",
    parent_asset_id: "book-1",
    members: [
      {
  ...
  const residual_graftx_cm8_tip_floating_pack = {
    highlight_launch: residual_graftx_fd8_tip_highlight_launch,
    record_pack: residual_graftx_fd8_tip_record_pack,
  };
...
const residual_fs8_outer_fullscreen = {
  ...
  const residual_fs8_outer_draft_pack = {
    draft_gate: residual_rtx_graft_db8_tip_draft_gate,
    collective_pack: residual_rtx_graft_db8_tip_collective_pack,
  };
...
const residual_rt9_outer_presentation = {
  ...
  const residual_ws10_tip_decision_pack = {
    ...
    twin_search_pack: residual_md10_tip_twin_search_pack,
  };
  ...
  // residual_rt11 tip graft: MoWeekly×10 moniker needs residual_mkt10 through
  // weekly_pack→ab11→sa11→wt11→fs11→…→mkt10
      ...
      competition_pack: {
        ...
        nd_pack: {
          ...
          twin_presentation: {
            ...
            // nest lag: residual_rt10 weekly (not residual_rt11) to avoid TDZ cycle
  ...
  it("twin presentation + weekly pack ready", () => {
    const c = composeRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpack({
      twin: residual_rt10_outer_twin,
      presentation: residual_rt10_outer_presentation,
    ...
    expect(c.presentation.presentation_ready).toBe(true);
    expect(c.weekly_pack.pack_ready).toBe(true);
    ...
    expect(c.authority).toBe("recursive_twin_presentation_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mpack_compose_advisory");
    expect(formatRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpackSummary(c)).toMatch(/twin_written=false|REJECT|pack_ready=true/);
  });
  ...
  it("parent mismatch blocks pack_ready", () => {
    const c = composeRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMpack({
      twin: {
        ...residual_rt10_outer_twin,
    ...
    expect(c.parent_aligned).toBe(false);
    expect(c.pack_ready).toBe(false);
    expect(c.twin_written).toBe(false);
    expect(c.production_router_verdict).toBe("REJECT");
  });
