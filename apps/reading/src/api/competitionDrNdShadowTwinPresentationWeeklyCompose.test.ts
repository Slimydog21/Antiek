...
import {
  ...
  formatCompetitionDrNdShadowTwinPresentationWeeklySummary,
} from "./competitionDrNdShadowTwinPresentationWeeklyCompose";

describe("composeCompetitionDrNdShadowTwinPresentationWeekly", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("competition DR + ND shadow twin presentation weekly pack ready", () => {
    const c = composeCompetitionDrNdShadowTwinPresentationWeekly({
    ...
    expect(
      formatCompetitionDrNdShadowTwinPresentationWeeklySummary(c),
    ).toMatch(/live_dispatch_authorized=false/);
  });
  ...
  it("quality below floor blocks competition and pack", () => {
    const c = composeCompetitionDrNdShadowTwinPresentationWeekly({
      competition: {
        ...residual_competition,
        quality_overall: 0.1,
