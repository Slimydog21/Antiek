 ...
 * (short residual name: SourceAttachWriteTwinFsDraftPack — FS 255 policy).
...
import {
  ...
  type WriteModeTwinCollectiveFullscreenDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinInput,
} from "./writeModeTwinCollectiveFullscreenDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinCompose";

export interface SourceAttachWriteTwinFsDraftPackInput {
  sources: Omit<HtmlNativeSourceAttachInput, "operator_ack">;
  write_pack: Omit<
    WriteModeTwinCollectiveFullscreenDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinInput,
    "operator_ack"
  >;
...
export interface SourceAttachWriteTwinFsDraftPackCompose {
  session_id: string;
  ...
  write_pack: WriteModeTwinCollectiveFullscreenDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinCompose;
  ...
  notes: string[];
  authority: "source_attach_write_twin_fs_draft_pack_compose_advisory";
}
...
/**
 * HTML-native source attach stacked on write twin fullscreen draft-before-merge pack.
 * Never remote-fetches; never PDF; ND REJECT.
 */
export function composeSourceAttachWriteTwinFsDraftPack(
  input: SourceAttachWriteTwinFsDraftPackInput,
): SourceAttachWriteTwinFsDraftPackCompose {
  ...
  const write_pack = composeWriteModeTwinCollectiveFullscreenDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationRecordModelDecisionTwinSearchHtmlNativeMarketplaceFreeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin({
    ...input.write_pack,
    operator_ack: input.operator_ack,
  });
  ...
  return {
    ...
    notes,
    authority:
      "source_attach_write_twin_fs_draft_pack_compose_advisory",
  };
}

export function formatSourceAttachWriteTwinFsDraftPackSummary(
  c: SourceAttachWriteTwinFsDraftPackCompose,
): string {
  return (
