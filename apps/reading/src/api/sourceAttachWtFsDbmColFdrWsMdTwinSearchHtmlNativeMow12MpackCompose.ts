...
import {
  composeWriteModeTwinFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack,
  type WriteModeTwinFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose,
  type WriteModeTwinFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput,
} from "./writeModeTwinFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose";

export interface SourceAttachWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput {
  sources: Omit<HtmlNativeSourceAttachInput, "operator_ack">;
  write_pack: Omit<WriteModeTwinFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput, "operator_ack">;
  operator_ack: boolean;
  require_both?: boolean;
}

export interface SourceAttachWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose {
  session_id: string;
  ...
  write_pack: WriteModeTwinFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose;
  ...
  notes: string[];
  authority: "source_attach_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpack_compose_advisory";
}
 ...
 */
export function composeSourceAttachWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack(
  input: SourceAttachWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput,
): SourceAttachWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose {
  ...
  const write_pack = composeWriteModeTwinFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack({
    ...input.write_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatSourceAttachWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackSummary(
  c: SourceAttachWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose,
): string {
  return (
