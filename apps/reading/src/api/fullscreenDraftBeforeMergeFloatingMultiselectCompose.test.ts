...
describe("composeFullscreenDraftBeforeMergeFloatingMultiselect", () => {
  ...
  it("fullscreen + draft-before-merge multi-select model decision pack ready", () => {
    const c = composeFullscreenDraftBeforeMergeFloatingMultiselect({
    ...
    expect(
      formatFullscreenDraftBeforeMergeFloatingMultiselectSummary(c),
  ...
  it("would_exceed on nested decision blocks overall", () => {
    ...
    expect(c.draft_pack.multi_pack.decision_pack.decision.would_exceed).toBe(
      true,
    );
