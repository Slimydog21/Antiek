...
import {
  ...
  formatDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWritePackSummary,
} from "./draftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

describe("composeDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("draft-before-merge + collective floating DR MO weekly src write pack ready", () => {
    const c = composeDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
  ...
  it("parent mismatch on draft sources blocks pack_ready", () => {
    const c = composeDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWritePack({
      draft_gate: {
        ...
        sources: residual_db2_outer_draft_gate.sources.map((s) => ({
          ...s,
          parent_asset_id: "book-other",
        })),
      },
