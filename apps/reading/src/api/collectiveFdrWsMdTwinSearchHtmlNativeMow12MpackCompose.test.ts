...
describe("composeCollectiveFdrWsMdTwinSearchHtmlNativeMow12Mpack", () => {
const WEEKLY_ND = {
  weekly_learn: {
    week_id: "2026-W28",
...
const residual_ts10_tip_twin_records = [
  ...
  it("collective + floating DR + workstation pack ready", () => {
    const c = composeCollectiveFdrWsMdTwinSearchHtmlNativeMow12Mpack({
    ...
    expect(formatCollectiveFdrWsMdTwinSearchHtmlNativeMow12MpackSummary(c)).toMatch(/REJECT|pack_ready=true/);
  });
  ...
  it("session misalign blocks pack under require_both", () => {
    const c = composeCollectiveFdrWsMdTwinSearchHtmlNativeMow12Mpack({
      multiselect: { ...residual_col_multiselect, session_id: "sess-OTHER" },
      floating_pack: residual_col_floating_pack,
      operator_ack: true,
    });
