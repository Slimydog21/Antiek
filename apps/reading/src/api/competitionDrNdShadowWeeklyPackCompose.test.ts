...
describe("composeCompetitionDrNdShadowWeeklyPack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("competition DR + ND shadow weekly pack ready", () => {
    const c = composeCompetitionDrNdShadowWeeklyPack({
    ...
    expect(c.authority).toBe("competition_dr_nd_shadow_weekly_pack_compose_advisory");
    expect(formatCompetitionDrNdShadowWeeklyPackSummary(c)).toMatch(/live_dispatch_authorized=false|REJECT|remote_fetched=false/);
  });
