...
import {
  composeDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePack,
  type DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePackCompose,
  type DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePackInput,
} from "./draftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePackCompose";

export interface FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackInput {
  fullscreen: Omit<FloatingFullscreenOpenInput, "operator_ack">;
  draft_pack: Omit<
    DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackCompose {
  week_id: string;
  session_id: string;
  ...
  draft_pack: DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePackCompose;
  ...
  notes: string[];
  authority: "fullscreen_open_draft_before_merge_collective_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePack(
  input: FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackInput,
): FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackCompose {
  ...
  return {
    ...
    notes,
    authority:
      "fullscreen_open_draft_before_merge_collective_mo_weekly_src_write_pack_compose_advisory",
  };
}

export function formatFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackSummary(
  c: FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackCompose,
): string {
  return (
