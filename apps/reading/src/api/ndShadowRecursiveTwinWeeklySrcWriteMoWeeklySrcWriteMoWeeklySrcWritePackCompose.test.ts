...
import {
  ...
  formatNdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary,
} from "./ndShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

describe("composeNdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("ND shadow REJECT + recursive twin weekly MO weekly src write pack ready", () => {
    const c = composeNdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatNdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
    ).toMatch(/nd_verdict=REJECT/);
  });
  ...
  it("parent mismatch on twin blocks pack_ready", () => {
    const c = composeNdShadowRecursiveTwinWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
      nd_shadow: residual_nds2_outer_nd_shadow,
      twin_presentation: {
        ...residual_nds2_outer_twin_presentation,
        twin: {
