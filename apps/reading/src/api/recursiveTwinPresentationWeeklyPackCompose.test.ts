...
describe("composeRecursiveTwinPresentationWeeklyPack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("twin presentation + weekly pack ready", () => {
    const c = composeRecursiveTwinPresentationWeeklyPack({
    ...
    expect(c.authority).toBe("recursive_twin_presentation_weekly_pack_compose_advisory");
    expect(formatRecursiveTwinPresentationWeeklyPackSummary(c)).toMatch(/twin_written=false/);
  });
