...
describe("composeDraftBeforeMergeFloatingMultiselectModelDecision", () => {
  ...
  it("draft-before-merge + floating multi-select model decision pack ready", () => {
    const c = composeDraftBeforeMergeFloatingMultiselectModelDecision({
    ...
    expect(
      formatDraftBeforeMergeFloatingMultiselectModelDecisionSummary(c),
