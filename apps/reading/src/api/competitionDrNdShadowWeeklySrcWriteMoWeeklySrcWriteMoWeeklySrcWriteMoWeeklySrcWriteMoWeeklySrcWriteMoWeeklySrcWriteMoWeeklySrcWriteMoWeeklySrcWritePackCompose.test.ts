...
import {
  ...
  formatCompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary,
...
describe("composeCompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
const WEEKLY_ND = {
  weekly_learn: {
    week_id: "2026-W28",
...
const residual_cd7_outer_competition = {
  ...
  it("competition DR + ND shadow pack ready", () => {
    const c = composeCompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
      competition: residual_cd7_outer_competition,
      nd_pack: residual_cd7_outer_nd_pack,
      operator_ack: true,
    });
    expect(c.competition.pack_ready).toBe(true);
    ...
    expect(c.authority).toBe(
      "competition_dr_nd_shadow_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory",
    );
    expect(
      formatCompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
    ).toMatch(/REJECT|pack_ready=true|remote_fetched=false/);
  });
  ...
  it("would_exceed true blocks pack under require_both", () => {
    const c = composeCompetitionDrNdShadowWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
      competition: {
        ...residual_cd7_outer_competition,
        would_exceed: true,
