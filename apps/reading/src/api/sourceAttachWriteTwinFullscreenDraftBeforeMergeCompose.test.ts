...
describe("composeSourceAttachWriteTwinFullscreenDraftBeforeMerge", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("source attach + write twin fullscreen draft-before-merge pack ready", () => {
    const c = composeSourceAttachWriteTwinFullscreenDraftBeforeMerge({
    ...
    expect(
      formatSourceAttachWriteTwinFullscreenDraftBeforeMergeSummary(c),
