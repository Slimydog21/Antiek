...
import {
  composeSettingsDecisionCdNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack,
  type SettingsDecisionCdNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose,
  type SettingsDecisionCdNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput,
} from "./settingsDecisionCdNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose";

export interface MoSdCdNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput {
  mo: Omit<MidnightOilPriceCeilingApprovalInput, "operator_ack">;
  settings_pack: Omit<
    SettingsDecisionCdNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput,
    "operator_ack"
  >;
...
export interface MoSdCdNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose {
  week_id: string;
  session_id: string;
  ...
  settings_pack: SettingsDecisionCdNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose;
  pack_ready: boolean;
  ...
  notes: string[];
  authority: "mo_sd_cd_nds_rt_ab_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpack_compose_advisory";
}
 ...
 */
export function composeMoSdCdNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack(
  input: MoSdCdNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput,
): MoSdCdNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose {
  ...
  const settings_pack = composeSettingsDecisionCdNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack({
    ...input.settings_pack,
    operator_ack: input.operator_ack,
  });
  ...
  return {
    ...
    notes,
    authority:
      "mo_sd_cd_nds_rt_ab_sa_wt_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpack_compose_advisory",
  };
}

export function formatMoSdCdNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackSummary(
  c: MoSdCdNdsRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose,
): string {
  return (
