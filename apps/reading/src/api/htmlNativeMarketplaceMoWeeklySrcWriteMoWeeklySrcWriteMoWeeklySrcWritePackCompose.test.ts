...
describe("composeHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("HTML-native + marketplace free Midnight Oil weekly pack ready", () => {
    const c = composeHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
  ...
  it("claimed_format pdf still pdf_primary false", () => {
    const c = composeHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
      html_view: {
        ...residual_hn3_outer_html_view,
