...
import {
  ...
  type CollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWritePackInput,
} from "./collectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

export interface DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWritePackInput {
  draft_gate: Omit<FloatingDraftBeforeFullMergeGateInput, "operator_ack">;
  collective_pack: Omit<
    CollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "draft_before_merge_collective_floating_dr_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWritePack(
  input: DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWritePackInput,
  ...
  const collective_pack = composeCollectiveMultiselectFloatingDrWorkstationMoWeeklySrcWriteMoWeeklySrcWritePack(
    {
...
export function formatDraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWriteMoWeeklySrcWritePackSummary(
