...
import {
  composeSettingsDecisionCompetitionDrNdShadowRecursiveTwinPresentationWeekly,
  type SettingsDecisionCompetitionDrNdShadowRecursiveTwinPresentationWeeklyCompose,
  type SettingsDecisionCompetitionDrNdShadowRecursiveTwinPresentationWeeklyInput,
} from "./settingsDecisionCompetitionDrNdShadowRecursiveTwinPresentationWeeklyCompose";

export interface MidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinInput {
  mo: Omit<MidnightOilPriceCeilingApprovalInput, "operator_ack">;
  settings_pack: Omit<
    SettingsDecisionCompetitionDrNdShadowRecursiveTwinPresentationWeeklyInput,
    "operator_ack"
  >;
...
export interface MidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinCompose {
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "midnight_oil_settings_decision_competition_dr_nd_shadow_recursive_twin_compose_advisory";
}
 ...
 */
export function composeMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwin(
  input: MidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinInput,
  ...
  const settings_pack = composeSettingsDecisionCompetitionDrNdShadowRecursiveTwinPresentationWeekly({
    ...input.settings_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatMidnightOilSettingsDecisionCompetitionDrNdShadowRecursiveTwinSummary(
