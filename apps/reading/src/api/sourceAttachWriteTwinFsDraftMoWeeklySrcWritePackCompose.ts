...
import {
  composeWriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePack,
  type WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePackCompose,
  type WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePackInput,
} from "./writeModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePackCompose";

export interface SourceAttachWriteTwinFsDraftMoWeeklySrcWritePackInput {
  sources: Omit<HtmlNativeSourceAttachInput, "operator_ack">;
  write_pack: Omit<
    WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface SourceAttachWriteTwinFsDraftMoWeeklySrcWritePackCompose {
  session_id: string;
  ...
  write_pack: WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePackCompose;
  ...
  notes: string[];
  authority: "source_attach_write_twin_fs_draft_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeSourceAttachWriteTwinFsDraftMoWeeklySrcWritePack(
  input: SourceAttachWriteTwinFsDraftMoWeeklySrcWritePackInput,
  ...
  const write_pack = composeWriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWritePack({
    ...input.write_pack,
    operator_ack: input.operator_ack,
  });
  ...
  return {
    ...
    notes,
    authority:
      "source_attach_write_twin_fs_draft_mo_weekly_src_write_pack_compose_advisory",
  };
}

export function formatSourceAttachWriteTwinFsDraftMoWeeklySrcWritePackSummary(
  c: SourceAttachWriteTwinFsDraftMoWeeklySrcWritePackCompose,
): string {
  return (
