 ...
 * src write pack (short residual: TwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePack
 * — FS 255).
 *
...
import {
  composeHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePack,
  type HtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
  type HtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackInput,
} from "./htmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

export interface TwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackInput {
  search_query: string;
  twin_records: TwinSearchRecord[];
  search_limit?: number;
  html_pack: Omit<
    HtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface TwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "twin_search_html_native_marketplace_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeTwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePack(
  input: TwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackInput,
  ...
  const html_pack = composeHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...input.html_pack,
...
export function formatTwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackSummary(
