...
describe("composeAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("weekly learn + source attach write twin FS draft MO weekly src write pack ready", () => {
    const c = composeAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
  ...
  it("session mismatch blocks pack_ready", () => {
    const c = composeAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
      weekly_learn: residual_ab3_outer_weekly_learn,
      source_pack: {
        ...residual_ab3_outer_source_pack,
        sources: {
          ...residual_ab3_outer_source_pack.sources,
