...
import {
  composeFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWritePack,
  type FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
  type FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackInput,
} from "./fullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

export interface WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackInput {
  write: Omit<WriteModeTwinCollectiveAnalysisInput, "operator_ack">;
  fullscreen_pack: Omit<
    FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  week_id: string;
  session_id: string;
  ...
  notes: string[];
  authority: "write_mode_twin_fullscreen_draft_collective_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeWriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePack(
  input: WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackInput,
...
export function formatWriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackSummary(
