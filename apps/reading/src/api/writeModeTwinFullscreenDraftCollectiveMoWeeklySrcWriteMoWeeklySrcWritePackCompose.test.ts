...
describe("composeWriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("write-mode twin + fullscreen draft collective MO weekly src write pack ready", () => {
    const c = composeWriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatWriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
  ...
  it("parent mismatch on write blocks pack under require_both", () => {
    const c = composeWriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePack({
      write: {
        ...
        twin_slices: [
          {
            ...residual_wt2_outer_write.twin_slices[0],
            parent_asset_id: "book-other",
          },
          {
            ...residual_wt2_outer_write.twin_slices[1],
            parent_asset_id: "book-other-slice-2",
          },
        ],
        chase_slots: residual_wt2_outer_write.chase_slots.map((s) => ({
          ...s,
          parent_asset_id: "book-other",
        })),
      },
