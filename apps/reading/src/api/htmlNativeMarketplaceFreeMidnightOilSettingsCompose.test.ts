...
import {
  ...
  formatHtmlNativeMarketplaceFreeMidnightOilSettingsSummary,
} from "./htmlNativeMarketplaceFreeMidnightOilSettingsCompose";

describe("composeHtmlNativeMarketplaceFreeMidnightOilSettings", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("HTML-native + marketplace free MO settings pack ready", () => {
    const c = composeHtmlNativeMarketplaceFreeMidnightOilSettings({
    ...
    expect(
      formatHtmlNativeMarketplaceFreeMidnightOilSettingsSummary(c),
