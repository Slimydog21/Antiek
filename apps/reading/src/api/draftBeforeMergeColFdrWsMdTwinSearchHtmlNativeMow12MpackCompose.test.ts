...
describe("composeDraftBeforeMergeColFdrWsMdTwinSearchHtmlNativeMow12Mpack", () => {
const WEEKLY_ND = {
  weekly_learn: {
    week_id: "2026-W28",
...
const residual_ts10_tip_twin_records = [
  ...
  it("draft-before-merge + collective pack ready", () => {
    const c = composeDraftBeforeMergeColFdrWsMdTwinSearchHtmlNativeMow12Mpack({
    ...
    expect(formatDraftBeforeMergeColFdrWsMdTwinSearchHtmlNativeMow12MpackSummary(c)).toMatch(/REJECT|pack_ready=true/);
  });
  ...
  it("session misalign blocks pack under require_both", () => {
    const c = composeDraftBeforeMergeColFdrWsMdTwinSearchHtmlNativeMow12Mpack({
      draft_gate: { ...residual_dbm_draft_gate, session_id: "sess-OTHER" },
      collective_pack: residual_dbm_collective_pack,
      operator_ack: true,
    });
