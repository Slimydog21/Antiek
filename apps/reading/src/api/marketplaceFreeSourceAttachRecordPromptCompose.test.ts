...
describe("composeMarketplaceFreeSourceAttachRecordPrompt", () => {
  it("free HTML port + research pack ready", () => {
    const c = composeMarketplaceFreeSourceAttachRecordPrompt({
      market: MARKET,
      research: RESEARCH,
      operator_ack: true,
    });
    ...
    expect(formatMarketplaceFreeSourceAttachRecordPromptSummary(c)).toMatch(
  ...
  it("unknown free blocks market port", () => {
    const c = composeMarketplaceFreeSourceAttachRecordPrompt({
      market: {
        ...MARKET,
