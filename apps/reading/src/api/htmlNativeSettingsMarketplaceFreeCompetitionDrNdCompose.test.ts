...
describe("composeHtmlNativeSettingsMarketplaceFreeCompetitionDrNd", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("HTML-native view + settings marketplace free competition DR ND pack ready", () => {
    const c = composeHtmlNativeSettingsMarketplaceFreeCompetitionDrNd({
    ...
    expect(
      formatHtmlNativeSettingsMarketplaceFreeCompetitionDrNdSummary(c),
  ...
  it("asset mismatch blocks parent alignment", () => {
    const c = composeHtmlNativeSettingsMarketplaceFreeCompetitionDrNd({
      html_view: {
        ...pack_outer_html_view,
        asset_id: "other-book",
