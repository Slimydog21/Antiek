...
import {
  ...
  formatMarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary,
...
describe("composeMarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  const residual_mk6_outer_market_pre0 = {
    title: "Scaling Laws Book",
    account_id: "acct-1",
    free_copy_available: true as boolean | null,
    free_html_projection_sha: "sha-free-1",
  ...
  const residual_mk6_outer_mo_pack_pre0 = {
  ...
  const residual_hn4_outer_market_pack = {
    market: residual_mk6_outer_market_pre0,
    mo_pack: residual_mk6_outer_mo_pack_pre0,
  };
  ...
  it("marketplace free + Midnight Oil settings pack ready", () => {
    const c = composeMarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...
    expect(
      formatMarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(c),
  ...
  it("no free copy blocks pack_ready", () => {
    const c = composeMarketplaceFreeMoSettingsWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
      market: {
        ...residual_mk7_outer_market,
