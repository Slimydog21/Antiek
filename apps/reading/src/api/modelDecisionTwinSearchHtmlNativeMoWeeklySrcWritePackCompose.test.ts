...
import {
  ...
  formatModelDecisionTwinSearchHtmlNativeMoWeeklySrcWritePackSummary,
} from "./modelDecisionTwinSearchHtmlNativeMoWeeklySrcWritePackCompose";

describe("composeModelDecisionTwinSearchHtmlNativeMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("model decision + twin search HTML-native marketplace MO weekly src write pack ready", () => {
    const c = composeModelDecisionTwinSearchHtmlNativeMoWeeklySrcWritePack({
    ...
    expect(
      formatModelDecisionTwinSearchHtmlNativeMoWeeklySrcWritePackSummary(c),
  ...
  it("empty twin hits block twin_search_pack and pack under require_both", () => {
    const c = composeModelDecisionTwinSearchHtmlNativeMoWeeklySrcWritePack({
      decision: residual_md_outer_decision,
      twin_search_pack: {
        ...residual_md_outer_twin_search_pack,
        twin_records: [],
      },
      operator_ack: true,
    });
