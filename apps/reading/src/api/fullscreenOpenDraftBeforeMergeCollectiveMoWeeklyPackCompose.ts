...
import {
  composeDraftBeforeMergeCollectiveFloatingDrMoWeeklyPack,
  type DraftBeforeMergeCollectiveFloatingDrMoWeeklyPackCompose,
  type DraftBeforeMergeCollectiveFloatingDrMoWeeklyPackInput,
} from "./draftBeforeMergeCollectiveFloatingDrMoWeeklyPackCompose";

export interface FullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackInput {
  fullscreen: Omit<FloatingFullscreenOpenInput, "operator_ack">;
  draft_pack: Omit<
    DraftBeforeMergeCollectiveFloatingDrMoWeeklyPackInput,
    "operator_ack"
  >;
...
export interface FullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackCompose {
  week_id: string;
  session_id: string;
  ...
  draft_pack: DraftBeforeMergeCollectiveFloatingDrMoWeeklyPackCompose;
  ...
  notes: string[];
  authority: "fullscreen_open_draft_before_merge_collective_mo_weekly_pack_compose_advisory";
}
...
/**
 * Fullscreen-open stacked on draft-before-merge collective MO weekly pack.
 * Never live-dispatches; never merges; ND REJECT.
 */
export function composeFullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPack(
  input: FullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackInput,
): FullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackCompose {
...
export function formatFullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackSummary(
  c: FullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackCompose,
): string {
  return (
