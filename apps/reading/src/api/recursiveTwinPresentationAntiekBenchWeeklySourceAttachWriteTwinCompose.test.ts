...
import {
  ...
  formatRecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinSummary,
} from "./recursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinCompose";

describe("composeRecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwin", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("twin presentation + weekly source attach write twin pack ready", () => {
    const c = composeRecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwin({
      twin: residual_twin,
    ...
    expect(
      formatRecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinSummary(c),
