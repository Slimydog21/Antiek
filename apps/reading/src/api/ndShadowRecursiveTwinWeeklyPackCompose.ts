 ...
 * (short residual: NdShadowRecursiveTwinWeeklyPack — FS 255 policy; production REJECT).
...
import {
  ...
  type RecursiveTwinPresentationWeeklyPackCompose,
  type RecursiveTwinPresentationWeeklyPackInput,
} from "./recursiveTwinPresentationWeeklyPackCompose";

export interface NdShadowRecursiveTwinWeeklyPackInput {
  nd_shadow: NotDiamondShadowAdvisoryInput;
  twin_presentation: Omit<
    RecursiveTwinPresentationWeeklyPackInput,
    "operator_ack"
  >;
...
export interface NdShadowRecursiveTwinWeeklyPackCompose {
  week_id: string;
  session_id: string;
  ...
  twin_presentation: RecursiveTwinPresentationWeeklyPackCompose;
  pack_ready: boolean;
  ...
  notes: string[];
  authority: "nd_shadow_recursive_twin_weekly_pack_compose_advisory";
}
 ...
 */
export function composeNdShadowRecursiveTwinWeeklyPack(
  input: NdShadowRecursiveTwinWeeklyPackInput,
): NdShadowRecursiveTwinWeeklyPackCompose {
  ...
  return {
    ...
    notes,
    authority:
      "nd_shadow_recursive_twin_weekly_pack_compose_advisory",
  };
}

export function formatNdShadowRecursiveTwinWeeklyPackSummary(
  c: NdShadowRecursiveTwinWeeklyPackCompose,
): string {
  return (
