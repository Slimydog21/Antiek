...
describe("composeWorkstationRecordModelDecisionTwinSearchMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("workstation records + model decision twin search MO weekly src write pack ready", () => {
    const c = composeWorkstationRecordModelDecisionTwinSearchMoWeeklySrcWritePack({
      session_id: "sess-1",
    ...
    expect(
      formatWorkstationRecordModelDecisionTwinSearchMoWeeklySrcWritePackSummary(c),
