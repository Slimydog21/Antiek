...
describe("composeCompetitionDrMarketplaceFreeBenchMo", () => {
  const twin_pack = {
    twin: {
      parent_asset_id: "book-1",
      source_excerpt:
  ...
  it("competition DR + free marketplace bench MO pack ready", () => {
    const c = composeCompetitionDrMarketplaceFreeBenchMo({
      competition,
      free_pack: {
        market,
        bench_mo: {
    ...
    expect(c.free_pack.pack_ready).toBe(true);
    ...
    expect(
      formatCompetitionDrMarketplaceFreeBenchMoSummary(c),
  ...
  it("quality below floor blocks competition and overall", () => {
    const c = composeCompetitionDrMarketplaceFreeBenchMo({
      competition: {
        ...competition,
        quality_overall: 0.1,
