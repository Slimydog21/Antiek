...
import {
  composeAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWritePack,
  type AntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
  type AntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWritePackInput,
} from "./antiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

export interface RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput {
  twin: Omit<RecursiveTwinNoteTakerInput, "operator_ack">;
  presentation: TwinPresentationSurfaceInput;
  weekly_pack: Omit<
    AntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  week_id: string;
  session_id: string;
  ...
  weekly_pack: AntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWritePackCompose;
  ...
  notes: string[];
  authority: "recursive_twin_presentation_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack(
  input: RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
): RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  ...
  const weekly_pack = composeAntiekBenchWeeklySrcWriteFsDraftMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...input.weekly_pack,
    operator_ack: input.operator_ack,
  });
  ...
  return {
    ...
    notes,
    authority:
      "recursive_twin_presentation_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory",
  };
}

export function formatRecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(
  c: RecursiveTwinPresentationWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
): string {
  return (
