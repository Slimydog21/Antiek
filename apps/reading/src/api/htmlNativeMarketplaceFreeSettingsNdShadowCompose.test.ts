...
describe("composeHtmlNativeMarketplaceFreeSettingsNdShadow", () => {
  ...
  it("HTML-native view + marketplace free settings ND pack ready", () => {
    const c = composeHtmlNativeMarketplaceFreeSettingsNdShadow({
    ...
    expect(
      formatHtmlNativeMarketplaceFreeSettingsNdShadowSummary(c),
  ...
  it("pdf claim on html_view blocks overall", () => {
    const c = composeHtmlNativeMarketplaceFreeSettingsNdShadow({
      html_view: {
        ...html_view_input,
        claimed_format: "pdf",
