...
describe("composeTwinSearchHtmlNativeMarketplaceFreeSettings", () => {
  ...
  it("twin search + HTML-native marketplace free settings pack ready", () => {
    const c = composeTwinSearchHtmlNativeMarketplaceFreeSettings({
      search_query: "scaling noise",
    ...
    expect(
      formatTwinSearchHtmlNativeMarketplaceFreeSettingsSummary(c),
  ...
  it("session mismatch in nested html_view blocks overall", () => {
    const c = composeTwinSearchHtmlNativeMarketplaceFreeSettings({
      search_query: "scaling noise",
      twin_records: twin_search_records,
      html_pack: {
        html_view: { ...html_view_auth_input, session_id: "sess-other" },
        market_pack,
      },
      operator_ack: true,
    });
