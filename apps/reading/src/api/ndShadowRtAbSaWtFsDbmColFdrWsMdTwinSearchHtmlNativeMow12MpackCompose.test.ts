...
describe("composeNdShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack", () => {
const WEEKLY_ND = {
  weekly_learn: {
    week_id: "2026-W28",
...
const residual_ts10_tip_twin_records = [
  ...
  it("ND shadow REJECT + recursive twin presentation pack ready", () => {
    const c = composeNdShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack({
    ...
    expect(formatNdShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackSummary(c)).toMatch(/REJECT|pack_ready=true/);
  });
  ...
  it("session misalign blocks pack under require_both", () => {
    const c = composeNdShadowRtAbSaWtFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack({
      nd_shadow: residual_nds_shadow,
      twin_presentation: {
        ...residual_nds_twin_presentation,
        weekly_pack: {
          ...residual_rt_weekly_pack,
          source_pack: {
            ...residual_ab_source_pack,
            sources: { ...residual_sa_sources, session_id: "sess-OTHER" },
          },
        },
      },
      operator_ack: true,
