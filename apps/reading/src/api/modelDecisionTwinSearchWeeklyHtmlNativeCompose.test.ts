...
describe("composeModelDecisionTwinSearchWeeklyHtmlNative", () => {
  const twin_pack = {
    twin: {
      parent_asset_id: "book-1",
      source_excerpt:
  ...
  it("model decision + twin search weekly pack ready", () => {
    const c = composeModelDecisionTwinSearchWeeklyHtmlNative({
      decision,
      twin_search_pack: {
    ...
    expect(
      formatModelDecisionTwinSearchWeeklyHtmlNativeSummary(c),
  ...
  it("budget exceed blocks pack_ready", () => {
    const c = composeModelDecisionTwinSearchWeeklyHtmlNative({
      decision: {
        ...decision,
        spent_usd: 49,
  ...
  it("zero search hits blocks twin pack and overall", () => {
    const c = composeModelDecisionTwinSearchWeeklyHtmlNative({
      decision,
      twin_search_pack: {
