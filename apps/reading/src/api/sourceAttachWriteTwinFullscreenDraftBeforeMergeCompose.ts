...
import {
  composeWriteModeTwinCollectiveFullscreenDraftBeforeMerge,
  type WriteModeTwinCollectiveFullscreenDraftBeforeMergeCompose,
  type WriteModeTwinCollectiveFullscreenDraftBeforeMergeInput,
} from "./writeModeTwinCollectiveFullscreenDraftBeforeMergeCompose";

export interface SourceAttachWriteTwinFullscreenDraftBeforeMergeInput {
  sources: Omit<HtmlNativeSourceAttachInput, "operator_ack">;
  write_pack: Omit<
    WriteModeTwinCollectiveFullscreenDraftBeforeMergeInput,
    "operator_ack"
  >;
...
export interface SourceAttachWriteTwinFullscreenDraftBeforeMergeCompose {
  session_id: string;
  ...
  write_pack: WriteModeTwinCollectiveFullscreenDraftBeforeMergeCompose;
  ...
  notes: string[];
  authority: "source_attach_write_twin_fullscreen_draft_before_merge_compose_advisory";
}
 ...
 */
export function composeSourceAttachWriteTwinFullscreenDraftBeforeMerge(
  input: SourceAttachWriteTwinFullscreenDraftBeforeMergeInput,
): SourceAttachWriteTwinFullscreenDraftBeforeMergeCompose {
  ...
  const write_pack = composeWriteModeTwinCollectiveFullscreenDraftBeforeMerge({
    ...input.write_pack,
    operator_ack: input.operator_ack,
  });
  ...
  return {
    ...
    notes,
    authority:
      "source_attach_write_twin_fullscreen_draft_before_merge_compose_advisory",
  };
}

export function formatSourceAttachWriteTwinFullscreenDraftBeforeMergeSummary(
  c: SourceAttachWriteTwinFullscreenDraftBeforeMergeCompose,
): string {
  return (
