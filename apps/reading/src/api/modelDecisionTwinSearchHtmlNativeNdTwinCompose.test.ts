...
describe("composeModelDecisionTwinSearchHtmlNativeNdTwin", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("model decision + twin search HTML-native ND twin pack ready", () => {
    const c = composeModelDecisionTwinSearchHtmlNativeNdTwin({
    ...
    expect(
      formatModelDecisionTwinSearchHtmlNativeNdTwinSummary(c),
  ...
  it("would_exceed blocks pack_ready under default budget gate", () => {
    const c = composeModelDecisionTwinSearchHtmlNativeNdTwin({
      decision: {
  ...
  it("empty twin hits block twin_search readiness", () => {
    const c = composeModelDecisionTwinSearchHtmlNativeNdTwin({
      decision: outer_decision_input,
      twin_search_pack: {
        ...outer_twin_search_pack,
        twin_records: [],
      },
      operator_ack: true,
    });
