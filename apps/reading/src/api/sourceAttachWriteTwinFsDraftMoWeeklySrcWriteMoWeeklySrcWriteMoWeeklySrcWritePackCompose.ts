...
import {
  composeWriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack,
  type WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
  type WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
} from "./writeModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose";

export interface SourceAttachWriteTwinFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput {
  sources: Omit<HtmlNativeSourceAttachInput, "operator_ack">;
  write_pack: Omit<
    WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
    "operator_ack"
  >;
...
export interface SourceAttachWriteTwinFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose {
  session_id: string;
  ...
  notes: string[];
  authority: "source_attach_write_twin_fs_draft_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory";
}
 ...
 */
export function composeSourceAttachWriteTwinFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack(
  input: SourceAttachWriteTwinFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackInput,
  ...
  const write_pack = composeWriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePack({
    ...input.write_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatSourceAttachWriteTwinFsDraftMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackSummary(
