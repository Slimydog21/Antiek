...
describe("composeMarketplaceFreeMidnightOilSettingsDecision", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("marketplace free + MO settings decision pack ready", () => {
    const c = composeMarketplaceFreeMidnightOilSettingsDecision({
    ...
    expect(
      formatMarketplaceFreeMidnightOilSettingsDecisionSummary(c),
