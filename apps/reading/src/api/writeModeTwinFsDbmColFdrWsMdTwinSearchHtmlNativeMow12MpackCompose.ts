...
import {
  ...
  type FullscreenOpenDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput,
} from "./fullscreenOpenDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose";

export interface WriteModeTwinFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput {
  write: Omit<WriteModeTwinCollectiveAnalysisInput, "operator_ack">;
  fullscreen_pack: Omit<FullscreenOpenDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput, "operator_ack">;
  operator_ack: boolean;
  require_both?: boolean;
}

export interface WriteModeTwinFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose {
  week_id: string;
  session_id: string;
  ...
  fullscreen_pack: FullscreenOpenDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose;
  ...
  notes: string[];
  authority: "write_mode_twin_fs_dbm_col_fdr_ws_md_twin_search_html_native_mow12_mpack_compose_advisory";
}
 ...
 */
export function composeWriteModeTwinFsDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack(
  input: WriteModeTwinFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackInput,
): WriteModeTwinFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose {
  ...
  const fullscreen_pack = composeFullscreenOpenDbmColFdrWsMdTwinSearchHtmlNativeMow12Mpack({
...
export function formatWriteModeTwinFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackSummary(
  c: WriteModeTwinFsDbmColFdrWsMdTwinSearchHtmlNativeMow12MpackCompose,
): string {
  return (
