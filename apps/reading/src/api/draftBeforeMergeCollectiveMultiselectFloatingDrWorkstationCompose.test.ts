...
describe("composeDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstation", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("draft-before-merge + collective multiselect floating DR workstation pack ready", () => {
    const c = composeDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstation({
    ...
    expect(
      formatDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationSummary(c),
  ...
  it("parent mismatch blocks pack_ready", () => {
    const c = composeDraftBeforeMergeCollectiveMultiselectFloatingDrWorkstation({
      draft_gate: {
        ...
        sources: residual_outer_draft_gate.sources.map((s) => ({
          ...s,
          parent_asset_id: "book-other",
        })),
      },
