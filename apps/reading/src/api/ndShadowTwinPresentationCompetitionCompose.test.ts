...
describe("composeNdShadowTwinPresentationCompetition", () => {
  const twin_pack = {
    twin: {
      parent_asset_id: "book-1",
      source_excerpt:
  ...
  it("ND shadow REJECT + twin presentation pack ready", () => {
    const c = composeNdShadowTwinPresentationCompetition({
      nd_shadow,
      twin_presentation: {
        twin: twin_input,
    ...
    expect(
      formatNdShadowTwinPresentationCompetitionSummary(c),
  ...
  it("twin presentation open false blocks overall", () => {
    const c = composeNdShadowTwinPresentationCompetition({
      nd_shadow,
      twin_presentation: {
        twin: twin_input,
  ...
  it("ND shadow kill switch off still REJECT and never live-routes", () => {
    const c = composeNdShadowTwinPresentationCompetition({
