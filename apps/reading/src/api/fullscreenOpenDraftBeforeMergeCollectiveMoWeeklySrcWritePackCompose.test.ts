...
describe("composeFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePack", () => {
...
const COMPETITION_CITATIONS = [
  ...
  it("fullscreen + draft-before-merge collective MO weekly src write pack ready", () => {
    const c = composeFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePack({
    ...
    expect(
      formatFullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackSummary(c),
