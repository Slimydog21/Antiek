...
import {
  ...
  type NdShadowRecursiveTwinWeeklySrcWriteMoWeeklyPackCompose,
  type NdShadowRecursiveTwinWeeklySrcWriteMoWeeklyPackInput,
} from "./ndShadowRecursiveTwinWeeklySrcWriteMoWeeklyPackCompose";

export interface CompetitionDrNdShadowWeeklySrcWriteMoWeeklyPackInput {
  competition: Omit<CompetitionDrQualitySourcePackInput, "operator_ack">;
  nd_pack: Omit<
    NdShadowRecursiveTwinWeeklySrcWriteMoWeeklyPackInput,
    "operator_ack"
  >;
...
export interface CompetitionDrNdShadowWeeklySrcWriteMoWeeklyPackCompose {
  session_id: string;
  week_id: string;
  ...
  nd_pack: NdShadowRecursiveTwinWeeklySrcWriteMoWeeklyPackCompose;
  ...
  notes: string[];
  authority: "competition_dr_nd_shadow_weekly_src_write_mo_weekly_pack_compose_advisory";
}
 ...
 */
export function composeCompetitionDrNdShadowWeeklySrcWriteMoWeeklyPack(
  input: CompetitionDrNdShadowWeeklySrcWriteMoWeeklyPackInput,
): CompetitionDrNdShadowWeeklySrcWriteMoWeeklyPackCompose {
  ...
  const nd_pack = composeNdShadowRecursiveTwinWeeklySrcWriteMoWeeklyPack({
    ...input.nd_pack,
    operator_ack: input.operator_ack,
  });
...
export function formatCompetitionDrNdShadowWeeklySrcWriteMoWeeklyPackSummary(
  c: CompetitionDrNdShadowWeeklySrcWriteMoWeeklyPackCompose,
): string {
  return (
