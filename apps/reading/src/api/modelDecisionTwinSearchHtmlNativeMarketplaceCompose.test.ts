...
describe("composeModelDecisionTwinSearchHtmlNativeMarketplace", () => {
  const twin_pack = {
    twin: {
      parent_asset_id: "book-1",
      source_excerpt:
  ...
  it("model decision + twin search html-native marketplace pack ready", () => {
    const c = composeModelDecisionTwinSearchHtmlNativeMarketplace({
    ...
    expect(
      formatModelDecisionTwinSearchHtmlNativeMarketplaceSummary(c),
