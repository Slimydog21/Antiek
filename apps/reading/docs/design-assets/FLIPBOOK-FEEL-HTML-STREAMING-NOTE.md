...
# 42 files / 360 tests (invent reframe multi-phase + invent class + wave honesty + ice-cursor + minigame living-TV + invent inventory + Flipbook stream ladder + RM factory densify)
```
