...
# 44 files / 379 tests (invent reframe multi-phase + invent class + wave honesty + ice-cursor baitChromeFromFollow + fishing-line catenary/tipToBaitDistance/rodBendFromPoints + minigame living-TV + invent inventory + Flipbook stream ladder + RM factory densify)
```
