...
from substrate.antiek_bench_weekly_src_write_fs_draft_mo_weekly_pack_compose import (
...
class RecursiveTwinPresentationWeeklySrcWriteMoWeeklyPackComposeError(
    ValueError
):
...
@dataclass(frozen=True)
class RecursiveTwinPresentationWeeklySrcWriteMoWeeklyPackCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise RecursiveTwinPresentationWeeklySrcWriteMoWeeklyPackComposeError(
...
def compose_recursive_twin_presentation_weekly_src_write_mo_weekly_pack(
    *,
    twin: object,
    presentation: object,
    weekly_pack: object,
    ...
    try:
        wp = compose_antiek_bench_weekly_src_write_fs_draft_mo_weekly_pack(
    ...
    except AntiekBenchWeeklySrcWriteFsDraftMoWeeklyPackComposeError as e:
        raise RecursiveTwinPresentationWeeklySrcWriteMoWeeklyPackComposeError(
            str(e)
        ) from e
    ...
    return RecursiveTwinPresentationWeeklySrcWriteMoWeeklyPackCompose(
        week_id=week,
        session_id=session,
...
def format_recursive_twin_presentation_weekly_src_write_mo_weekly_pack_summary(
...
__all__ = [
    "PresentationSurface",
    "RecursiveTwinPresentationWeeklySrcWriteMoWeeklyPackCompose",
    "RecursiveTwinPresentationWeeklySrcWriteMoWeeklyPackComposeError",
    "compose_recursive_twin_presentation_weekly_src_write_mo_weekly_pack",
    "format_recursive_twin_presentation_weekly_src_write_mo_weekly_pack_summary",
]
