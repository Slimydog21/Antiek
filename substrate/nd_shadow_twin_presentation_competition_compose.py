...
class NdShadowTwinPresentationCompetitionComposeError(ValueError):
    """Fail-closed validation for ND shadow + twin presentation pack."""


@dataclass(frozen=True)
class NdShadowTwinPresentationCompetitionCompose:
    parent_asset_id: str
    session_id: str
    title: str
    account_id: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise NdShadowTwinPresentationCompetitionComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_nd_shadow_twin_presentation_competition(
    *,
    nd_shadow: object,
    ...
    try:
        ...
        raise NdShadowTwinPresentationCompetitionComposeError(str(e)) from e
    ...
    try:
        twin = compose_recursive_twin_presentation_competition_dr(
    ...
    except RecursiveTwinPresentationCompetitionDrComposeError as e:
        raise NdShadowTwinPresentationCompetitionComposeError(str(e)) from e
    ...
    return NdShadowTwinPresentationCompetitionCompose(
...
def format_nd_shadow_twin_presentation_competition_summary(
