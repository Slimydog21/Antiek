...
from substrate.competition_dr_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_compose import (
...
class SettingsDecisionCompetitionDrNdShadowRecursiveTwinPresentationWeeklyComposeError(ValueError):
    """Fail-closed validation for settings decision + competition DR pack."""


@dataclass(frozen=True)
class SettingsDecisionCompetitionDrNdShadowRecursiveTwinPresentationWeeklyCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise SettingsDecisionCompetitionDrNdShadowRecursiveTwinPresentationWeeklyComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_settings_decision_competition_dr_nd_shadow_recursive_twin_presentation_weekly(
    *,
    settings: object,
    ...
    try:
        cp = compose_competition_dr_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft(
    ...
    except CompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftComposeError as e:
        raise SettingsDecisionCompetitionDrNdShadowRecursiveTwinPresentationWeeklyComposeError(
            str(e)
        ) from e
    ...
    return SettingsDecisionCompetitionDrNdShadowRecursiveTwinPresentationWeeklyCompose(
        week_id=week,
        session_id=session,
...
def format_settings_decision_competition_dr_nd_shadow_recursive_twin_presentation_weekly_summary(
...
__all__ = [
    "SettingsDecisionCompetitionDrNdShadowRecursiveTwinPresentationWeeklyCompose",
    "SettingsDecisionCompetitionDrNdShadowRecursiveTwinPresentationWeeklyComposeError",
    "compose_settings_decision_competition_dr_nd_shadow_recursive_twin_presentation_weekly",
    "format_settings_decision_competition_dr_nd_shadow_recursive_twin_presentation_weekly_summary",
]
