...
class TwinSearchHtmlNativeMarketplaceFreeSettingsNdTwinComposeError(ValueError):
    """Fail-closed validation for twin search + HTML-native marketplace pack."""


@dataclass(frozen=True)
class TwinSearchHtmlNativeMarketplaceFreeSettingsNdTwinCompose:
    session_id: str
    parent_asset_id: str
    asset_id: str
    title: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise TwinSearchHtmlNativeMarketplaceFreeSettingsNdTwinComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_twin_search_html_native_marketplace_free_settings_nd_twin(
    *,
    search_query: object,
    twin_records: object,
    html_pack: object,
    ...
    try:
        hp = compose_html_native_marketplace_free_settings_nd_twin(
    ...
    return TwinSearchHtmlNativeMarketplaceFreeSettingsNdTwinCompose(
        session_id=session,
...
def format_twin_search_html_native_marketplace_free_settings_nd_twin_summary(
...
__all__ = [
    ...
    "format_twin_search_html_native_marketplace_free_settings_nd_twin_summary",
]
