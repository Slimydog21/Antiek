...
from substrate.competition_dr_nd_shadow_weekly_src_write_mo_weekly_pack_compose import (
    CompetitionDrNdShadowWeeklySrcWriteMoWeeklyPackCompose,
    CompetitionDrNdShadowWeeklySrcWriteMoWeeklyPackComposeError,
    compose_competition_dr_nd_shadow_weekly_src_write_mo_weekly_pack,
)
...
class SettingsDecisionCompetitionWeeklySrcWriteMoWeeklyPackComposeError(ValueError):
    """Fail-closed validation for settings decision + competition DR pack."""


@dataclass(frozen=True)
class SettingsDecisionCompetitionWeeklySrcWriteMoWeeklyPackCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise SettingsDecisionCompetitionWeeklySrcWriteMoWeeklyPackComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_settings_decision_competition_weekly_src_write_mo_weekly_pack(
    *,
    settings: object,
    ...
    try:
        cp = compose_competition_dr_nd_shadow_weekly_src_write_mo_weekly_pack(
    ...
    except CompetitionDrNdShadowWeeklySrcWriteMoWeeklyPackComposeError as e:
        raise SettingsDecisionCompetitionWeeklySrcWriteMoWeeklyPackComposeError(
            str(e)
        ) from e
    ...
    return SettingsDecisionCompetitionWeeklySrcWriteMoWeeklyPackCompose(
        week_id=week,
        session_id=session,
...
def format_settings_decision_competition_weekly_src_write_mo_weekly_pack_summary(
...
__all__ = [
    ...
    "format_settings_decision_competition_weekly_src_write_mo_weekly_pack_summary",
]
