...
class RecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinComposeError(
    ValueError
):
...
@dataclass(frozen=True)
class RecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise RecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinComposeError(
...
def compose_recursive_twin_presentation_antiek_bench_weekly_source_attach_write_twin(
    *,
    twin: object,
    presentation: object,
    weekly_pack: object,
    ...
    try:
        wp = compose_antiek_bench_weekly_source_attach_write_twin(
    ...
    return RecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinCompose(
        week_id=week,
        session_id=session,
...
def format_recursive_twin_presentation_antiek_bench_weekly_source_attach_write_twin_summary(
...
__all__ = [
    "PresentationSurface",
    "RecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinCompose",
    "RecursiveTwinPresentationAntiekBenchWeeklySourceAttachWriteTwinComposeError",
    "compose_recursive_twin_presentation_antiek_bench_weekly_source_attach_write_twin",
    "format_recursive_twin_presentation_antiek_bench_weekly_source_attach_write_twin_summary",
]
