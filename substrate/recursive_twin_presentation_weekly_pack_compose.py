...
from substrate.antiek_bench_weekly_src_write_pack_compose import (
...
class RecursiveTwinPresentationWeeklyPackComposeError(
    ValueError
):
...
@dataclass(frozen=True)
class RecursiveTwinPresentationWeeklyPackCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise RecursiveTwinPresentationWeeklyPackComposeError(
...
def compose_recursive_twin_presentation_weekly_pack(
    *,
    twin: object,
    presentation: object,
    weekly_pack: object,
...
) -> RecursiveTwinPresentationWeeklyPackCompose:
    ...
    try:
        wp = compose_antiek_bench_weekly_src_write_pack(
    ...
    except AntiekBenchWeeklySrcWritePackComposeError as e:
        raise RecursiveTwinPresentationWeeklyPackComposeError(
            str(e)
        ) from e
    ...
    return RecursiveTwinPresentationWeeklyPackCompose(
        week_id=week,
        session_id=session,
...
def format_recursive_twin_presentation_weekly_pack_summary(
    c: RecursiveTwinPresentationWeeklyPackCompose,
) -> str:
    return (
...
__all__ = [
    "PresentationSurface",
    "RecursiveTwinPresentationWeeklyPackCompose",
    "RecursiveTwinPresentationWeeklyPackComposeError",
    "compose_recursive_twin_presentation_weekly_pack",
    "format_recursive_twin_presentation_weekly_pack_summary",
]
