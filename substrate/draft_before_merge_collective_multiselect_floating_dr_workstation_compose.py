...
from substrate.collective_multiselect_floating_dr_workstation_record_compose import (
    CollectiveMultiselectFloatingDrWorkstationRecordCompose,
    CollectiveMultiselectFloatingDrWorkstationRecordComposeError,
    compose_collective_multiselect_floating_dr_workstation_record,
)
...
class DraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationComposeError(
    ValueError
):
...
class DraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
    ...
    collective_pack: CollectiveMultiselectFloatingDrWorkstationRecordCompose
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "authority": (
                "draft_before_merge_collective_multiselect_floating_dr_workstation_compose_advisory"
            ),
        }
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise DraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_draft_before_merge_collective_multiselect_floating_dr_workstation(
    *,
    draft_gate: object,
    collective_pack: object,
    operator_ack: object,
    require_both: object | None = None,
) -> DraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationCompose:
    ...
    try:
        cp = compose_collective_multiselect_floating_dr_workstation_record(
    ...
    except CollectiveMultiselectFloatingDrWorkstationRecordComposeError as e:
        raise DraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationComposeError(
            str(e)
        ) from e
    ...
    return DraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationCompose(
        week_id=week,
        session_id=session,
...
def format_draft_before_merge_collective_multiselect_floating_dr_workstation_summary(
    c: DraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationCompose,
) -> str:
    return (
...
__all__ = [
    "DraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationCompose",
    "DraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationComposeError",
    "compose_draft_before_merge_collective_multiselect_floating_dr_workstation",
    "format_draft_before_merge_collective_multiselect_floating_dr_workstation_summary",
]
