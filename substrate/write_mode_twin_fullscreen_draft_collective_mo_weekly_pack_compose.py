"""Write twin collective over fullscreen draft collective MO weekly (pure).
...
class WriteModeTwinFullscreenDraftCollectiveMoWeeklyPackComposeError(
    ValueError
):
...
class WriteModeTwinFullscreenDraftCollectiveMoWeeklyPackCompose:
    session_id: str
    parent_asset_id: str
    week_id: str
    asset_id: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise WriteModeTwinFullscreenDraftCollectiveMoWeeklyPackComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_write_mode_twin_fullscreen_draft_collective_mo_weekly_pack(
    *,
    write: object,
    ...
    try:
        fp = compose_fullscreen_open_draft_before_merge_collective_mo_weekly_pack(
    ...
    return WriteModeTwinFullscreenDraftCollectiveMoWeeklyPackCompose(
        session_id=session,
...
def format_write_mode_twin_fullscreen_draft_collective_mo_weekly_pack_summary(
...
__all__ = [
    ...
    "format_write_mode_twin_fullscreen_draft_collective_mo_weekly_pack_summary",
]
