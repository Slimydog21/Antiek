...
from substrate.recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_compose import (
    ...
    RecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftComposeError,
    compose_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft,
)


class NdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftComposeError(ValueError):
    """Fail-closed validation for ND shadow + twin presentation weekly pack."""


@dataclass(frozen=True)
class NdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise NdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft(
    *,
    nd_shadow: object,
    ...
    try:
        twin = compose_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft(
    ...
    except RecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftComposeError as e:
        raise NdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftComposeError(
            str(e)
        ) from e
    ...
    return NdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose(
        week_id=week,
        session_id=session,
...
def format_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_summary(
...
__all__ = [
    ...
    "format_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_summary",
]
