"""Draft-before-full-merge over collective multiselect floating DR MO weekly (pure).
...
from substrate.collective_multiselect_floating_dr_workstation_mo_weekly_pack_compose import (
    CollectiveMultiselectFloatingDrWorkstationMoWeeklyPackCompose,
    CollectiveMultiselectFloatingDrWorkstationMoWeeklyPackComposeError,
    compose_collective_multiselect_floating_dr_workstation_mo_weekly_pack,
)
...
class DraftBeforeMergeCollectiveFloatingDrMoWeeklyPackComposeError(
    ValueError
):
...
class DraftBeforeMergeCollectiveFloatingDrMoWeeklyPackCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise DraftBeforeMergeCollectiveFloatingDrMoWeeklyPackComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_draft_before_merge_collective_floating_dr_mo_weekly_pack(
    *,
    draft_gate: object,
    ...
    """Draft-before-merge + collective multiselect floating DR MO weekly. Never writes/merges."""
    ...
    try:
        cp = compose_collective_multiselect_floating_dr_workstation_mo_weekly_pack(
    ...
    except CollectiveMultiselectFloatingDrWorkstationMoWeeklyPackComposeError as e:
        raise DraftBeforeMergeCollectiveFloatingDrMoWeeklyPackComposeError(
            str(e)
        ) from e
    ...
    return DraftBeforeMergeCollectiveFloatingDrMoWeeklyPackCompose(
        week_id=week,
        session_id=session,
...
def format_draft_before_merge_collective_floating_dr_mo_weekly_pack_summary(
...
__all__ = [
    "DraftBeforeMergeCollectiveFloatingDrMoWeeklyPackCompose",
    "DraftBeforeMergeCollectiveFloatingDrMoWeeklyPackComposeError",
    "compose_draft_before_merge_collective_floating_dr_mo_weekly_pack",
    "format_draft_before_merge_collective_floating_dr_mo_weekly_pack_summary",
]
