...
class AntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftComposeError(ValueError):
    """Fail-closed validation for weekly learn + source attach write twin."""


@dataclass(frozen=True)
class AntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise AntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_antiek_bench_weekly_source_attach_write_twin_fullscreen_draft(
    *,
    weekly_learn: object,
    source_pack: object,
    operator_ack: object,
    ...
    try:
        ...
        raise AntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftComposeError(str(e)) from e
    notes.extend(f"[weekly_learn] {n}" for n in wl.notes)

    try:
        sp = compose_source_attach_write_twin_fullscreen_draft_before_merge(
    ...
    return AntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftCompose(
        week_id=week,
        session_id=session,
...
def format_antiek_bench_weekly_source_attach_write_twin_fullscreen_draft_summary(
...
__all__ = [
    "AntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftCompose",
    "AntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftComposeError",
