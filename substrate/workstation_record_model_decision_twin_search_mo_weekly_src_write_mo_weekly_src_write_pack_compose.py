...
from substrate.model_decision_twin_search_html_native_mo_weekly_src_write_mo_weekly_src_write_pack_compose import (
    ModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
    ModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWritePackComposeError,
...
class WorkstationRecordModelDecisionTwinSearchMoWeeklySrcWriteMoWeeklySrcWritePackComposeError(ValueError):
    """Fail-closed validation for workstation records + model decision twin search."""


@dataclass(frozen=True)
class WorkstationRecordModelDecisionTwinSearchMoWeeklySrcWriteMoWeeklySrcWritePackCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise WorkstationRecordModelDecisionTwinSearchMoWeeklySrcWriteMoWeeklySrcWritePackComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_workstation_record_model_decision_twin_search_mo_weekly_src_write_mo_weekly_src_write_pack(
    *,
    session_id: object,
    items: object,
    ...
    try:
        ...
        raise WorkstationRecordModelDecisionTwinSearchMoWeeklySrcWriteMoWeeklySrcWritePackComposeError(str(e)) from e
    notes.extend(f"[records] {n}" for n in rec.notes)

    try:
        dp = compose_model_decision_twin_search_html_native_mo_weekly_src_write_mo_weekly_src_write_pack(
    ...
    except ModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWritePackComposeError as e:
        raise WorkstationRecordModelDecisionTwinSearchMoWeeklySrcWriteMoWeeklySrcWritePackComposeError(str(e)) from e
    ...
    return WorkstationRecordModelDecisionTwinSearchMoWeeklySrcWriteMoWeeklySrcWritePackCompose(
        week_id=week,
        session_id=session,
...
def format_workstation_record_model_decision_twin_search_mo_weekly_src_write_mo_weekly_src_write_pack_summary(
...
__all__ = [
    "WorkstationRecordModelDecisionTwinSearchMoWeeklySrcWriteMoWeeklySrcWritePackCompose",
    "WorkstationRecordModelDecisionTwinSearchMoWeeklySrcWriteMoWeeklySrcWritePackComposeError",
    "compose_workstation_record_model_decision_twin_search_mo_weekly_src_write_mo_weekly_src_write_pack",
    "format_workstation_record_model_decision_twin_search_mo_weekly_src_write_mo_weekly_src_write_pack_summary",
]
