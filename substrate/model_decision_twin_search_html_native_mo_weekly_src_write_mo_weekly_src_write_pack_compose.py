...
from substrate.twin_search_html_native_marketplace_mo_weekly_src_write_mo_weekly_src_write_pack_compose import (
...
class ModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWritePackComposeError(ValueError):
    """Fail-closed validation for model decision + twin search HTML-native MO."""


@dataclass(frozen=True)
class ModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWritePackCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
    ...
    twin_search_pack: TwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackCompose
    pack_ready: bool
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise ModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWritePackComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_model_decision_twin_search_html_native_mo_weekly_src_write_mo_weekly_src_write_pack(
    *,
    decision: object,
    ...
    try:
        tsp = compose_twin_search_html_native_marketplace_mo_weekly_src_write_mo_weekly_src_write_pack(
    ...
    except TwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWritePackComposeError as e:
        raise ModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWritePackComposeError(
            str(e)
        ) from e
    ...
    return ModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWritePackCompose(
        week_id=week,
        session_id=session,
...
def format_model_decision_twin_search_html_native_mo_weekly_src_write_mo_weekly_src_write_pack_summary(
    c: ModelDecisionTwinSearchHtmlNativeMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
) -> str:
    exceed = (
        "would_exceed=null"
