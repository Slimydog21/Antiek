...
from substrate.draft_before_merge_collective_multiselect_floating_dr_workstation_compose import (
...
class FullscreenOpenDraftBeforeMergeCollectiveMultiselectComposeError(ValueError):
    """Fail-closed validation for fullscreen + draft collective multiselect pack."""


@dataclass(frozen=True)
class FullscreenOpenDraftBeforeMergeCollectiveMultiselectCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise FullscreenOpenDraftBeforeMergeCollectiveMultiselectComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_fullscreen_open_draft_before_merge_collective_multiselect(
    *,
    fullscreen: object,
    draft_pack: object,
    operator_ack: object,
    ...
    try:
        dp = compose_draft_before_merge_collective_multiselect_floating_dr_workstation(
    ...
    except DraftBeforeMergeCollectiveMultiselectFloatingDrWorkstationComposeError as e:
        raise FullscreenOpenDraftBeforeMergeCollectiveMultiselectComposeError(
            str(e)
        ) from e
    ...
    return FullscreenOpenDraftBeforeMergeCollectiveMultiselectCompose(
        week_id=week,
        session_id=session,
...
def format_fullscreen_open_draft_before_merge_collective_multiselect_summary(
...
__all__ = [
    "FullscreenOpenDraftBeforeMergeCollectiveMultiselectCompose",
    "FullscreenOpenDraftBeforeMergeCollectiveMultiselectComposeError",
    "compose_fullscreen_open_draft_before_merge_collective_multiselect",
    "format_fullscreen_open_draft_before_merge_collective_multiselect_summary",
]
