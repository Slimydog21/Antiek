...
from substrate.fullscreen_open_draft_before_merge_collective_mo_weekly_src_write_mo_weekly_src_write_pack_compose import (
...
class WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackComposeError(
    ValueError
):
...
class WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackCompose:
    session_id: str
    parent_asset_id: str
    week_id: str
    asset_id: str
    ...
    fullscreen_pack: FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackCompose
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_write_mode_twin_fullscreen_draft_collective_mo_weekly_src_write_mo_weekly_src_write_pack(
    *,
    write: object,
    fullscreen_pack: object,
    operator_ack: object,
    require_both: object | None = None,
) -> WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackCompose:
    ...
    try:
        fp = compose_fullscreen_open_draft_before_merge_collective_mo_weekly_src_write_mo_weekly_src_write_pack(
    ...
    except FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackComposeError as e:
        raise WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackComposeError(
            str(e)
        ) from e
    ...
    return WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackCompose(
        session_id=session,
...
def format_write_mode_twin_fullscreen_draft_collective_mo_weekly_src_write_mo_weekly_src_write_pack_summary(
    c: WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
) -> str:
    return (
...
__all__ = [
    "WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackCompose",
    "WriteModeTwinFullscreenDraftCollectiveMoWeeklySrcWriteMoWeeklySrcWritePackComposeError",
    "compose_write_mode_twin_fullscreen_draft_collective_mo_weekly_src_write_mo_weekly_src_write_pack",
    "format_write_mode_twin_fullscreen_draft_collective_mo_weekly_src_write_mo_weekly_src_write_pack_summary",
]
