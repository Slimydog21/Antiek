...
from substrate.draft_before_merge_collective_floating_dr_mo_weekly_src_write_pack_compose import (
...
class FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackComposeError(ValueError):
    """Fail-closed validation for fullscreen + draft collective multiselect pack."""


@dataclass(frozen=True)
class FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_fullscreen_open_draft_before_merge_collective_mo_weekly_src_write_pack(
    *,
    fullscreen: object,
    draft_pack: object,
    operator_ack: object,
    ...
    try:
        dp = compose_draft_before_merge_collective_floating_dr_mo_weekly_src_write_pack(
    ...
    except DraftBeforeMergeCollectiveFloatingDrMoWeeklySrcWritePackComposeError as e:
        raise FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackComposeError(
            str(e)
        ) from e
    ...
    return FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackCompose(
        week_id=week,
        session_id=session,
...
def format_fullscreen_open_draft_before_merge_collective_mo_weekly_src_write_pack_summary(
...
__all__ = [
    "FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackCompose",
    "FullscreenOpenDraftBeforeMergeCollectiveMoWeeklySrcWritePackComposeError",
    "compose_fullscreen_open_draft_before_merge_collective_mo_weekly_src_write_pack",
    "format_fullscreen_open_draft_before_merge_collective_mo_weekly_src_write_pack_summary",
]
