...
from substrate.write_twin_fs_draft_pack_compose import (
...
class SourceAttachWriteTwinFsDraftPackComposeError(ValueError):
    """Fail-closed validation for source attach + write twin collective pack."""


@dataclass(frozen=True)
class SourceAttachWriteTwinFsDraftPackCompose:
    session_id: str
    parent_asset_id: str
    week_id: str
    asset_id: str
    ...
    write_pack: WriteTwinFsDraftPackCompose
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise SourceAttachWriteTwinFsDraftPackComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_source_attach_write_twin_fs_draft_pack(
    *,
    sources: object,
    write_pack: object,
    operator_ack: object,
    ...
    return SourceAttachWriteTwinFsDraftPackCompose(
        session_id=session,
...
def format_source_attach_write_twin_fs_draft_pack_summary(
...
__all__ = [
    ...
    "format_source_attach_write_twin_fs_draft_pack_summary",
]
