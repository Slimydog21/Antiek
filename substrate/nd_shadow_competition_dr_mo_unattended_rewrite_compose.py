...
class NdShadowCompetitionDrMoUnattendedRewriteComposeError(ValueError):
    """Fail-closed validation for ND shadow + twin presentation pack."""


@dataclass(frozen=True)
class NdShadowCompetitionDrMoUnattendedRewriteCompose:
    parent_asset_id: str
    session_id: str
    title: str
    account_id: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise NdShadowCompetitionDrMoUnattendedRewriteComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_nd_shadow_competition_dr_mo_unattended_rewrite(
    *,
    nd_shadow: object,
    ...
    try:
        ...
        raise NdShadowCompetitionDrMoUnattendedRewriteComposeError(str(e)) from e
    ...
    if pack_ready:
        ...
        notes.append(
            "pack_ready=false — nd_shadow, competition_pack, or operator_ack "
            "gate open"
        )
    ...
    return NdShadowCompetitionDrMoUnattendedRewriteCompose(
...
def format_nd_shadow_competition_dr_mo_unattended_rewrite_summary(
