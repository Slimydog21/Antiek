...
from substrate.html_native_marketplace_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose import (
    HtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
    HtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackComposeError,
    compose_html_native_marketplace_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack,
)
...
class TwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackComposeError(ValueError):
    """Fail-closed validation for twin search + HTML-native marketplace MO weekly src write."""


@dataclass(frozen=True)
class TwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
    ...
    html_pack: HtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose
    pack_ready: bool
    hit_count: int
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "authority": (
                "twin_search_html_native_marketplace_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_compose_advisory"
            ),
        }
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise TwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_twin_search_html_native_marketplace_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack(
    *,
    search_query: object,
    twin_records: object,
    html_pack: object,
    ...
    try:
        ...
        raise TwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackComposeError(str(e)) from e
    notes.extend(f"[search] {n}" for n in search.notes)

    try:
        hp = compose_html_native_marketplace_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack(
            html_view=html_pack.get("html_view"),
            market_pack=html_pack.get("market_pack"),
            operator_ack=operator_ack,
            require_both=html_pack.get("require_both"),
        )
    except HtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackComposeError as e:
        raise TwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackComposeError(str(e)) from e
    ...
    return TwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose(
        week_id=week,
        session_id=session,
...
def format_twin_search_html_native_marketplace_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_summary(
    c: TwinSearchHtmlNativeMarketplaceMoWeeklySrcWriteMoWeeklySrcWriteMoWeeklySrcWritePackCompose,
) -> str:
    return (
...
__all__ = [
    ...
    "format_twin_search_html_native_marketplace_mo_weekly_src_write_mo_weekly_src_write_mo_weekly_src_write_pack_summary",
]
