...
class SettingsDecisionCompetitionWeeklyPackComposeError(ValueError):
    """Fail-closed validation for settings decision + competition DR pack."""


@dataclass(frozen=True)
class SettingsDecisionCompetitionWeeklyPackCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise SettingsDecisionCompetitionWeeklyPackComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_settings_decision_competition_weekly_pack(
    *,
    settings: object,
    ...
    try:
        cp = compose_competition_dr_nd_shadow_weekly_pack(
    ...
    return SettingsDecisionCompetitionWeeklyPackCompose(
        week_id=week,
        session_id=session,
...
def format_settings_decision_competition_weekly_pack_summary(
...
__all__ = [
    ...
    "format_settings_decision_competition_weekly_pack_summary",
]
