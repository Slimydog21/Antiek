...
class RecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftComposeError(
    ValueError
):
...
@dataclass(frozen=True)
class RecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise RecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftComposeError(
...
def compose_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft(
    *,
    twin: object,
    presentation: object,
    weekly_pack: object,
    ...
    try:
        wp = compose_antiek_bench_weekly_source_attach_write_twin_fullscreen_draft(
    ...
    except AntiekBenchWeeklySourceAttachWriteTwinFullscreenDraftComposeError as e:
        raise RecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftComposeError(
            str(e)
        ) from e
    ...
    return RecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose(
        week_id=week,
        session_id=session,
...
def format_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_summary(
