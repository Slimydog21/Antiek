...
# historical/provisional seams; all currently implemented seams are committed.
...
class ThreadHop:
    ...
    built: bool = True
    # True only for historical/provisional seam hops; committed hops keep this
    # false so the breadcrumb does not imply unfinished substrate.
