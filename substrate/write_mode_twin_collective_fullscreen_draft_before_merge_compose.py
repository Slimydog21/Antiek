"""Write twin collective over fullscreen draft-before-merge collective multiselect (pure).
...
from substrate.fullscreen_open_draft_before_merge_collective_multiselect_compose import (
...
class WriteModeTwinCollectiveFullscreenDraftBeforeMergeComposeError(
    ValueError
):
...
class WriteModeTwinCollectiveFullscreenDraftBeforeMergeCompose:
    session_id: str
    parent_asset_id: str
    week_id: str
    asset_id: str
    ...
    fullscreen_pack: FullscreenOpenDraftBeforeMergeCollectiveMultiselectCompose
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "authority": (
                "write_mode_twin_collective_fullscreen_draft_before_merge_compose_advisory"
            ),
        }
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise WriteModeTwinCollectiveFullscreenDraftBeforeMergeComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_write_mode_twin_collective_fullscreen_draft_before_merge(
    *,
    write: object,
    fullscreen_pack: object,
    operator_ack: object,
    require_both: object | None = None,
) -> WriteModeTwinCollectiveFullscreenDraftBeforeMergeCompose:
    ...
    try:
        fp = compose_fullscreen_open_draft_before_merge_collective_multiselect(
    ...
    except FullscreenOpenDraftBeforeMergeCollectiveMultiselectComposeError as e:
        raise WriteModeTwinCollectiveFullscreenDraftBeforeMergeComposeError(
            str(e)
        ) from e
    ...
    return WriteModeTwinCollectiveFullscreenDraftBeforeMergeCompose(
        session_id=session,
...
def format_write_mode_twin_collective_fullscreen_draft_before_merge_summary(
    c: WriteModeTwinCollectiveFullscreenDraftBeforeMergeCompose,
) -> str:
    return (
...
__all__ = [
    "WriteModeTwinCollectiveFullscreenDraftBeforeMergeCompose",
    "WriteModeTwinCollectiveFullscreenDraftBeforeMergeComposeError",
    "compose_write_mode_twin_collective_fullscreen_draft_before_merge",
    "format_write_mode_twin_collective_fullscreen_draft_before_merge_summary",
]
