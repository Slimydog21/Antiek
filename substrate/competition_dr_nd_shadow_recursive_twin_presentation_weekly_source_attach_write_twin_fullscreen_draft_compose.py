...
from substrate.nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_compose import (
    NdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose,
    NdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftComposeError,
    compose_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft,
)


class CompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftComposeError(ValueError):
    """Fail-closed validation for competition DR + ND shadow twin presentation weekly."""


@dataclass(frozen=True)
class CompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose:
    session_id: str
    week_id: str
    parent_asset_id: str
    asset_id: str
    ...
    nd_pack: NdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "authority": (
                "competition_dr_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_compose_advisory"
            ),
        }
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise CompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_competition_dr_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft(
    *,
    competition: object,
    nd_pack: object,
    operator_ack: object,
    require_both: object | None = None,
) -> CompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose:
    ...
    try:
        ...
        raise CompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftComposeError(str(e)) from e
    notes.extend(f"[competition] {n}" for n in comp.notes)

    try:
        nd = compose_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft(
            nd_shadow=nd_pack.get("nd_shadow"),
            twin_presentation=nd_pack.get("twin_presentation"),
            operator_ack=operator_ack,
            require_both=nd_pack.get("require_both"),
        )
    except NdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftComposeError as e:
        raise CompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftComposeError(str(e)) from e
    ...
    return CompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose(
        session_id=session,
        week_id=week,
...
def format_competition_dr_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_summary(
    c: CompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose,
) -> str:
    return (
...
__all__ = [
    "CompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftCompose",
    "CompetitionDrNdShadowRecursiveTwinPresentationWeeklySourceAttachWriteTwinFullscreenDraftComposeError",
    "compose_competition_dr_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft",
    "format_competition_dr_nd_shadow_recursive_twin_presentation_weekly_source_attach_write_twin_fullscreen_draft_summary",
]
