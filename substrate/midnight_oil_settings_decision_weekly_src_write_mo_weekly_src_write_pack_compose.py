...
from substrate.settings_decision_competition_weekly_src_write_mo_weekly_src_write_pack_compose import (
    SettingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWritePackCompose,
    SettingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWritePackComposeError,
    compose_settings_decision_competition_weekly_src_write_mo_weekly_src_write_pack,
)


class MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWritePackComposeError(ValueError):
    """Fail-closed validation for MO + settings decision competition DR."""


@dataclass(frozen=True)
class MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWritePackCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
    ...
    settings_pack: SettingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWritePackCompose
    pack_ready: bool
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "authority": (
                "midnight_oil_settings_decision_weekly_src_write_mo_weekly_src_write_pack_compose_advisory"
            ),
        }
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWritePackComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_midnight_oil_settings_decision_weekly_src_write_mo_weekly_src_write_pack(
    *,
    mo: object,
    ...
    try:
        ...
        raise MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWritePackComposeError(str(e)) from e
    notes.extend(f"[mo] {n}" for n in mo_c.notes)

    try:
        sp = compose_settings_decision_competition_weekly_src_write_mo_weekly_src_write_pack(
    ...
    except SettingsDecisionCompetitionWeeklySrcWriteMoWeeklySrcWritePackComposeError as e:
        raise MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWritePackComposeError(str(e)) from e
    ...
    return MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWritePackCompose(
        week_id=week,
        session_id=session,
...
def format_midnight_oil_settings_decision_weekly_src_write_mo_weekly_src_write_pack_summary(
    c: MidnightOilSettingsDecisionWeeklySrcWriteMoWeeklySrcWritePackCompose,
) -> str:
    return (
...
__all__ = [
    ...
    "format_midnight_oil_settings_decision_weekly_src_write_mo_weekly_src_write_pack_summary",
]
