...
def place_block(
    ...
    *,
    ...
    """Place a lego block into an outline section.

    Callers coordinating several writes may defer OUTLINE_BLOCK_PLACED until
    their outer transaction commits by passing ``emit_event=False``.
