"""Fullscreen-open over draft-before-merge collective MO weekly floating DR (pure).
...
from substrate.draft_before_merge_collective_floating_dr_mo_weekly_pack_compose import (
...
class FullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackComposeError(ValueError):
    """Fail-closed validation for fullscreen + draft collective multiselect pack."""


@dataclass(frozen=True)
class FullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackCompose:
    week_id: str
    session_id: str
    parent_asset_id: str
    asset_id: str
...
def _require_nonempty(value: object, *, field: str) -> str:
    if not isinstance(value, str) or not value.strip():
        raise FullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackComposeError(
            f"{field} must be a non-empty string"
        )
    return value.strip()


def compose_fullscreen_open_draft_before_merge_collective_mo_weekly_pack(
    *,
    fullscreen: object,
    draft_pack: object,
    operator_ack: object,
    ...
    """Fullscreen-open + draft-before-merge collective MO weekly. Never dispatches."""
    ...
    try:
        dp = compose_draft_before_merge_collective_floating_dr_mo_weekly_pack(
    ...
    except DraftBeforeMergeCollectiveFloatingDrMoWeeklyPackComposeError as e:
        raise FullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackComposeError(
            str(e)
        ) from e
    ...
    return FullscreenOpenDraftBeforeMergeCollectiveMoWeeklyPackCompose(
        week_id=week,
        session_id=session,
...
def format_fullscreen_open_draft_before_merge_collective_mo_weekly_pack_summary(
...
__all__ = [
    ...
    "format_fullscreen_open_draft_before_merge_collective_mo_weekly_pack_summary",
]
